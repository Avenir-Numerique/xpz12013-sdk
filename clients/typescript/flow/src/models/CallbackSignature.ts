...
/**
 * Check if a given object implements the CallbackSignature interface.
 */
export function instanceOfCallbackSignature(value: object): value is CallbackSignature {
    if (!('algo' in value) || value['algo'] === undefined) return false;
    if (!('key' in value) || value['key'] === undefined) return false;
    return true;
}

export function CallbackSignatureFromJSON(json: any): CallbackSignature {
    return CallbackSignatureFromJSONTyped(json, false);
}

export function CallbackSignatureFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallbackSignature {
    if (json == null) {
        return json;
    }
    return {
        
        'algo': AlgorithmFromJSON(json['algo']),
        'key': json['key'],
    };
}

export function CallbackSignatureToJSON(json: any): CallbackSignature {
    return CallbackSignatureToJSONTyped(json, false);
}

export function CallbackSignatureToJSONTyped(value?: CallbackSignature | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'algo': AlgorithmToJSON(value['algo']),
        'key': value['key'],
    };
}
