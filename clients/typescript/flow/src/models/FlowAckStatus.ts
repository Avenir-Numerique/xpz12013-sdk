 ...
 * @export
 */
export const FlowAckStatus = {
    Pending: 'Pending',
    Ok: 'Ok',
    Error: 'Error'
} as const;
export type FlowAckStatus = typeof FlowAckStatus[keyof typeof FlowAckStatus];


export function instanceOfFlowAckStatus(value: any): boolean {
    for (const key in FlowAckStatus) {
        if (Object.prototype.hasOwnProperty.call(FlowAckStatus, key)) {
            if (FlowAckStatus[key as keyof typeof FlowAckStatus] === value) {
                return true;
            }
        }
    }
...
export function FlowAckStatusFromJSON(json: any): FlowAckStatus {
    return FlowAckStatusFromJSONTyped(json, false);
}

export function FlowAckStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlowAckStatus {
    return json as FlowAckStatus;
}

export function FlowAckStatusToJSON(value?: FlowAckStatus | null): any {
    return value as any;
}

export function FlowAckStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): FlowAckStatus {
    return value as FlowAckStatus;
}
