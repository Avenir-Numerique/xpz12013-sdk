...
export interface AcknowledgementDetail {
     ...
     */
    level: AcknowledgementDetailLevelEnum;
    /**
 ...
 * @export
 */
export const AcknowledgementDetailLevelEnum = {
    Error: 'Error',
    Warning: 'Warning'
} as const;
export type AcknowledgementDetailLevelEnum = typeof AcknowledgementDetailLevelEnum[keyof typeof AcknowledgementDetailLevelEnum];


/**
 * Check if a given object implements the AcknowledgementDetail interface.
 */
export function instanceOfAcknowledgementDetail(value: object): value is AcknowledgementDetail {
...
export function AcknowledgementDetailFromJSON(json: any): AcknowledgementDetail {
    return AcknowledgementDetailFromJSONTyped(json, false);
}

export function AcknowledgementDetailFromJSONTyped(json: any, ignoreDiscriminator: boolean): AcknowledgementDetail {
    if (json == null) {
        return json;
    }
    return {
...
export function AcknowledgementDetailToJSON(json: any): AcknowledgementDetail {
    return AcknowledgementDetailToJSONTyped(json, false);
}

export function AcknowledgementDetailToJSONTyped(value?: AcknowledgementDetail | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
