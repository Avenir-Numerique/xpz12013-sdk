...
/**
 * Check if a given object implements the BasicAuthentication interface.
 */
export function instanceOfBasicAuthentication(value: object): value is BasicAuthentication {
    if (!('userId' in value) || value['userId'] === undefined) return false;
    if (!('userPassword' in value) || value['userPassword'] === undefined) return false;
    return true;
}

export function BasicAuthenticationFromJSON(json: any): BasicAuthentication {
    return BasicAuthenticationFromJSONTyped(json, false);
}

export function BasicAuthenticationFromJSONTyped(json: any, ignoreDiscriminator: boolean): BasicAuthentication {
    if (json == null) {
        return json;
    }
    return {
...
export function BasicAuthenticationToJSON(json: any): BasicAuthentication {
    return BasicAuthenticationToJSONTyped(json, false);
}

export function BasicAuthenticationToJSONTyped(value?: BasicAuthentication | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
