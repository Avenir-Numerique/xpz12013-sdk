...
/**
 * Check if a given object implements the CallbackHeader interface.
 */
export function instanceOfCallbackHeader(value: object): value is CallbackHeader {
...
export function CallbackHeaderFromJSON(json: any): CallbackHeader {
    return CallbackHeaderFromJSONTyped(json, false);
}

export function CallbackHeaderFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallbackHeader {
    if (json == null) {
        return json;
    }
    return {
...
export function CallbackHeaderToJSON(json: any): CallbackHeader {
    return CallbackHeaderToJSONTyped(json, false);
}

export function CallbackHeaderToJSONTyped(value?: CallbackHeader | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
