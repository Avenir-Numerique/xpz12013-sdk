 ...
 */
export function instanceOfWebhookMetadata(value: object): value is WebhookMetadata {
...
export function WebhookMetadataFromJSON(json: any): WebhookMetadata {
    return WebhookMetadataFromJSONTyped(json, false);
}

export function WebhookMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookMetadata {
    if (json == null) {
        return json;
    }
    return {
...
export function WebhookMetadataToJSON(json: any): WebhookMetadata {
    return WebhookMetadataToJSONTyped(json, false);
}

export function WebhookMetadataToJSONTyped(value?: WebhookMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
