 ...
 */
export function instanceOfOAuth2Authentication(value: object): value is OAuth2Authentication {
...
export function OAuth2AuthenticationToJSON(json: any): OAuth2Authentication {
    return OAuth2AuthenticationToJSONTyped(json, false);
}

export function OAuth2AuthenticationToJSONTyped(value?: OAuth2Authentication | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
