...
export type ReasonCodeEnum = typeof ReasonCodeEnum[keyof typeof ReasonCodeEnum];


export function instanceOfReasonCodeEnum(value: any): boolean {
    for (const key in ReasonCodeEnum) {
        if (Object.prototype.hasOwnProperty.call(ReasonCodeEnum, key)) {
            if (ReasonCodeEnum[key as keyof typeof ReasonCodeEnum] === value) {
                return true;
            }
        }
    }
...
export function ReasonCodeEnumFromJSON(json: any): ReasonCodeEnum {
    return ReasonCodeEnumFromJSONTyped(json, false);
}

export function ReasonCodeEnumFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReasonCodeEnum {
    return json as ReasonCodeEnum;
}

export function ReasonCodeEnumToJSON(value?: ReasonCodeEnum | null): any {
    return value as any;
}

export function ReasonCodeEnumToJSONTyped(value: any, ignoreDiscriminator: boolean): ReasonCodeEnum {
    return value as ReasonCodeEnum;
}
