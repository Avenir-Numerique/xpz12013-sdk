 ...
 * 
 * @export
 * @interface SearchFlowParams
 */
export interface SearchFlowParams {
    /**
     * Pagination, Maximum number of results that may be returned
     * @type {number}
     * @memberof SearchFlowParams
     */
    limit?: number;
    /**
     ...
     * @memberof SearchFlowParams
     */
    where: SearchFlowFilters;
}

/**
 * Check if a given object implements the SearchFlowParams interface.
 */
export function instanceOfSearchFlowParams(value: object): value is SearchFlowParams {
    if (!('where' in value) || value['where'] === undefined) return false;
    return true;
}

export function SearchFlowParamsFromJSON(json: any): SearchFlowParams {
    return SearchFlowParamsFromJSONTyped(json, false);
}

export function SearchFlowParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchFlowParams {
    if (json == null) {
        return json;
    }
    return {
        ...
        'where': SearchFlowFiltersFromJSON(json['where']),
    };
}

export function SearchFlowParamsToJSON(json: any): SearchFlowParams {
    return SearchFlowParamsToJSONTyped(json, false);
}

export function SearchFlowParamsToJSONTyped(value?: SearchFlowParams | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'limit': value['limit'],
        'cursor': value['cursor'],
        'where': SearchFlowFiltersToJSON(value['where']),
    };
}
