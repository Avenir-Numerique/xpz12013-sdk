...
import {
    instanceOfReasonCodeEnum,
    ReasonCodeEnumFromJSON,
    ReasonCodeEnumFromJSONTyped,
    ReasonCodeEnumToJSON,
} from './ReasonCodeEnum';
 ...
 * @export
 */
export type ReasonCode = ReasonCodeEnum | string;

export function ReasonCodeFromJSON(json: any): ReasonCode {
    return ReasonCodeFromJSONTyped(json, false);
}

export function ReasonCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReasonCode {
    if (json == null) {
        return json;
    }
    if (instanceOfReasonCodeEnum(json)) {
        return ReasonCodeEnumFromJSONTyped(json, true);
    }
...
export function ReasonCodeToJSON(json: any): any {
    return ReasonCodeToJSONTyped(json, false);
}

export function ReasonCodeToJSONTyped(value?: ReasonCode | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }

    if (instanceOfReasonCodeEnum(value)) {
        return ReasonCodeEnumToJSON(value as ReasonCodeEnum);
    }
