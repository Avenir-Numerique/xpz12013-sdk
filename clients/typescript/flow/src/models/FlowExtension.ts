...
export interface FlowExtension {
     ...
     * @memberof FlowExtension
     */
    processingRuleSource: FlowExtensionProcessingRuleSourceEnum;
    /**
     * 
     * @type {FlowDirection}
     * @memberof FlowExtension
 ...
 * @export
 */
export const FlowExtensionProcessingRuleSourceEnum = {
    Input: 'Input',
    Computed: 'Computed'
} as const;
export type FlowExtensionProcessingRuleSourceEnum = typeof FlowExtensionProcessingRuleSourceEnum[keyof typeof FlowExtensionProcessingRuleSourceEnum];


/**
 * Check if a given object implements the FlowExtension interface.
 */
export function instanceOfFlowExtension(value: object): value is FlowExtension {
...
export function FlowExtensionFromJSON(json: any): FlowExtension {
    return FlowExtensionFromJSONTyped(json, false);
}

export function FlowExtensionFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlowExtension {
    if (json == null) {
        return json;
    }
    return {
...
export function FlowExtensionToJSON(json: any): FlowExtension {
    return FlowExtensionToJSONTyped(json, false);
}

export function FlowExtensionToJSONTyped(value?: FlowExtension | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
