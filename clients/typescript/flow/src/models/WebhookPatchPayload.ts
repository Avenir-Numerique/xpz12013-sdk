...
import type { CallbackHeader } from './CallbackHeader';
import {
    CallbackHeaderFromJSON,
    CallbackHeaderFromJSONTyped,
    CallbackHeaderToJSON,
    CallbackHeaderToJSONTyped,
} from './CallbackHeader';
import type { CallbackAuthentication } from './CallbackAuthentication';
import {
    CallbackAuthenticationFromJSON,
    CallbackAuthenticationFromJSONTyped,
    CallbackAuthenticationToJSON,
    CallbackAuthenticationToJSONTyped,
} from './CallbackAuthentication';
import type { CallbackSignature } from './CallbackSignature';
import {
    CallbackSignatureFromJSON,
    CallbackSignatureFromJSONTyped,
    CallbackSignatureToJSON,
    CallbackSignatureToJSONTyped,
} from './CallbackSignature';

/**
 * 
 * @export
 * @interface WebhookPatchPayload
 */
export interface WebhookPatchPayload {
    /**
     * 
     * @type {Array<CallbackHeader>}
     * @memberof WebhookPatchPayload
     */
...
/**
 * Check if a given object implements the WebhookPatchPayload interface.
 */
export function instanceOfWebhookPatchPayload(value: object): value is WebhookPatchPayload {
    return true;
}

export function WebhookPatchPayloadFromJSON(json: any): WebhookPatchPayload {
    return WebhookPatchPayloadFromJSONTyped(json, false);
}

export function WebhookPatchPayloadFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookPatchPayload {
    if (json == null) {
        return json;
    }
    return {
        
        'headers': json['headers'] == null ? undefined : ((json['headers'] as Array<any>).map(CallbackHeaderFromJSON)),
        'authentication': json['authentication'] == null ? undefined : CallbackAuthenticationFromJSON(json['authentication']),
        'signature': json['signature'] == null ? undefined : CallbackSignatureFromJSON(json['signature']),
    };
}

export function WebhookPatchPayloadToJSON(json: any): WebhookPatchPayload {
    return WebhookPatchPayloadToJSONTyped(json, false);
}

export function WebhookPatchPayloadToJSONTyped(value?: WebhookPatchPayload | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'headers': value['headers'] == null ? undefined : ((value['headers'] as Array<any>).map(CallbackHeaderToJSON)),
        'authentication': CallbackAuthenticationToJSON(value['authentication']),
        'signature': CallbackSignatureToJSON(value['signature']),
    };
}
