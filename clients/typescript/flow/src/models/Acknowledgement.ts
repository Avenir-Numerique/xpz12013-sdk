...
import type { AcknowledgementDetail } from './AcknowledgementDetail';
import {
    AcknowledgementDetailFromJSON,
    AcknowledgementDetailFromJSONTyped,
    AcknowledgementDetailToJSON,
    AcknowledgementDetailToJSONTyped,
} from './AcknowledgementDetail';
...
export interface Acknowledgement {
    ...
    /**
     * 
     * @type {Array<AcknowledgementDetail>}
     * @memberof Acknowledgement
     */
    details?: Array<AcknowledgementDetail>;
}
...
export function AcknowledgementFromJSONTyped(json: any, ignoreDiscriminator: boolean): Acknowledgement {
    ...
    return {
        ...
        'status': FlowAckStatusFromJSON(json['status']),
        'details': json['details'] == null ? undefined : ((json['details'] as Array<any>).map(AcknowledgementDetailFromJSON)),
    };
}
...
export function AcknowledgementToJSONTyped(value?: Acknowledgement | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'status': FlowAckStatusToJSON(value['status']),
        'details': value['details'] == null ? undefined : ((value['details'] as Array<any>).map(AcknowledgementDetailToJSON)),
    };
}
