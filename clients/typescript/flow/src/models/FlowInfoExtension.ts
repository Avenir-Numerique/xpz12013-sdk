 ...
 * @export
 * @interface FlowInfoExtension
 */
export interface FlowInfoExtension {
    /**
     ...
     * 
     * @type {string}
     * @memberof FlowInfoExtension
     */
    sha256?: string;
}

/**
 * Check if a given object implements the FlowInfoExtension interface.
 */
export function instanceOfFlowInfoExtension(value: object): value is FlowInfoExtension {
    return true;
}

export function FlowInfoExtensionFromJSON(json: any): FlowInfoExtension {
    return FlowInfoExtensionFromJSONTyped(json, false);
}

export function FlowInfoExtensionFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlowInfoExtension {
    if (json == null) {
        return json;
    }
    return {
...
export function FlowInfoExtensionToJSON(json: any): FlowInfoExtension {
    return FlowInfoExtensionToJSONTyped(json, false);
}

export function FlowInfoExtensionToJSONTyped(value?: FlowInfoExtension | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
