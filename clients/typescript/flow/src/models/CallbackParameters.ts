...
/**
 * Check if a given object implements the CallbackParameters interface.
 */
export function instanceOfCallbackParameters(value: object): value is CallbackParameters {
    if (!('url' in value) || value['url'] === undefined) return false;
    return true;
}

export function CallbackParametersFromJSON(json: any): CallbackParameters {
    return CallbackParametersFromJSONTyped(json, false);
}

export function CallbackParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallbackParameters {
    if (json == null) {
        return json;
    }
    return {
...
export function CallbackParametersToJSON(json: any): CallbackParameters {
    return CallbackParametersToJSONTyped(json, false);
}

export function CallbackParametersToJSONTyped(value?: CallbackParameters | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
