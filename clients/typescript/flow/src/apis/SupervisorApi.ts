...
export class SupervisorApi extends runtime.BaseAPI {
     ...
     */
    async getHealthRaw(requestParameters: GetHealthRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
     ...
     * Check whether the API service is up and running.
     */
    async getHealth(requestParameters: GetHealthRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.getHealthRaw(requestParameters, initOverrides);
    }
