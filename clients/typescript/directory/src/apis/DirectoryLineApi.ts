...
export class DirectoryLineApi extends runtime.BaseAPI {
     ...
     * Search for a directory line
     */
    async searchDirectoryLine(requestParameters: SearchDirectoryLineRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DirectoryLineSearchPost200Response> {
