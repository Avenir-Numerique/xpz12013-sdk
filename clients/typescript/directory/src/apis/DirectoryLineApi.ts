...
import {
    ...
    DirectoryLinePayloadLegalUnitFacilityRoutingCodeFromJSON,
    DirectoryLinePayloadLegalUnitFacilityRoutingCodeToJSON,
    DirectoryLineSearchPost200ResponseFromJSON,
    DirectoryLineSearchPost200ResponseToJSON,
    SearchDirectoryLineFromJSON,
    SearchDirectoryLineToJSON,
} from '../models/index';

export interface GetDirectoryLineByIdRequest {
    addressingIdentifier: string;
    include?: Array<GetDirectoryLineByIdIncludeEnum>;
    fields?: Array<DirectoryLineField>;
}

export interface SearchDirectoryLineRequest {
    searchDirectoryLine?: SearchDirectoryLine;
}

/**
 * 
 */
export class DirectoryLineApi extends runtime.BaseAPI {

    /**
     * Retrieve the data from the directory line corresponding to the identifier passed in parameters.
     * Get a directory line.
     */
    async getDirectoryLineByIdRaw(requestParameters: GetDirectoryLineByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DirectoryLinePayloadLegalUnitFacilityRoutingCode>> {
        if (requestParameters['addressingIdentifier'] == null) {
            throw new runtime.RequiredError(
                'addressingIdentifier',
                'Required parameter "addressingIdentifier" was null or undefined when calling getDirectoryLineById().'
            );
        }
        ...
        const response = await this.request({
            path: `/v1/directory-line/code:{addressing-identifier}`.replace(`{${"addressing-identifier"}}`, encodeURIComponent(String(requestParameters['addressingIdentifier']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => DirectoryLinePayloadLegalUnitFacilityRoutingCodeFromJSON(jsonValue));
    }
     ...
     * Get a directory line.
     */
    async getDirectoryLineById(requestParameters: GetDirectoryLineByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DirectoryLinePayloadLegalUnitFacilityRoutingCode> {
        const response = await this.getDirectoryLineByIdRaw(requestParameters, initOverrides);
     ...
     */
    async searchDirectoryLineRaw(requestParameters: SearchDirectoryLineRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DirectoryLineSearchPost200Response>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/v1/directory-line/search`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: SearchDirectoryLineToJSON(requestParameters['searchDirectoryLine']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => DirectoryLineSearchPost200ResponseFromJSON(jsonValue));
    }
     ...
     * Search for a directory line
     */
    async searchDirectoryLine(requestParameters: SearchDirectoryLineRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DirectoryLineSearchPost200Response | null | undefined > {
        const response = await this.searchDirectoryLineRaw(requestParameters, initOverrides);
 ...
 * @export
 */
export const GetDirectoryLineByIdIncludeEnum = {
    Siren: 'siren',
    Siret: 'siret',
    RoutingCode: 'routingCode'
} as const;
export type GetDirectoryLineByIdIncludeEnum = typeof GetDirectoryLineByIdIncludeEnum[keyof typeof GetDirectoryLineByIdIncludeEnum];
