...
import {
    LegalUnitPayloadHistoryFromJSON,
    LegalUnitPayloadHistoryToJSON,
    SearchSirenFromJSON,
    SearchSirenToJSON,
    SirenFieldFromJSON,
    SirenFieldToJSON,
    SirenSearchPost200ResponseFromJSON,
    SirenSearchPost200ResponseToJSON,
} from '../models/index';

export interface GetCompanyBySirenRequest {
    siren: string;
    fields?: Array<SirenField>;
}

export interface SearchCompanyBySirenRequest {
    searchSiren?: SearchSiren;
}

/**
 * 
 */
export class SirenApi extends runtime.BaseAPI {

    /**
     * Returns the details of a company (legal unit) identified by the SIREN number passed as a parameter.
     * Consult a siren (legal unit) by SIREN number
     */
    async getCompanyBySirenRaw(requestParameters: GetCompanyBySirenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LegalUnitPayloadHistory>> {
        if (requestParameters['siren'] == null) {
            throw new runtime.RequiredError(
                'siren',
                'Required parameter "siren" was null or undefined when calling getCompanyBySiren().'
            );
        }
        ...
        const response = await this.request({
            path: `/v1/siren/code-insee:{siren}`.replace(`{${"siren"}}`, encodeURIComponent(String(requestParameters['siren']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => LegalUnitPayloadHistoryFromJSON(jsonValue));
    }
     ...
     * Consult a siren (legal unit) by SIREN number
     */
    async getCompanyBySiren(requestParameters: GetCompanyBySirenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LegalUnitPayloadHistory> {
        const response = await this.getCompanyBySirenRaw(requestParameters, initOverrides);
     ...
     */
    async searchCompanyBySirenRaw(requestParameters: SearchCompanyBySirenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SirenSearchPost200Response>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/v1/siren/search`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: SearchSirenToJSON(requestParameters['searchSiren']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => SirenSearchPost200ResponseFromJSON(jsonValue));
    }
     ...
     * SIREN search (or legal unit)
     */
    async searchCompanyBySiren(requestParameters: SearchCompanyBySirenRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SirenSearchPost200Response | null | undefined > {
        const response = await this.searchCompanyBySirenRaw(requestParameters, initOverrides);
