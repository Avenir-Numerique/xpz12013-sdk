...
export class SirenApi extends runtime.BaseAPI {
     ...
     * SIREN search (or legal unit)
     */
    async searchCompanyBySiren(requestParameters: SearchCompanyBySirenRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SirenSearchPost200Response> {
