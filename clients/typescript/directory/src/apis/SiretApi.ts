...
import {
    FacilityPayloadHistoryFromJSON,
    FacilityPayloadHistoryToJSON,
    SearchSiretFromJSON,
    SearchSiretToJSON,
    SiretFieldFromJSON,
    SiretFieldToJSON,
    SiretSearchPost200ResponseFromJSON,
    SiretSearchPost200ResponseToJSON,
} from '../models/index';

export interface GetFacilityBySiretRequest {
    siret: string;
    fields?: Array<SiretField>;
    include?: Array<GetFacilityBySiretIncludeEnum>;
}

export interface SearchFacilityBySiretRequest {
    searchSiret?: SearchSiret;
}

/**
 * 
 */
export class SiretApi extends runtime.BaseAPI {

    /**
     * Returns the details of a facility associated to a SIRET.
     * Gets a siret (facility) by SIRET number
     */
    async getFacilityBySiretRaw(requestParameters: GetFacilityBySiretRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FacilityPayloadHistory>> {
        if (requestParameters['siret'] == null) {
            throw new runtime.RequiredError(
                'siret',
                'Required parameter "siret" was null or undefined when calling getFacilityBySiret().'
            );
        }
        ...
        const response = await this.request({
            path: `/v1/siret/code-insee:{siret}`.replace(`{${"siret"}}`, encodeURIComponent(String(requestParameters['siret']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => FacilityPayloadHistoryFromJSON(jsonValue));
    }
     ...
     * Gets a siret (facility) by SIRET number
     */
    async getFacilityBySiret(requestParameters: GetFacilityBySiretRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FacilityPayloadHistory> {
        const response = await this.getFacilityBySiretRaw(requestParameters, initOverrides);
     ...
     */
    async searchFacilityBySiretRaw(requestParameters: SearchFacilityBySiretRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SiretSearchPost200Response>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/v1/siret/search`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: SearchSiretToJSON(requestParameters['searchSiret']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => SiretSearchPost200ResponseFromJSON(jsonValue));
    }
     ...
     * Search for a SIRET (facility)
     */
    async searchFacilityBySiret(requestParameters: SearchFacilityBySiretRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SiretSearchPost200Response | null | undefined > {
        const response = await this.searchFacilityBySiretRaw(requestParameters, initOverrides);
 ...
 * @export
 */
export const GetFacilityBySiretIncludeEnum = {
    Siren: 'siren'
} as const;
export type GetFacilityBySiretIncludeEnum = typeof GetFacilityBySiretIncludeEnum[keyof typeof GetFacilityBySiretIncludeEnum];
