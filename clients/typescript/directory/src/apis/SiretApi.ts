...
export class SiretApi extends runtime.BaseAPI {
     ...
     * Search for a SIRET (facility)
     */
    async searchFacilityBySiret(requestParameters: SearchFacilityBySiretRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SiretSearchPost200Response> {
