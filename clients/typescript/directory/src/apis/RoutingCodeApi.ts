...
export class RoutingCodeApi extends runtime.BaseAPI {
     ...
     * Search for a routing code
     */
    async searchRoutingCode(requestParameters: SearchRoutingCodeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RoutingCodeSearchPost200Response | null | undefined > {
