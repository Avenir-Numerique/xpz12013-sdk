 ...
 * @export
 */
export const ContainsOrStrictOperator = {
    Contains: 'contains',
    Strict: 'strict'
} as const;
export type ContainsOrStrictOperator = typeof ContainsOrStrictOperator[keyof typeof ContainsOrStrictOperator];


export function instanceOfContainsOrStrictOperator(value: any): boolean {
    for (const key in ContainsOrStrictOperator) {
        if (Object.prototype.hasOwnProperty.call(ContainsOrStrictOperator, key)) {
            if (ContainsOrStrictOperator[key as keyof typeof ContainsOrStrictOperator] === value) {
                return true;
            }
        }
    }
...
export function ContainsOrStrictOperatorFromJSON(json: any): ContainsOrStrictOperator {
    return ContainsOrStrictOperatorFromJSONTyped(json, false);
}

export function ContainsOrStrictOperatorFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContainsOrStrictOperator {
    return json as ContainsOrStrictOperator;
}

export function ContainsOrStrictOperatorToJSON(value?: ContainsOrStrictOperator | null): any {
    return value as any;
}

export function ContainsOrStrictOperatorToJSONTyped(value: any, ignoreDiscriminator: boolean): ContainsOrStrictOperator {
    return value as ContainsOrStrictOperator;
}
