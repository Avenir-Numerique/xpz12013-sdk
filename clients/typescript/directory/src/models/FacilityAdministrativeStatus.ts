 ...
 * @export
 */
export const FacilityAdministrativeStatus = {
    A: 'A',
    C: 'C'
} as const;
export type FacilityAdministrativeStatus = typeof FacilityAdministrativeStatus[keyof typeof FacilityAdministrativeStatus];


export function instanceOfFacilityAdministrativeStatus(value: any): boolean {
    for (const key in FacilityAdministrativeStatus) {
        if (Object.prototype.hasOwnProperty.call(FacilityAdministrativeStatus, key)) {
            if (FacilityAdministrativeStatus[key as keyof typeof FacilityAdministrativeStatus] === value) {
                return true;
            }
        }
    }
...
export function FacilityAdministrativeStatusFromJSON(json: any): FacilityAdministrativeStatus {
    return FacilityAdministrativeStatusFromJSONTyped(json, false);
}

export function FacilityAdministrativeStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): FacilityAdministrativeStatus {
    return json as FacilityAdministrativeStatus;
}

export function FacilityAdministrativeStatusToJSON(value?: FacilityAdministrativeStatus | null): any {
    return value as any;
}

export function FacilityAdministrativeStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): FacilityAdministrativeStatus {
    return value as FacilityAdministrativeStatus;
}
