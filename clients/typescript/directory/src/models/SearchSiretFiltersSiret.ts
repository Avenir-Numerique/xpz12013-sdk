 ...
 * 
 * @export
 * @interface SearchSiretFiltersSiret
 */
export interface SearchSiretFiltersSiret {
    /**
     * 
     * @type {StrictOperator}
     * @memberof SearchSiretFiltersSiret
     */
    op?: StrictOperator;
    /**
...
/**
 * Check if a given object implements the SearchSiretFiltersSiret interface.
 */
export function instanceOfSearchSiretFiltersSiret(value: object): value is SearchSiretFiltersSiret {
    return true;
}

export function SearchSiretFiltersSiretFromJSON(json: any): SearchSiretFiltersSiret {
    return SearchSiretFiltersSiretFromJSONTyped(json, false);
}

export function SearchSiretFiltersSiretFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSiretFiltersSiret {
    if (json == null) {
        return json;
    }
    return {
...
export function SearchSiretFiltersSiretToJSON(json: any): SearchSiretFiltersSiret {
    return SearchSiretFiltersSiretToJSONTyped(json, false);
}

export function SearchSiretFiltersSiretToJSONTyped(value?: SearchSiretFiltersSiret | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
