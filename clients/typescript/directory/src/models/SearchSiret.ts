...
import type { SiretField } from './SiretField';
import {
    SiretFieldFromJSON,
    SiretFieldFromJSONTyped,
    SiretFieldToJSON,
    SiretFieldToJSONTyped,
} from './SiretField';
import type { SearchSiretSortingInner } from './SearchSiretSortingInner';
import {
    SearchSiretSortingInnerFromJSON,
    SearchSiretSortingInnerFromJSONTyped,
    SearchSiretSortingInnerToJSON,
    SearchSiretSortingInnerToJSONTyped,
} from './SearchSiretSortingInner';
import type { SearchSiretFilters } from './SearchSiretFilters';
import {
    SearchSiretFiltersFromJSON,
    SearchSiretFiltersFromJSONTyped,
    SearchSiretFiltersToJSON,
    SearchSiretFiltersToJSONTyped,
} from './SearchSiretFilters';

/**
 * 
 * @export
 * @interface SearchSiret
 */
export interface SearchSiret {
    /**
     * 
     * @type {SearchSiretFilters}
     * @memberof SearchSiret
     */
    filters?: SearchSiretFilters;
    /**
     * Sorting criteria on a field and an order (ascending or descending).
     * @type {Array<SearchSiretSortingInner>}
     * @memberof SearchSiret
     */
    sorting?: Array<SearchSiretSortingInner>;
    /**
     * Allows you to filter the desired fields in the response.
     * @type {Array<SiretField>}
     * @memberof SearchSiret
     */
    fields?: Array<SiretField>;
    /**
     * 
     * @type {Array<string>}
     * @memberof SearchSiret
     */
    include?: Array<SearchSiretIncludeEnum>;
    /**
 ...
 * @export
 */
export const SearchSiretIncludeEnum = {
    Siren: 'siren'
} as const;
export type SearchSiretIncludeEnum = typeof SearchSiretIncludeEnum[keyof typeof SearchSiretIncludeEnum];


/**
 * Check if a given object implements the SearchSiret interface.
 */
export function instanceOfSearchSiret(value: object): value is SearchSiret {
    return true;
}

export function SearchSiretFromJSON(json: any): SearchSiret {
    return SearchSiretFromJSONTyped(json, false);
}

export function SearchSiretFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSiret {
    if (json == null) {
        return json;
    }
    return {
        
        'filters': json['filters'] == null ? undefined : SearchSiretFiltersFromJSON(json['filters']),
        'sorting': json['sorting'] == null ? undefined : ((json['sorting'] as Array<any>).map(SearchSiretSortingInnerFromJSON)),
        'fields': json['fields'] == null ? undefined : ((json['fields'] as Array<any>).map(SiretFieldFromJSON)),
...
export function SearchSiretToJSON(json: any): SearchSiret {
    return SearchSiretToJSONTyped(json, false);
}

export function SearchSiretToJSONTyped(value?: SearchSiret | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'filters': SearchSiretFiltersToJSON(value['filters']),
        'sorting': value['sorting'] == null ? undefined : ((value['sorting'] as Array<any>).map(SearchSiretSortingInnerToJSON)),
        'fields': value['fields'] == null ? undefined : ((value['fields'] as Array<any>).map(SiretFieldToJSON)),
