 ...
 * @export
 */
export const StrictOperator = {
    Strict: 'strict'
} as const;
export type StrictOperator = typeof StrictOperator[keyof typeof StrictOperator];


export function instanceOfStrictOperator(value: any): boolean {
    for (const key in StrictOperator) {
        if (Object.prototype.hasOwnProperty.call(StrictOperator, key)) {
            if (StrictOperator[key as keyof typeof StrictOperator] === value) {
                return true;
            }
        }
    }
...
export function StrictOperatorFromJSON(json: any): StrictOperator {
    return StrictOperatorFromJSONTyped(json, false);
}

export function StrictOperatorFromJSONTyped(json: any, ignoreDiscriminator: boolean): StrictOperator {
    return json as StrictOperator;
}

export function StrictOperatorToJSON(value?: StrictOperator | null): any {
    return value as any;
}

export function StrictOperatorToJSONTyped(value: any, ignoreDiscriminator: boolean): StrictOperator {
    return value as StrictOperator;
}
