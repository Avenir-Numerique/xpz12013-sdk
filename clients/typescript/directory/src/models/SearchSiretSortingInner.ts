 ...
 * @export
 * @interface SearchSiretSortingInner
 */
export interface SearchSiretSortingInner {
    /**
     * 
     * @type {SiretField}
     * @memberof SearchSiretSortingInner
     */
    field?: SiretField;
    /**
     * 
...
/**
 * Check if a given object implements the SearchSiretSortingInner interface.
 */
export function instanceOfSearchSiretSortingInner(value: object): value is SearchSiretSortingInner {
    return true;
}

export function SearchSiretSortingInnerFromJSON(json: any): SearchSiretSortingInner {
    return SearchSiretSortingInnerFromJSONTyped(json, false);
}

export function SearchSiretSortingInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSiretSortingInner {
    if (json == null) {
        return json;
    }
    return {
        
        'field': json['field'] == null ? undefined : SiretFieldFromJSON(json['field']),
        'sortingOrder': json['sortingOrder'] == null ? undefined : SortingOrderFromJSON(json['sortingOrder']),
    };
}

export function SearchSiretSortingInnerToJSON(json: any): SearchSiretSortingInner {
    return SearchSiretSortingInnerToJSONTyped(json, false);
}

export function SearchSiretSortingInnerToJSONTyped(value?: SearchSiretSortingInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'field': SiretFieldToJSON(value['field']),
