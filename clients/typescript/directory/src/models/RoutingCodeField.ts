...
export type RoutingCodeField = typeof RoutingCodeField[keyof typeof RoutingCodeField];


export function instanceOfRoutingCodeField(value: any): boolean {
    for (const key in RoutingCodeField) {
        if (Object.prototype.hasOwnProperty.call(RoutingCodeField, key)) {
            if (RoutingCodeField[key as keyof typeof RoutingCodeField] === value) {
                return true;
            }
        }
    }
...
export function RoutingCodeFieldFromJSON(json: any): RoutingCodeField {
    return RoutingCodeFieldFromJSONTyped(json, false);
}

export function RoutingCodeFieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutingCodeField {
    return json as RoutingCodeField;
}

export function RoutingCodeFieldToJSON(value?: RoutingCodeField | null): any {
    return value as any;
}

export function RoutingCodeFieldToJSONTyped(value: any, ignoreDiscriminator: boolean): RoutingCodeField {
    return value as RoutingCodeField;
}
