 ...
 * @export
 */
export const LegalUnitAdministrativeStatus = {
    A: 'A',
    C: 'C'
} as const;
export type LegalUnitAdministrativeStatus = typeof LegalUnitAdministrativeStatus[keyof typeof LegalUnitAdministrativeStatus];


export function instanceOfLegalUnitAdministrativeStatus(value: any): boolean {
    for (const key in LegalUnitAdministrativeStatus) {
        if (Object.prototype.hasOwnProperty.call(LegalUnitAdministrativeStatus, key)) {
            if (LegalUnitAdministrativeStatus[key as keyof typeof LegalUnitAdministrativeStatus] === value) {
                return true;
            }
        }
    }
...
export function LegalUnitAdministrativeStatusFromJSON(json: any): LegalUnitAdministrativeStatus {
    return LegalUnitAdministrativeStatusFromJSONTyped(json, false);
}

export function LegalUnitAdministrativeStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): LegalUnitAdministrativeStatus {
    return json as LegalUnitAdministrativeStatus;
}

export function LegalUnitAdministrativeStatusToJSON(value?: LegalUnitAdministrativeStatus | null): any {
    return value as any;
}

export function LegalUnitAdministrativeStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): LegalUnitAdministrativeStatus {
    return value as LegalUnitAdministrativeStatus;
}
