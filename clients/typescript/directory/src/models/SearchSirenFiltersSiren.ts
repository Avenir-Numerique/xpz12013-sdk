 ...
 * 
 * @export
 * @interface SearchSirenFiltersSiren
 */
export interface SearchSirenFiltersSiren {
    /**
     * 
     * @type {StrictOperator}
     * @memberof SearchSirenFiltersSiren
     */
    op?: StrictOperator;
    /**
...
/**
 * Check if a given object implements the SearchSirenFiltersSiren interface.
 */
export function instanceOfSearchSirenFiltersSiren(value: object): value is SearchSirenFiltersSiren {
    return true;
}

export function SearchSirenFiltersSirenFromJSON(json: any): SearchSirenFiltersSiren {
    return SearchSirenFiltersSirenFromJSONTyped(json, false);
}

export function SearchSirenFiltersSirenFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSirenFiltersSiren {
    if (json == null) {
        return json;
    }
    return {
...
export function SearchSirenFiltersSirenToJSON(json: any): SearchSirenFiltersSiren {
    return SearchSirenFiltersSirenToJSONTyped(json, false);
}

export function SearchSirenFiltersSirenToJSONTyped(value?: SearchSirenFiltersSiren | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
