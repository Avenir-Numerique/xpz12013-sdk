 ...
 * 
 * @export
 * @interface SearchSirenFiltersEntityType
 */
export interface SearchSirenFiltersEntityType {
    /**
     * 
     * @type {StrictOperator}
     * @memberof SearchSirenFiltersEntityType
     */
    op?: StrictOperator;
    /**
     * 
...
/**
 * Check if a given object implements the SearchSirenFiltersEntityType interface.
 */
export function instanceOfSearchSirenFiltersEntityType(value: object): value is SearchSirenFiltersEntityType {
    return true;
}

export function SearchSirenFiltersEntityTypeFromJSON(json: any): SearchSirenFiltersEntityType {
    return SearchSirenFiltersEntityTypeFromJSONTyped(json, false);
}

export function SearchSirenFiltersEntityTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSirenFiltersEntityType {
    if (json == null) {
        return json;
    }
    return {
        ...
        'value': json['value'] == null ? undefined : EntityTypeFromJSON(json['value']),
    };
}

export function SearchSirenFiltersEntityTypeToJSON(json: any): SearchSirenFiltersEntityType {
    return SearchSirenFiltersEntityTypeToJSONTyped(json, false);
}

export function SearchSirenFiltersEntityTypeToJSONTyped(value?: SearchSirenFiltersEntityType | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'value': EntityTypeToJSON(value['value']),
    };
}
