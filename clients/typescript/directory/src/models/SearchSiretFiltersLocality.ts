 ...
 * 
 * @export
 * @interface SearchSiretFiltersLocality
 */
export interface SearchSiretFiltersLocality {
    /**
     * 
     * @type {ContainsOrStrictOrStartWithOperator}
     * @memberof SearchSiretFiltersLocality
     */
...
/**
 * Check if a given object implements the SearchSiretFiltersLocality interface.
 */
export function instanceOfSearchSiretFiltersLocality(value: object): value is SearchSiretFiltersLocality {
    return true;
}

export function SearchSiretFiltersLocalityFromJSON(json: any): SearchSiretFiltersLocality {
    return SearchSiretFiltersLocalityFromJSONTyped(json, false);
}

export function SearchSiretFiltersLocalityFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSiretFiltersLocality {
    if (json == null) {
        return json;
    }
    return {
...
export function SearchSiretFiltersLocalityToJSON(json: any): SearchSiretFiltersLocality {
    return SearchSiretFiltersLocalityToJSONTyped(json, false);
}

export function SearchSiretFiltersLocalityToJSONTyped(value?: SearchSiretFiltersLocality | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
