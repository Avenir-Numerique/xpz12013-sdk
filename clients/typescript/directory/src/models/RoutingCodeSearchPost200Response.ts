...
import type { RoutingCodePayloadHistoryLegalUnitFacility } from './RoutingCodePayloadHistoryLegalUnitFacility';
import {
    RoutingCodePayloadHistoryLegalUnitFacilityFromJSON,
    RoutingCodePayloadHistoryLegalUnitFacilityFromJSONTyped,
    RoutingCodePayloadHistoryLegalUnitFacilityToJSON,
    RoutingCodePayloadHistoryLegalUnitFacilityToJSONTyped,
} from './RoutingCodePayloadHistoryLegalUnitFacility';
import type { RoutingCodeSearch } from './RoutingCodeSearch';
import {
    RoutingCodeSearchFromJSON,
    RoutingCodeSearchFromJSONTyped,
    RoutingCodeSearchToJSON,
    RoutingCodeSearchToJSONTyped,
} from './RoutingCodeSearch';

/**
 * 
 * @export
 * @interface RoutingCodeSearchPost200Response
 */
export interface RoutingCodeSearchPost200Response {
    /**
     * 
     * @type {RoutingCodeSearch}
     * @memberof RoutingCodeSearchPost200Response
     */
    ...
    /**
     * 
     * @type {Array<RoutingCodePayloadHistoryLegalUnitFacility>}
     * @memberof RoutingCodeSearchPost200Response
     */
    results?: Array<RoutingCodePayloadHistoryLegalUnitFacility>;
}

/**
 * Check if a given object implements the RoutingCodeSearchPost200Response interface.
 */
export function instanceOfRoutingCodeSearchPost200Response(value: object): value is RoutingCodeSearchPost200Response {
    return true;
}

export function RoutingCodeSearchPost200ResponseFromJSON(json: any): RoutingCodeSearchPost200Response {
    return RoutingCodeSearchPost200ResponseFromJSONTyped(json, false);
}

export function RoutingCodeSearchPost200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutingCodeSearchPost200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'search': json['search'] == null ? undefined : RoutingCodeSearchFromJSON(json['search']),
        'totalNumberOfResults': json['totalNumberOfResults'] == null ? undefined : json['totalNumberOfResults'],
        'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(RoutingCodePayloadHistoryLegalUnitFacilityFromJSON)),
    };
}

export function RoutingCodeSearchPost200ResponseToJSON(json: any): RoutingCodeSearchPost200Response {
    return RoutingCodeSearchPost200ResponseToJSONTyped(json, false);
}

export function RoutingCodeSearchPost200ResponseToJSONTyped(value?: RoutingCodeSearchPost200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'search': RoutingCodeSearchToJSON(value['search']),
        'totalNumberOfResults': value['totalNumberOfResults'],
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(RoutingCodePayloadHistoryLegalUnitFacilityToJSON)),
    };
}
