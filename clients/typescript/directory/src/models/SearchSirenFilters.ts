...
import type { SearchSirenFiltersEntityType } from './SearchSirenFiltersEntityType';
import {
    SearchSirenFiltersEntityTypeFromJSON,
    SearchSirenFiltersEntityTypeFromJSONTyped,
    SearchSirenFiltersEntityTypeToJSON,
    SearchSirenFiltersEntityTypeToJSONTyped,
} from './SearchSirenFiltersEntityType';
import type { SearchSirenFiltersBusinessName } from './SearchSirenFiltersBusinessName';
import {
    SearchSirenFiltersBusinessNameFromJSON,
    SearchSirenFiltersBusinessNameFromJSONTyped,
    SearchSirenFiltersBusinessNameToJSON,
    SearchSirenFiltersBusinessNameToJSONTyped,
} from './SearchSirenFiltersBusinessName';
...
import type { SearchSirenFiltersAdministrativeStatus } from './SearchSirenFiltersAdministrativeStatus';
import {
    SearchSirenFiltersAdministrativeStatusFromJSON,
    SearchSirenFiltersAdministrativeStatusFromJSONTyped,
    SearchSirenFiltersAdministrativeStatusToJSON,
    SearchSirenFiltersAdministrativeStatusToJSONTyped,
} from './SearchSirenFiltersAdministrativeStatus';

/**
 * 
 * @export
 * @interface SearchSirenFilters
 */
export interface SearchSirenFilters {
    /**
     * 
     * @type {SearchSirenFiltersSiren}
     * @memberof SearchSirenFilters
     */
    siren?: SearchSirenFiltersSiren;
    /**
     * 
     * @type {SearchSirenFiltersBusinessName}
     * @memberof SearchSirenFilters
     */
    businessName?: SearchSirenFiltersBusinessName;
    /**
     * 
     * @type {SearchSirenFiltersEntityType}
     * @memberof SearchSirenFilters
     */
    entityType?: SearchSirenFiltersEntityType;
    /**
     * 
     * @type {SearchSirenFiltersAdministrativeStatus}
     * @memberof SearchSirenFilters
     */
...
/**
 * Check if a given object implements the SearchSirenFilters interface.
 */
export function instanceOfSearchSirenFilters(value: object): value is SearchSirenFilters {
    return true;
}

export function SearchSirenFiltersFromJSON(json: any): SearchSirenFilters {
    return SearchSirenFiltersFromJSONTyped(json, false);
}

export function SearchSirenFiltersFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSirenFilters {
    if (json == null) {
        return json;
    }
    return {
        ...
        'businessName': json['businessName'] == null ? undefined : SearchSirenFiltersBusinessNameFromJSON(json['businessName']),
        'entityType': json['entityType'] == null ? undefined : SearchSirenFiltersEntityTypeFromJSON(json['entityType']),
        'administrativeStatus': json['administrativeStatus'] == null ? undefined : SearchSirenFiltersAdministrativeStatusFromJSON(json['administrativeStatus']),
    };
}

export function SearchSirenFiltersToJSON(json: any): SearchSirenFilters {
    return SearchSirenFiltersToJSONTyped(json, false);
}

export function SearchSirenFiltersToJSONTyped(value?: SearchSirenFilters | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'businessName': SearchSirenFiltersBusinessNameToJSON(value['businessName']),
        'entityType': SearchSirenFiltersEntityTypeToJSON(value['entityType']),
        'administrativeStatus': SearchSirenFiltersAdministrativeStatusToJSON(value['administrativeStatus']),
    };
}
