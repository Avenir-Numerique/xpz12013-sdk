...
/**
 * Check if a given object implements the AddressRead interface.
 */
export function instanceOfAddressRead(value: object): value is AddressRead {
    return true;
}

export function AddressReadFromJSON(json: any): AddressRead {
    return AddressReadFromJSONTyped(json, false);
}

export function AddressReadFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddressRead {
    if (json == null) {
        return json;
    }
    return {
...
export function AddressReadToJSON(json: any): AddressRead {
    return AddressReadToJSONTyped(json, false);
}

export function AddressReadToJSONTyped(value?: AddressRead | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
