 ...
 * 
 * @export
 * @interface RoutingCodePayloadHistoryLegalUnitFacility
 */
export interface RoutingCodePayloadHistoryLegalUnitFacility {
    /**
     * Routing identifier od a routing code.
     * @type {string}
     * @memberof RoutingCodePayloadHistoryLegalUnitFacility
     */
...
/**
 * Check if a given object implements the RoutingCodePayloadHistoryLegalUnitFacility interface.
 */
export function instanceOfRoutingCodePayloadHistoryLegalUnitFacility(value: object): value is RoutingCodePayloadHistoryLegalUnitFacility {
    return true;
}

export function RoutingCodePayloadHistoryLegalUnitFacilityFromJSON(json: any): RoutingCodePayloadHistoryLegalUnitFacility {
    return RoutingCodePayloadHistoryLegalUnitFacilityFromJSONTyped(json, false);
}

export function RoutingCodePayloadHistoryLegalUnitFacilityFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutingCodePayloadHistoryLegalUnitFacility {
    if (json == null) {
        return json;
    }
    return {
...
export function RoutingCodePayloadHistoryLegalUnitFacilityToJSON(json: any): RoutingCodePayloadHistoryLegalUnitFacility {
    return RoutingCodePayloadHistoryLegalUnitFacilityToJSONTyped(json, false);
}

export function RoutingCodePayloadHistoryLegalUnitFacilityToJSONTyped(value?: RoutingCodePayloadHistoryLegalUnitFacility | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
