 ...
 * @export
 */
export const DirectoryLineField = {
...
export type DirectoryLineField = typeof DirectoryLineField[keyof typeof DirectoryLineField];


export function instanceOfDirectoryLineField(value: any): boolean {
    for (const key in DirectoryLineField) {
        if (Object.prototype.hasOwnProperty.call(DirectoryLineField, key)) {
            if (DirectoryLineField[key as keyof typeof DirectoryLineField] === value) {
                return true;
            }
        }
    }
...
export function DirectoryLineFieldFromJSON(json: any): DirectoryLineField {
    return DirectoryLineFieldFromJSONTyped(json, false);
}

export function DirectoryLineFieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): DirectoryLineField {
    return json as DirectoryLineField;
}

export function DirectoryLineFieldToJSON(value?: DirectoryLineField | null): any {
    return value as any;
}

export function DirectoryLineFieldToJSONTyped(value: any, ignoreDiscriminator: boolean): DirectoryLineField {
    return value as DirectoryLineField;
}
