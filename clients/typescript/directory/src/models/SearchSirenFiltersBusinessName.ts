...
import type { ContainsOrStrictOrStartWithOperator } from './ContainsOrStrictOrStartWithOperator';
import {
    ContainsOrStrictOrStartWithOperatorFromJSON,
    ContainsOrStrictOrStartWithOperatorFromJSONTyped,
    ContainsOrStrictOrStartWithOperatorToJSON,
    ContainsOrStrictOrStartWithOperatorToJSONTyped,
} from './ContainsOrStrictOrStartWithOperator';

/**
 * 
 * @export
 * @interface SearchSirenFiltersBusinessName
 */
export interface SearchSirenFiltersBusinessName {
    /**
     * 
     * @type {ContainsOrStrictOrStartWithOperator}
     * @memberof SearchSirenFiltersBusinessName
     */
    op?: ContainsOrStrictOrStartWithOperator;
    /**
     * Business name
     * @type {string}
     * @memberof SearchSirenFiltersBusinessName
...
/**
 * Check if a given object implements the SearchSirenFiltersBusinessName interface.
 */
export function instanceOfSearchSirenFiltersBusinessName(value: object): value is SearchSirenFiltersBusinessName {
    return true;
}

export function SearchSirenFiltersBusinessNameFromJSON(json: any): SearchSirenFiltersBusinessName {
    return SearchSirenFiltersBusinessNameFromJSONTyped(json, false);
}

export function SearchSirenFiltersBusinessNameFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSirenFiltersBusinessName {
    if (json == null) {
        return json;
    }
    return {
        
        'op': json['op'] == null ? undefined : ContainsOrStrictOrStartWithOperatorFromJSON(json['op']),
        'value': json['value'] == null ? undefined : json['value'],
    };
}

export function SearchSirenFiltersBusinessNameToJSON(json: any): SearchSirenFiltersBusinessName {
    return SearchSirenFiltersBusinessNameToJSONTyped(json, false);
}

export function SearchSirenFiltersBusinessNameToJSONTyped(value?: SearchSirenFiltersBusinessName | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'op': ContainsOrStrictOrStartWithOperatorToJSON(value['op']),
        'value': value['value'],
    };
}
