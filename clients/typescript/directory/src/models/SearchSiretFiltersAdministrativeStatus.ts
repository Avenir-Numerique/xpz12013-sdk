 ...
 * 
 * @export
 * @interface SearchSiretFiltersAdministrativeStatus
 */
export interface SearchSiretFiltersAdministrativeStatus {
    /**
     * 
     * @type {StrictOperator}
     * @memberof SearchSiretFiltersAdministrativeStatus
     */
    op?: StrictOperator;
    /**
     * 
     ...
     * @memberof SearchSiretFiltersAdministrativeStatus
     */
    value?: FacilityAdministrativeStatus;
}



/**
 * Check if a given object implements the SearchSiretFiltersAdministrativeStatus interface.
 */
export function instanceOfSearchSiretFiltersAdministrativeStatus(value: object): value is SearchSiretFiltersAdministrativeStatus {
    return true;
}

export function SearchSiretFiltersAdministrativeStatusFromJSON(json: any): SearchSiretFiltersAdministrativeStatus {
    return SearchSiretFiltersAdministrativeStatusFromJSONTyped(json, false);
}

export function SearchSiretFiltersAdministrativeStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSiretFiltersAdministrativeStatus {
    if (json == null) {
        return json;
    }
    return {
        ...
        'value': json['value'] == null ? undefined : FacilityAdministrativeStatusFromJSON(json['value']),
    };
}

export function SearchSiretFiltersAdministrativeStatusToJSON(json: any): SearchSiretFiltersAdministrativeStatus {
    return SearchSiretFiltersAdministrativeStatusToJSONTyped(json, false);
}

export function SearchSiretFiltersAdministrativeStatusToJSONTyped(value?: SearchSiretFiltersAdministrativeStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'value': FacilityAdministrativeStatusToJSON(value['value']),
    };
}
