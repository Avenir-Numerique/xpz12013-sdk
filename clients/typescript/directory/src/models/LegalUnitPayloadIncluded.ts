...
import type { LegalUnitAdministrativeStatus } from './LegalUnitAdministrativeStatus';
import {
    LegalUnitAdministrativeStatusFromJSON,
    LegalUnitAdministrativeStatusFromJSONTyped,
    LegalUnitAdministrativeStatusToJSON,
    LegalUnitAdministrativeStatusToJSONTyped,
} from './LegalUnitAdministrativeStatus';
import type { SirenInstructions } from './SirenInstructions';
import {
    SirenInstructionsFromJSON,
    SirenInstructionsFromJSONTyped,
    SirenInstructionsToJSON,
    SirenInstructionsToJSONTyped,
} from './SirenInstructions';

/**
 * 
 * @export
 * @interface LegalUnitPayloadIncluded
 */
export interface LegalUnitPayloadIncluded {
    /**
     * SIREN number
     * @type {string}
     * @memberof LegalUnitPayloadIncluded
     */
    siren?: string;
    /**
     * Business name
    ...
    /**
     * 
     * @type {LegalUnitAdministrativeStatus}
     * @memberof LegalUnitPayloadIncluded
     */
    administrativeStatus?: LegalUnitAdministrativeStatus;
    /**
     * 
     * @type {SirenInstructions}
     * @memberof LegalUnitPayloadIncluded
     */
    instructions?: SirenInstructions;
}



/**
 * Check if a given object implements the LegalUnitPayloadIncluded interface.
 */
export function instanceOfLegalUnitPayloadIncluded(value: object): value is LegalUnitPayloadIncluded {
    return true;
}

export function LegalUnitPayloadIncludedFromJSON(json: any): LegalUnitPayloadIncluded {
    return LegalUnitPayloadIncludedFromJSONTyped(json, false);
}

export function LegalUnitPayloadIncludedFromJSONTyped(json: any, ignoreDiscriminator: boolean): LegalUnitPayloadIncluded {
    if (json == null) {
        return json;
    }
    return {
        ...
        'entityType': json['entityType'] == null ? undefined : EntityTypeFromJSON(json['entityType']),
        'administrativeStatus': json['administrativeStatus'] == null ? undefined : LegalUnitAdministrativeStatusFromJSON(json['administrativeStatus']),
        'instructions': json['instructions'] == null ? undefined : SirenInstructionsFromJSON(json['instructions']),
    };
}

export function LegalUnitPayloadIncludedToJSON(json: any): LegalUnitPayloadIncluded {
    return LegalUnitPayloadIncludedToJSONTyped(json, false);
}

export function LegalUnitPayloadIncludedToJSONTyped(value?: LegalUnitPayloadIncluded | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'administrativeStatus': LegalUnitAdministrativeStatusToJSON(value['administrativeStatus']),
        'instructions': SirenInstructionsToJSON(value['instructions']),
    };
}
