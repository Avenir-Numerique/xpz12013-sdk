...
import type { SearchSiretFiltersAdministrativeStatus } from './SearchSiretFiltersAdministrativeStatus';
import {
    SearchSiretFiltersAdministrativeStatusFromJSON,
    SearchSiretFiltersAdministrativeStatusFromJSONTyped,
    SearchSiretFiltersAdministrativeStatusToJSON,
    SearchSiretFiltersAdministrativeStatusToJSONTyped,
} from './SearchSiretFiltersAdministrativeStatus';
import type { SearchSiretFiltersLocality } from './SearchSiretFiltersLocality';
import {
    SearchSiretFiltersLocalityFromJSON,
    SearchSiretFiltersLocalityFromJSONTyped,
    SearchSiretFiltersLocalityToJSON,
    SearchSiretFiltersLocalityToJSONTyped,
} from './SearchSiretFiltersLocality';
import type { SearchSiretFiltersAddressLines } from './SearchSiretFiltersAddressLines';
import {
    SearchSiretFiltersAddressLinesFromJSON,
    SearchSiretFiltersAddressLinesFromJSONTyped,
    SearchSiretFiltersAddressLinesToJSON,
    SearchSiretFiltersAddressLinesToJSONTyped,
} from './SearchSiretFiltersAddressLines';
import type { SearchSiretFiltersName } from './SearchSiretFiltersName';
import {
    SearchSiretFiltersNameFromJSON,
    SearchSiretFiltersNameFromJSONTyped,
    SearchSiretFiltersNameToJSON,
    SearchSiretFiltersNameToJSONTyped,
} from './SearchSiretFiltersName';
import type { SearchSiretFiltersFacilityType } from './SearchSiretFiltersFacilityType';
import {
    SearchSiretFiltersFacilityTypeFromJSON,
    SearchSiretFiltersFacilityTypeFromJSONTyped,
    SearchSiretFiltersFacilityTypeToJSON,
    SearchSiretFiltersFacilityTypeToJSONTyped,
} from './SearchSiretFiltersFacilityType';
import type { SearchSiretFiltersPostalCode } from './SearchSiretFiltersPostalCode';
import {
    SearchSiretFiltersPostalCodeFromJSON,
    SearchSiretFiltersPostalCodeFromJSONTyped,
    SearchSiretFiltersPostalCodeToJSON,
    SearchSiretFiltersPostalCodeToJSONTyped,
} from './SearchSiretFiltersPostalCode';
import type { SearchSirenFiltersSiren } from './SearchSirenFiltersSiren';
import {
    SearchSirenFiltersSirenFromJSON,
    SearchSirenFiltersSirenFromJSONTyped,
    SearchSirenFiltersSirenToJSON,
    SearchSirenFiltersSirenToJSONTyped,
} from './SearchSirenFiltersSiren';
import type { SearchSiretFiltersCountrySubdivision } from './SearchSiretFiltersCountrySubdivision';
import {
    SearchSiretFiltersCountrySubdivisionFromJSON,
    SearchSiretFiltersCountrySubdivisionFromJSONTyped,
    SearchSiretFiltersCountrySubdivisionToJSON,
    SearchSiretFiltersCountrySubdivisionToJSONTyped,
} from './SearchSiretFiltersCountrySubdivision';
import type { SearchSiretFiltersSiret } from './SearchSiretFiltersSiret';
import {
    SearchSiretFiltersSiretFromJSON,
    SearchSiretFiltersSiretFromJSONTyped,
    SearchSiretFiltersSiretToJSON,
    SearchSiretFiltersSiretToJSONTyped,
} from './SearchSiretFiltersSiret';

/**
 * 
 * @export
 * @interface SearchSiretFilters
 */
export interface SearchSiretFilters {
    /**
     * 
     * @type {SearchSiretFiltersSiret}
     * @memberof SearchSiretFilters
     */
    siret?: SearchSiretFiltersSiret;
    /**
     * 
     * @type {SearchSirenFiltersSiren}
     * @memberof SearchSiretFilters
     */
    siren?: SearchSirenFiltersSiren;
    /**
     * 
     * @type {SearchSiretFiltersFacilityType}
     * @memberof SearchSiretFilters
     */
    facilityType?: SearchSiretFiltersFacilityType;
    /**
     * 
     * @type {SearchSiretFiltersName}
     * @memberof SearchSiretFilters
     */
    name?: SearchSiretFiltersName;
    /**
     * 
     * @type {SearchSiretFiltersAddressLines}
     * @memberof SearchSiretFilters
     */
    addressLines?: SearchSiretFiltersAddressLines;
    /**
     * 
     * @type {SearchSiretFiltersPostalCode}
     * @memberof SearchSiretFilters
     */
    postalCode?: SearchSiretFiltersPostalCode;
    /**
     * 
     * @type {SearchSiretFiltersCountrySubdivision}
     * @memberof SearchSiretFilters
     */
    countrySubdivision?: SearchSiretFiltersCountrySubdivision;
    /**
     * 
     * @type {SearchSiretFiltersLocality}
     * @memberof SearchSiretFilters
     */
    locality?: SearchSiretFiltersLocality;
    /**
     * 
     * @type {SearchSiretFiltersAdministrativeStatus}
     * @memberof SearchSiretFilters
     */
    administrativeStatus?: SearchSiretFiltersAdministrativeStatus;
}

/**
 * Check if a given object implements the SearchSiretFilters interface.
 */
export function instanceOfSearchSiretFilters(value: object): value is SearchSiretFilters {
    return true;
}

export function SearchSiretFiltersFromJSON(json: any): SearchSiretFilters {
    return SearchSiretFiltersFromJSONTyped(json, false);
}

export function SearchSiretFiltersFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSiretFilters {
    if (json == null) {
        return json;
    }
    return {
        
        'siret': json['siret'] == null ? undefined : SearchSiretFiltersSiretFromJSON(json['siret']),
        'siren': json['siren'] == null ? undefined : SearchSirenFiltersSirenFromJSON(json['siren']),
        'facilityType': json['facilityType'] == null ? undefined : SearchSiretFiltersFacilityTypeFromJSON(json['facilityType']),
        'name': json['name'] == null ? undefined : SearchSiretFiltersNameFromJSON(json['name']),
        'addressLines': json['addressLines'] == null ? undefined : SearchSiretFiltersAddressLinesFromJSON(json['addressLines']),
        'postalCode': json['postalCode'] == null ? undefined : SearchSiretFiltersPostalCodeFromJSON(json['postalCode']),
        'countrySubdivision': json['countrySubdivision'] == null ? undefined : SearchSiretFiltersCountrySubdivisionFromJSON(json['countrySubdivision']),
        'locality': json['locality'] == null ? undefined : SearchSiretFiltersLocalityFromJSON(json['locality']),
        'administrativeStatus': json['administrativeStatus'] == null ? undefined : SearchSiretFiltersAdministrativeStatusFromJSON(json['administrativeStatus']),
    };
}

export function SearchSiretFiltersToJSON(json: any): SearchSiretFilters {
    return SearchSiretFiltersToJSONTyped(json, false);
}

export function SearchSiretFiltersToJSONTyped(value?: SearchSiretFilters | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'siret': SearchSiretFiltersSiretToJSON(value['siret']),
        'siren': SearchSirenFiltersSirenToJSON(value['siren']),
        'facilityType': SearchSiretFiltersFacilityTypeToJSON(value['facilityType']),
        'name': SearchSiretFiltersNameToJSON(value['name']),
        'addressLines': SearchSiretFiltersAddressLinesToJSON(value['addressLines']),
        'postalCode': SearchSiretFiltersPostalCodeToJSON(value['postalCode']),
        'countrySubdivision': SearchSiretFiltersCountrySubdivisionToJSON(value['countrySubdivision']),
        'locality': SearchSiretFiltersLocalityToJSON(value['locality']),
        'administrativeStatus': SearchSiretFiltersAdministrativeStatusToJSON(value['administrativeStatus']),
    };
}
