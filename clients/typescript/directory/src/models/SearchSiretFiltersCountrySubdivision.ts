 ...
 * 
 * @export
 * @interface SearchSiretFiltersCountrySubdivision
 */
export interface SearchSiretFiltersCountrySubdivision {
    /**
     * 
     * @type {StrictOperator}
     * @memberof SearchSiretFiltersCountrySubdivision
     */
    op?: StrictOperator;
    /**
...
/**
 * Check if a given object implements the SearchSiretFiltersCountrySubdivision interface.
 */
export function instanceOfSearchSiretFiltersCountrySubdivision(value: object): value is SearchSiretFiltersCountrySubdivision {
    return true;
}

export function SearchSiretFiltersCountrySubdivisionFromJSON(json: any): SearchSiretFiltersCountrySubdivision {
    return SearchSiretFiltersCountrySubdivisionFromJSONTyped(json, false);
}

export function SearchSiretFiltersCountrySubdivisionFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSiretFiltersCountrySubdivision {
    if (json == null) {
        return json;
    }
    return {
...
export function SearchSiretFiltersCountrySubdivisionToJSON(json: any): SearchSiretFiltersCountrySubdivision {
    return SearchSiretFiltersCountrySubdivisionToJSONTyped(json, false);
}

export function SearchSiretFiltersCountrySubdivisionToJSONTyped(value?: SearchSiretFiltersCountrySubdivision | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
