...
import type { RoutingCodeSearchFiltersRoutingCodeName } from './RoutingCodeSearchFiltersRoutingCodeName';
import {
    RoutingCodeSearchFiltersRoutingCodeNameFromJSON,
    RoutingCodeSearchFiltersRoutingCodeNameFromJSONTyped,
    RoutingCodeSearchFiltersRoutingCodeNameToJSON,
    RoutingCodeSearchFiltersRoutingCodeNameToJSONTyped,
} from './RoutingCodeSearchFiltersRoutingCodeName';
...
import type { RoutingCodeSearchFiltersAdministrativeStatus } from './RoutingCodeSearchFiltersAdministrativeStatus';
import {
    RoutingCodeSearchFiltersAdministrativeStatusFromJSON,
    RoutingCodeSearchFiltersAdministrativeStatusFromJSONTyped,
    RoutingCodeSearchFiltersAdministrativeStatusToJSON,
    RoutingCodeSearchFiltersAdministrativeStatusToJSONTyped,
} from './RoutingCodeSearchFiltersAdministrativeStatus';
...
import type { RoutingCodeSearchFiltersRoutingIdentifier } from './RoutingCodeSearchFiltersRoutingIdentifier';
import {
    RoutingCodeSearchFiltersRoutingIdentifierFromJSON,
    RoutingCodeSearchFiltersRoutingIdentifierFromJSONTyped,
    RoutingCodeSearchFiltersRoutingIdentifierToJSON,
    RoutingCodeSearchFiltersRoutingIdentifierToJSONTyped,
} from './RoutingCodeSearchFiltersRoutingIdentifier';
 ...
 * 
 * @export
 * @interface RoutingCodeSearchFilters
 */
export interface RoutingCodeSearchFilters {
    /**
     * 
     * @type {RoutingCodeSearchFiltersRoutingIdentifier}
     * @memberof RoutingCodeSearchFilters
     */
    ...
    /**
     * 
     * @type {RoutingCodeSearchFiltersRoutingCodeName}
     * @memberof RoutingCodeSearchFilters
     */
    routingCodeName?: RoutingCodeSearchFiltersRoutingCodeName;
    /**
     * 
     * @type {RoutingCodeSearchFiltersAdministrativeStatus}
     * @memberof RoutingCodeSearchFilters
     */
...
/**
 * Check if a given object implements the RoutingCodeSearchFilters interface.
 */
export function instanceOfRoutingCodeSearchFilters(value: object): value is RoutingCodeSearchFilters {
    return true;
}

export function RoutingCodeSearchFiltersFromJSON(json: any): RoutingCodeSearchFilters {
    return RoutingCodeSearchFiltersFromJSONTyped(json, false);
}

export function RoutingCodeSearchFiltersFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutingCodeSearchFilters {
    if (json == null) {
        return json;
    }
    return {
        
        'routingIdentifier': json['routingIdentifier'] == null ? undefined : RoutingCodeSearchFiltersRoutingIdentifierFromJSON(json['routingIdentifier']),
        'siret': json['siret'] == null ? undefined : SearchSiretFiltersSiretFromJSON(json['siret']),
        'routingCodeName': json['routingCodeName'] == null ? undefined : RoutingCodeSearchFiltersRoutingCodeNameFromJSON(json['routingCodeName']),
        'administrativeStatus': json['administrativeStatus'] == null ? undefined : RoutingCodeSearchFiltersAdministrativeStatusFromJSON(json['administrativeStatus']),
...
export function RoutingCodeSearchFiltersToJSON(json: any): RoutingCodeSearchFilters {
    return RoutingCodeSearchFiltersToJSONTyped(json, false);
}

export function RoutingCodeSearchFiltersToJSONTyped(value?: RoutingCodeSearchFilters | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'routingIdentifier': RoutingCodeSearchFiltersRoutingIdentifierToJSON(value['routingIdentifier']),
        'siret': SearchSiretFiltersSiretToJSON(value['siret']),
        'routingCodeName': RoutingCodeSearchFiltersRoutingCodeNameToJSON(value['routingCodeName']),
        'administrativeStatus': RoutingCodeSearchFiltersAdministrativeStatusToJSON(value['administrativeStatus']),
