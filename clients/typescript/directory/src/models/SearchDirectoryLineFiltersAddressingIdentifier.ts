...
import type { ContainsOrStrictOperator } from './ContainsOrStrictOperator';
import {
    ContainsOrStrictOperatorFromJSON,
    ContainsOrStrictOperatorFromJSONTyped,
    ContainsOrStrictOperatorToJSON,
    ContainsOrStrictOperatorToJSONTyped,
} from './ContainsOrStrictOperator';

/**
 * 
 * @export
 * @interface SearchDirectoryLineFiltersAddressingIdentifier
 */
export interface SearchDirectoryLineFiltersAddressingIdentifier {
    /**
     * 
     * @type {ContainsOrStrictOperator}
     * @memberof SearchDirectoryLineFiltersAddressingIdentifier
     */
    op?: ContainsOrStrictOperator;
    /**
...
/**
 * Check if a given object implements the SearchDirectoryLineFiltersAddressingIdentifier interface.
 */
export function instanceOfSearchDirectoryLineFiltersAddressingIdentifier(value: object): value is SearchDirectoryLineFiltersAddressingIdentifier {
    return true;
}

export function SearchDirectoryLineFiltersAddressingIdentifierFromJSON(json: any): SearchDirectoryLineFiltersAddressingIdentifier {
    return SearchDirectoryLineFiltersAddressingIdentifierFromJSONTyped(json, false);
}

export function SearchDirectoryLineFiltersAddressingIdentifierFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchDirectoryLineFiltersAddressingIdentifier {
    if (json == null) {
        return json;
    }
    return {
        
        'op': json['op'] == null ? undefined : ContainsOrStrictOperatorFromJSON(json['op']),
        'value': json['value'] == null ? undefined : json['value'],
    };
}

export function SearchDirectoryLineFiltersAddressingIdentifierToJSON(json: any): SearchDirectoryLineFiltersAddressingIdentifier {
    return SearchDirectoryLineFiltersAddressingIdentifierToJSONTyped(json, false);
}

export function SearchDirectoryLineFiltersAddressingIdentifierToJSONTyped(value?: SearchDirectoryLineFiltersAddressingIdentifier | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'op': ContainsOrStrictOperatorToJSON(value['op']),
        'value': value['value'],
    };
}
