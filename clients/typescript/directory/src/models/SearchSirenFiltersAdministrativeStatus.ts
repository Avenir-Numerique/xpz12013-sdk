 ...
 * 
 * @export
 * @interface SearchSirenFiltersAdministrativeStatus
 */
export interface SearchSirenFiltersAdministrativeStatus {
    /**
     * 
     * @type {StrictOperator}
     * @memberof SearchSirenFiltersAdministrativeStatus
     */
    op?: StrictOperator;
    /**
     * 
     ...
     * @memberof SearchSirenFiltersAdministrativeStatus
     */
    value?: LegalUnitAdministrativeStatus;
}



/**
 * Check if a given object implements the SearchSirenFiltersAdministrativeStatus interface.
 */
export function instanceOfSearchSirenFiltersAdministrativeStatus(value: object): value is SearchSirenFiltersAdministrativeStatus {
    return true;
}

export function SearchSirenFiltersAdministrativeStatusFromJSON(json: any): SearchSirenFiltersAdministrativeStatus {
    return SearchSirenFiltersAdministrativeStatusFromJSONTyped(json, false);
}

export function SearchSirenFiltersAdministrativeStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSirenFiltersAdministrativeStatus {
    if (json == null) {
        return json;
    }
    return {
        ...
        'value': json['value'] == null ? undefined : LegalUnitAdministrativeStatusFromJSON(json['value']),
    };
}

export function SearchSirenFiltersAdministrativeStatusToJSON(json: any): SearchSirenFiltersAdministrativeStatus {
    return SearchSirenFiltersAdministrativeStatusToJSONTyped(json, false);
}

export function SearchSirenFiltersAdministrativeStatusToJSONTyped(value?: SearchSirenFiltersAdministrativeStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'value': LegalUnitAdministrativeStatusToJSON(value['value']),
    };
}
