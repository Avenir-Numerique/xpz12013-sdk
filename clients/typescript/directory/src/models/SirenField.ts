...
export type SirenField = typeof SirenField[keyof typeof SirenField];


export function instanceOfSirenField(value: any): boolean {
    for (const key in SirenField) {
        if (Object.prototype.hasOwnProperty.call(SirenField, key)) {
            if (SirenField[key as keyof typeof SirenField] === value) {
                return true;
            }
        }
    }
...
export function SirenFieldFromJSON(json: any): SirenField {
    return SirenFieldFromJSONTyped(json, false);
}

export function SirenFieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): SirenField {
    return json as SirenField;
}

export function SirenFieldToJSON(value?: SirenField | null): any {
    return value as any;
}

export function SirenFieldToJSONTyped(value: any, ignoreDiscriminator: boolean): SirenField {
    return value as SirenField;
}
