...
import type { LegalUnitPayloadHistory } from './LegalUnitPayloadHistory';
import {
    LegalUnitPayloadHistoryFromJSON,
    LegalUnitPayloadHistoryFromJSONTyped,
    LegalUnitPayloadHistoryToJSON,
    LegalUnitPayloadHistoryToJSONTyped,
} from './LegalUnitPayloadHistory';
import type { SearchSiren } from './SearchSiren';
import {
    SearchSirenFromJSON,
    SearchSirenFromJSONTyped,
    SearchSirenToJSON,
    SearchSirenToJSONTyped,
} from './SearchSiren';

/**
 * 
 * @export
 * @interface SirenSearchPost200Response
 */
export interface SirenSearchPost200Response {
    /**
     * 
     * @type {SearchSiren}
     * @memberof SirenSearchPost200Response
     */
    search?: SearchSiren;
    /**
    ...
    /**
     * 
     * @type {Array<LegalUnitPayloadHistory>}
     * @memberof SirenSearchPost200Response
     */
    results?: Array<LegalUnitPayloadHistory>;
}

/**
 * Check if a given object implements the SirenSearchPost200Response interface.
 */
export function instanceOfSirenSearchPost200Response(value: object): value is SirenSearchPost200Response {
    return true;
}

export function SirenSearchPost200ResponseFromJSON(json: any): SirenSearchPost200Response {
    return SirenSearchPost200ResponseFromJSONTyped(json, false);
}

export function SirenSearchPost200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SirenSearchPost200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'search': json['search'] == null ? undefined : SearchSirenFromJSON(json['search']),
        'totalNumberOfResults': json['totalNumberOfResults'] == null ? undefined : json['totalNumberOfResults'],
        'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(LegalUnitPayloadHistoryFromJSON)),
    };
}

export function SirenSearchPost200ResponseToJSON(json: any): SirenSearchPost200Response {
    return SirenSearchPost200ResponseToJSONTyped(json, false);
}

export function SirenSearchPost200ResponseToJSONTyped(value?: SirenSearchPost200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'search': SearchSirenToJSON(value['search']),
        'totalNumberOfResults': value['totalNumberOfResults'],
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(LegalUnitPayloadHistoryToJSON)),
    };
}
