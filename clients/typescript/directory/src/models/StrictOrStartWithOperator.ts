 ...
 * @export
 */
export const StrictOrStartWithOperator = {
    StartWith: 'startWith',
    Strict: 'strict'
} as const;
export type StrictOrStartWithOperator = typeof StrictOrStartWithOperator[keyof typeof StrictOrStartWithOperator];


export function instanceOfStrictOrStartWithOperator(value: any): boolean {
    for (const key in StrictOrStartWithOperator) {
        if (Object.prototype.hasOwnProperty.call(StrictOrStartWithOperator, key)) {
            if (StrictOrStartWithOperator[key as keyof typeof StrictOrStartWithOperator] === value) {
                return true;
            }
        }
    }
...
export function StrictOrStartWithOperatorFromJSON(json: any): StrictOrStartWithOperator {
    return StrictOrStartWithOperatorFromJSONTyped(json, false);
}

export function StrictOrStartWithOperatorFromJSONTyped(json: any, ignoreDiscriminator: boolean): StrictOrStartWithOperator {
    return json as StrictOrStartWithOperator;
}

export function StrictOrStartWithOperatorToJSON(value?: StrictOrStartWithOperator | null): any {
    return value as any;
}

export function StrictOrStartWithOperatorToJSONTyped(value: any, ignoreDiscriminator: boolean): StrictOrStartWithOperator {
    return value as StrictOrStartWithOperator;
}
