 ...
 * 
 * @export
 * @interface LegalUnitPayloadHistory
 */
export interface LegalUnitPayloadHistory {
    /**
     * SIREN number
     * @type {string}
     * @memberof LegalUnitPayloadHistory
     */
    siren?: string;
    /**
     * Business name
...
/**
 * Check if a given object implements the LegalUnitPayloadHistory interface.
 */
export function instanceOfLegalUnitPayloadHistory(value: object): value is LegalUnitPayloadHistory {
    return true;
}

export function LegalUnitPayloadHistoryFromJSON(json: any): LegalUnitPayloadHistory {
    return LegalUnitPayloadHistoryFromJSONTyped(json, false);
}

export function LegalUnitPayloadHistoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): LegalUnitPayloadHistory {
    if (json == null) {
        return json;
    }
    return {
...
export function LegalUnitPayloadHistoryToJSON(json: any): LegalUnitPayloadHistory {
    return LegalUnitPayloadHistoryToJSONTyped(json, false);
}

export function LegalUnitPayloadHistoryToJSONTyped(value?: LegalUnitPayloadHistory | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
