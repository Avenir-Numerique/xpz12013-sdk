 ...
 * @export
 */
export const RoutingCodeAdministrativeStatus = {
    A: 'A',
    C: 'C'
} as const;
export type RoutingCodeAdministrativeStatus = typeof RoutingCodeAdministrativeStatus[keyof typeof RoutingCodeAdministrativeStatus];


export function instanceOfRoutingCodeAdministrativeStatus(value: any): boolean {
    for (const key in RoutingCodeAdministrativeStatus) {
        if (Object.prototype.hasOwnProperty.call(RoutingCodeAdministrativeStatus, key)) {
            if (RoutingCodeAdministrativeStatus[key as keyof typeof RoutingCodeAdministrativeStatus] === value) {
                return true;
            }
        }
    }
...
export function RoutingCodeAdministrativeStatusFromJSON(json: any): RoutingCodeAdministrativeStatus {
    return RoutingCodeAdministrativeStatusFromJSONTyped(json, false);
}

export function RoutingCodeAdministrativeStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutingCodeAdministrativeStatus {
    return json as RoutingCodeAdministrativeStatus;
}

export function RoutingCodeAdministrativeStatusToJSON(value?: RoutingCodeAdministrativeStatus | null): any {
    return value as any;
}

export function RoutingCodeAdministrativeStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): RoutingCodeAdministrativeStatus {
    return value as RoutingCodeAdministrativeStatus;
}
