...
import type { RoutingCodeAdministrativeStatus } from './RoutingCodeAdministrativeStatus';
import {
    RoutingCodeAdministrativeStatusFromJSON,
    RoutingCodeAdministrativeStatusFromJSONTyped,
    RoutingCodeAdministrativeStatusToJSON,
    RoutingCodeAdministrativeStatusToJSONTyped,
} from './RoutingCodeAdministrativeStatus';
 ...
 * 
 * @export
 * @interface DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode
 */
export interface DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode {
    /**
     * Routing identifier od a routing code.
     * @type {string}
     * @memberof DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode
     */
    ...
    /**
     * 
     * @type {RoutingCodeAdministrativeStatus}
     * @memberof DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode
     */
    administrativeStatus?: RoutingCodeAdministrativeStatus;
    /**
     * 
     * @type {AddressRead}
     * @memberof DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode
...
/**
 * Check if a given object implements the DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode interface.
 */
export function instanceOfDirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode(value: object): value is DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode {
    return true;
}

export function DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCodeFromJSON(json: any): DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode {
    return DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCodeFromJSONTyped(json, false);
}

export function DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode {
    if (json == null) {
        return json;
    }
    return {
        ...
        'administrativeStatus': json['administrativeStatus'] == null ? undefined : RoutingCodeAdministrativeStatusFromJSON(json['administrativeStatus']),
        'address': json['address'] == null ? undefined : AddressReadFromJSON(json['address']),
    };
}

export function DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCodeToJSON(json: any): DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode {
    return DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCodeToJSONTyped(json, false);
}

export function DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCodeToJSONTyped(value?: DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'administrativeStatus': RoutingCodeAdministrativeStatusToJSON(value['administrativeStatus']),
