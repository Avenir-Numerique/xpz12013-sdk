 ...
 * @export
 */
export const DirectoryLineStatus = {
    Enabled: 'Enabled',
    Disabled: 'Disabled',
    Upcoming: 'Upcoming'
} as const;
export type DirectoryLineStatus = typeof DirectoryLineStatus[keyof typeof DirectoryLineStatus];


export function instanceOfDirectoryLineStatus(value: any): boolean {
    for (const key in DirectoryLineStatus) {
        if (Object.prototype.hasOwnProperty.call(DirectoryLineStatus, key)) {
            if (DirectoryLineStatus[key as keyof typeof DirectoryLineStatus] === value) {
                return true;
            }
        }
    }
...
export function DirectoryLineStatusFromJSON(json: any): DirectoryLineStatus {
    return DirectoryLineStatusFromJSONTyped(json, false);
}

export function DirectoryLineStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): DirectoryLineStatus {
    return json as DirectoryLineStatus;
}

export function DirectoryLineStatusToJSON(value?: DirectoryLineStatus | null): any {
    return value as any;
}

export function DirectoryLineStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): DirectoryLineStatus {
    return value as DirectoryLineStatus;
}
