...
import type { StrictOrStartWithOperator } from './StrictOrStartWithOperator';
import {
    StrictOrStartWithOperatorFromJSON,
    StrictOrStartWithOperatorFromJSONTyped,
    StrictOrStartWithOperatorToJSON,
    StrictOrStartWithOperatorToJSONTyped,
} from './StrictOrStartWithOperator';

/**
 * 
 * @export
 * @interface SearchSiretFiltersPostalCode
 */
export interface SearchSiretFiltersPostalCode {
    /**
     * 
     * @type {StrictOrStartWithOperator}
     * @memberof SearchSiretFiltersPostalCode
     */
    op?: StrictOrStartWithOperator;
    /**
     * Service postal code
     * @type {string}
     * @memberof SearchSiretFiltersPostalCode
...
/**
 * Check if a given object implements the SearchSiretFiltersPostalCode interface.
 */
export function instanceOfSearchSiretFiltersPostalCode(value: object): value is SearchSiretFiltersPostalCode {
    return true;
}

export function SearchSiretFiltersPostalCodeFromJSON(json: any): SearchSiretFiltersPostalCode {
    return SearchSiretFiltersPostalCodeFromJSONTyped(json, false);
}

export function SearchSiretFiltersPostalCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSiretFiltersPostalCode {
    if (json == null) {
        return json;
    }
    return {
        
        'op': json['op'] == null ? undefined : StrictOrStartWithOperatorFromJSON(json['op']),
        'value': json['value'] == null ? undefined : json['value'],
    };
}

export function SearchSiretFiltersPostalCodeToJSON(json: any): SearchSiretFiltersPostalCode {
    return SearchSiretFiltersPostalCodeToJSONTyped(json, false);
}

export function SearchSiretFiltersPostalCodeToJSONTyped(value?: SearchSiretFiltersPostalCode | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'op': StrictOrStartWithOperatorToJSON(value['op']),
        'value': value['value'],
    };
}
