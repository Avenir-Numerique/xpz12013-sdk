...
/**
 * \"contains\" or \"startWith\" comparison operator
 * @export
 */
export const ContainsOrStartWithOperator = {
    Contains: 'contains',
    StartWith: 'startWith'
} as const;
export type ContainsOrStartWithOperator = typeof ContainsOrStartWithOperator[keyof typeof ContainsOrStartWithOperator];


export function instanceOfContainsOrStartWithOperator(value: any): boolean {
    for (const key in ContainsOrStartWithOperator) {
        if (Object.prototype.hasOwnProperty.call(ContainsOrStartWithOperator, key)) {
            if (ContainsOrStartWithOperator[key as keyof typeof ContainsOrStartWithOperator] === value) {
                return true;
            }
        }
    }
...
export function ContainsOrStartWithOperatorFromJSON(json: any): ContainsOrStartWithOperator {
    return ContainsOrStartWithOperatorFromJSONTyped(json, false);
}

export function ContainsOrStartWithOperatorFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContainsOrStartWithOperator {
    return json as ContainsOrStartWithOperator;
}

export function ContainsOrStartWithOperatorToJSON(value?: ContainsOrStartWithOperator | null): any {
    return value as any;
}

export function ContainsOrStartWithOperatorToJSONTyped(value: any, ignoreDiscriminator: boolean): ContainsOrStartWithOperator {
    return value as ContainsOrStartWithOperator;
}
