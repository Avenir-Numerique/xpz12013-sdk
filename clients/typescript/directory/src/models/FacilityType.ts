...
export function instanceOfFacilityType(value: any): boolean {
    for (const key in FacilityType) {
        if (Object.prototype.hasOwnProperty.call(FacilityType, key)) {
            if (FacilityType[key as keyof typeof FacilityType] === value) {
                return true;
            }
        }
    }
...
export function FacilityTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): FacilityType {
    return json as FacilityType;
}

export function FacilityTypeToJSON(value?: FacilityType | null): any {
    return value as any;
}

export function FacilityTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): FacilityType {
