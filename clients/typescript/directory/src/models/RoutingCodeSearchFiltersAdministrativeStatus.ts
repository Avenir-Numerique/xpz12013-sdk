...
import type { StrictOperator } from './StrictOperator';
import {
    StrictOperatorFromJSON,
    StrictOperatorFromJSONTyped,
    StrictOperatorToJSON,
    StrictOperatorToJSONTyped,
} from './StrictOperator';

/**
 * 
 * @export
 * @interface RoutingCodeSearchFiltersAdministrativeStatus
 */
export interface RoutingCodeSearchFiltersAdministrativeStatus {
    /**
     * 
     * @type {StrictOperator}
     * @memberof RoutingCodeSearchFiltersAdministrativeStatus
     */
    op?: StrictOperator;
    /**
     * 
     ...
     * @memberof RoutingCodeSearchFiltersAdministrativeStatus
     */
    value?: RoutingCodeAdministrativeStatus;
}



/**
 * Check if a given object implements the RoutingCodeSearchFiltersAdministrativeStatus interface.
 */
export function instanceOfRoutingCodeSearchFiltersAdministrativeStatus(value: object): value is RoutingCodeSearchFiltersAdministrativeStatus {
    return true;
}

export function RoutingCodeSearchFiltersAdministrativeStatusFromJSON(json: any): RoutingCodeSearchFiltersAdministrativeStatus {
    return RoutingCodeSearchFiltersAdministrativeStatusFromJSONTyped(json, false);
}

export function RoutingCodeSearchFiltersAdministrativeStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutingCodeSearchFiltersAdministrativeStatus {
    if (json == null) {
        return json;
    }
    return {
        
        'op': json['op'] == null ? undefined : StrictOperatorFromJSON(json['op']),
        'value': json['value'] == null ? undefined : RoutingCodeAdministrativeStatusFromJSON(json['value']),
    };
}

export function RoutingCodeSearchFiltersAdministrativeStatusToJSON(json: any): RoutingCodeSearchFiltersAdministrativeStatus {
    return RoutingCodeSearchFiltersAdministrativeStatusToJSONTyped(json, false);
}

export function RoutingCodeSearchFiltersAdministrativeStatusToJSONTyped(value?: RoutingCodeSearchFiltersAdministrativeStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'op': StrictOperatorToJSON(value['op']),
        'value': RoutingCodeAdministrativeStatusToJSON(value['value']),
    };
}
