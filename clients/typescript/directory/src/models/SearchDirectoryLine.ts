...
import type { DirectoryLineField } from './DirectoryLineField';
import {
    DirectoryLineFieldFromJSON,
    DirectoryLineFieldFromJSONTyped,
    DirectoryLineFieldToJSON,
    DirectoryLineFieldToJSONTyped,
} from './DirectoryLineField';
import type { SearchDirectoryLineFilters } from './SearchDirectoryLineFilters';
import {
    SearchDirectoryLineFiltersFromJSON,
    SearchDirectoryLineFiltersFromJSONTyped,
    SearchDirectoryLineFiltersToJSON,
    SearchDirectoryLineFiltersToJSONTyped,
} from './SearchDirectoryLineFilters';
import type { SearchDirectoryLineSortingInner } from './SearchDirectoryLineSortingInner';
import {
    SearchDirectoryLineSortingInnerFromJSON,
    SearchDirectoryLineSortingInnerFromJSONTyped,
    SearchDirectoryLineSortingInnerToJSON,
    SearchDirectoryLineSortingInnerToJSONTyped,
} from './SearchDirectoryLineSortingInner';

/**
 * 
 * @export
 * @interface SearchDirectoryLine
 */
export interface SearchDirectoryLine {
    /**
     * 
     * @type {SearchDirectoryLineFilters}
     * @memberof SearchDirectoryLine
     */
    filters?: SearchDirectoryLineFilters;
    /**
     * Sorting criteria on a field and an order (ascending or descending).
     * @type {Array<SearchDirectoryLineSortingInner>}
     * @memberof SearchDirectoryLine
     */
    sorting?: Array<SearchDirectoryLineSortingInner>;
    /**
     * Allows you to filter the desired fields in the response.
     * @type {Array<DirectoryLineField>}
     * @memberof SearchDirectoryLine
     */
    fields?: Array<DirectoryLineField>;
    /**
     * 
     * @type {Array<string>}
     * @memberof SearchDirectoryLine
     */
    include?: Array<SearchDirectoryLineIncludeEnum>;
    /**
 ...
 * @export
 */
export const SearchDirectoryLineIncludeEnum = {
    Siren: 'siren',
    Siret: 'siret',
    RoutingCode: 'routingCode'
} as const;
export type SearchDirectoryLineIncludeEnum = typeof SearchDirectoryLineIncludeEnum[keyof typeof SearchDirectoryLineIncludeEnum];


/**
 * Check if a given object implements the SearchDirectoryLine interface.
 */
export function instanceOfSearchDirectoryLine(value: object): value is SearchDirectoryLine {
    return true;
}

export function SearchDirectoryLineFromJSON(json: any): SearchDirectoryLine {
    return SearchDirectoryLineFromJSONTyped(json, false);
}

export function SearchDirectoryLineFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchDirectoryLine {
    if (json == null) {
        return json;
    }
    return {
        
        'filters': json['filters'] == null ? undefined : SearchDirectoryLineFiltersFromJSON(json['filters']),
        'sorting': json['sorting'] == null ? undefined : ((json['sorting'] as Array<any>).map(SearchDirectoryLineSortingInnerFromJSON)),
        'fields': json['fields'] == null ? undefined : ((json['fields'] as Array<any>).map(DirectoryLineFieldFromJSON)),
...
export function SearchDirectoryLineToJSON(json: any): SearchDirectoryLine {
    return SearchDirectoryLineToJSONTyped(json, false);
}

export function SearchDirectoryLineToJSONTyped(value?: SearchDirectoryLine | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'filters': SearchDirectoryLineFiltersToJSON(value['filters']),
        'sorting': value['sorting'] == null ? undefined : ((value['sorting'] as Array<any>).map(SearchDirectoryLineSortingInnerToJSON)),
        'fields': value['fields'] == null ? undefined : ((value['fields'] as Array<any>).map(DirectoryLineFieldToJSON)),
