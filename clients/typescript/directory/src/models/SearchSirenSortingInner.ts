 ...
 * @export
 * @interface SearchSirenSortingInner
 */
export interface SearchSirenSortingInner {
    /**
     * 
     * @type {SirenField}
     * @memberof SearchSirenSortingInner
     */
    field?: SirenField;
    /**
     * 
...
/**
 * Check if a given object implements the SearchSirenSortingInner interface.
 */
export function instanceOfSearchSirenSortingInner(value: object): value is SearchSirenSortingInner {
    return true;
}

export function SearchSirenSortingInnerFromJSON(json: any): SearchSirenSortingInner {
    return SearchSirenSortingInnerFromJSONTyped(json, false);
}

export function SearchSirenSortingInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSirenSortingInner {
    if (json == null) {
        return json;
    }
    return {
        
        'field': json['field'] == null ? undefined : SirenFieldFromJSON(json['field']),
        'sortingOrder': json['sortingOrder'] == null ? undefined : SortingOrderFromJSON(json['sortingOrder']),
    };
}

export function SearchSirenSortingInnerToJSON(json: any): SearchSirenSortingInner {
    return SearchSirenSortingInnerToJSONTyped(json, false);
}

export function SearchSirenSortingInnerToJSONTyped(value?: SearchSirenSortingInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'field': SirenFieldToJSON(value['field']),
