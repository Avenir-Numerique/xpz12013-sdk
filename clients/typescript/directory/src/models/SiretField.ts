...
export type SiretField = typeof SiretField[keyof typeof SiretField];


export function instanceOfSiretField(value: any): boolean {
    for (const key in SiretField) {
        if (Object.prototype.hasOwnProperty.call(SiretField, key)) {
            if (SiretField[key as keyof typeof SiretField] === value) {
                return true;
            }
        }
    }
...
export function SiretFieldFromJSON(json: any): SiretField {
    return SiretFieldFromJSONTyped(json, false);
}

export function SiretFieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiretField {
    return json as SiretField;
}

export function SiretFieldToJSON(value?: SiretField | null): any {
    return value as any;
}

export function SiretFieldToJSONTyped(value: any, ignoreDiscriminator: boolean): SiretField {
    return value as SiretField;
}
