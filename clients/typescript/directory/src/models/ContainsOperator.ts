...
export function instanceOfContainsOperator(value: any): boolean {
    for (const key in ContainsOperator) {
        if (Object.prototype.hasOwnProperty.call(ContainsOperator, key)) {
            if (ContainsOperator[key as keyof typeof ContainsOperator] === value) {
                return true;
            }
        }
    }
...
export function ContainsOperatorFromJSON(json: any): ContainsOperator {
    return ContainsOperatorFromJSONTyped(json, false);
}

export function ContainsOperatorFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContainsOperator {
    return json as ContainsOperator;
}

export function ContainsOperatorToJSON(value?: ContainsOperator | null): any {
    return value as any;
}

export function ContainsOperatorToJSONTyped(value: any, ignoreDiscriminator: boolean): ContainsOperator {
    return value as ContainsOperator;
}
