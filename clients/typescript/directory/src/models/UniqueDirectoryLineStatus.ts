...
/**
 * Current line status of the platform.
 *   - Enabled : Active line linked to a platform
 *   - Disabled : No platform linked to the line
 * 
 * @export
 */
export const UniqueDirectoryLineStatus = {
    Enabled: 'Enabled',
    Disabled: 'Disabled'
} as const;
export type UniqueDirectoryLineStatus = typeof UniqueDirectoryLineStatus[keyof typeof UniqueDirectoryLineStatus];


export function instanceOfUniqueDirectoryLineStatus(value: any): boolean {
    for (const key in UniqueDirectoryLineStatus) {
        if (Object.prototype.hasOwnProperty.call(UniqueDirectoryLineStatus, key)) {
            if (UniqueDirectoryLineStatus[key as keyof typeof UniqueDirectoryLineStatus] === value) {
                return true;
            }
        }
    }
...
export function UniqueDirectoryLineStatusFromJSON(json: any): UniqueDirectoryLineStatus {
    return UniqueDirectoryLineStatusFromJSONTyped(json, false);
}

export function UniqueDirectoryLineStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): UniqueDirectoryLineStatus {
    return json as UniqueDirectoryLineStatus;
}

export function UniqueDirectoryLineStatusToJSON(value?: UniqueDirectoryLineStatus | null): any {
    return value as any;
}

export function UniqueDirectoryLineStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): UniqueDirectoryLineStatus {
    return value as UniqueDirectoryLineStatus;
}
