...
import type { ContainsOrStartWithOperator } from './ContainsOrStartWithOperator';
import {
    ContainsOrStartWithOperatorFromJSON,
    ContainsOrStartWithOperatorFromJSONTyped,
    ContainsOrStartWithOperatorToJSON,
    ContainsOrStartWithOperatorToJSONTyped,
} from './ContainsOrStartWithOperator';

/**
 * 
 * @export
 * @interface SearchSiretFiltersAddressLines
 */
export interface SearchSiretFiltersAddressLines {
    /**
     * 
     * @type {ContainsOrStartWithOperator}
     * @memberof SearchSiretFiltersAddressLines
     */
    op?: ContainsOrStartWithOperator;
    /**
...
/**
 * Check if a given object implements the SearchSiretFiltersAddressLines interface.
 */
export function instanceOfSearchSiretFiltersAddressLines(value: object): value is SearchSiretFiltersAddressLines {
    return true;
}

export function SearchSiretFiltersAddressLinesFromJSON(json: any): SearchSiretFiltersAddressLines {
    return SearchSiretFiltersAddressLinesFromJSONTyped(json, false);
}

export function SearchSiretFiltersAddressLinesFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSiretFiltersAddressLines {
    if (json == null) {
        return json;
    }
    return {
        
        'op': json['op'] == null ? undefined : ContainsOrStartWithOperatorFromJSON(json['op']),
        'value': json['value'] == null ? undefined : json['value'],
    };
}

export function SearchSiretFiltersAddressLinesToJSON(json: any): SearchSiretFiltersAddressLines {
    return SearchSiretFiltersAddressLinesToJSONTyped(json, false);
}

export function SearchSiretFiltersAddressLinesToJSONTyped(value?: SearchSiretFiltersAddressLines | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'op': ContainsOrStartWithOperatorToJSON(value['op']),
        'value': value['value'],
    };
}
