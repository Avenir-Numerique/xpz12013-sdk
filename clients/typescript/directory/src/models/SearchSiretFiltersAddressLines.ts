...
import type { ContainsOperator } from './ContainsOperator';
import {
    ContainsOperatorFromJSON,
    ContainsOperatorFromJSONTyped,
    ContainsOperatorToJSON,
    ContainsOperatorToJSONTyped,
} from './ContainsOperator';
...
export function SearchSiretFiltersAddressLinesFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSiretFiltersAddressLines {
    ...
    return {
        ...
        'op': json['op'] == null ? undefined : ContainsOperatorFromJSON(json['op']),
...
export function SearchSiretFiltersAddressLinesToJSONTyped(value?: SearchSiretFiltersAddressLines | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'op': ContainsOperatorToJSON(value['op']),
        'value': value['value'],
    };
}
