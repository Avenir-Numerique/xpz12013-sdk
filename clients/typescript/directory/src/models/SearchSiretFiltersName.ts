 ...
 * 
 * @export
 * @interface SearchSiretFiltersName
 */
export interface SearchSiretFiltersName {
    /**
     * 
     * @type {ContainsOrStrictOrStartWithOperator}
     * @memberof SearchSiretFiltersName
     */
...
/**
 * Check if a given object implements the SearchSiretFiltersName interface.
 */
export function instanceOfSearchSiretFiltersName(value: object): value is SearchSiretFiltersName {
    return true;
}

export function SearchSiretFiltersNameFromJSON(json: any): SearchSiretFiltersName {
    return SearchSiretFiltersNameFromJSONTyped(json, false);
}

export function SearchSiretFiltersNameFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSiretFiltersName {
    if (json == null) {
        return json;
    }
    return {
...
export function SearchSiretFiltersNameToJSON(json: any): SearchSiretFiltersName {
    return SearchSiretFiltersNameToJSONTyped(json, false);
}

export function SearchSiretFiltersNameToJSONTyped(value?: SearchSiretFiltersName | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
