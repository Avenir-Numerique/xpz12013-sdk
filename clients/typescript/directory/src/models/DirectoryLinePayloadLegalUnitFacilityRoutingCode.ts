...
import type { UniqueDirectoryLineStatus } from './UniqueDirectoryLineStatus';
import {
    UniqueDirectoryLineStatusFromJSON,
    UniqueDirectoryLineStatusFromJSONTyped,
    UniqueDirectoryLineStatusToJSON,
    UniqueDirectoryLineStatusToJSONTyped,
} from './UniqueDirectoryLineStatus';
 ...
 * 
 * @export
 * @interface DirectoryLinePayloadLegalUnitFacilityRoutingCode
 */
export interface DirectoryLinePayloadLegalUnitFacilityRoutingCode {
    /**
     * Addressing identifier of the directory line.
     * @type {string}
     * @memberof DirectoryLinePayloadLegalUnitFacilityRoutingCode
     */
    ...
    /**
     * 
     * @type {UniqueDirectoryLineStatus}
     * @memberof DirectoryLinePayloadLegalUnitFacilityRoutingCode
     */
    directoryLineStatus?: UniqueDirectoryLineStatus;
    /**
     * SIREN number
     * @type {string}
     * @memberof DirectoryLinePayloadLegalUnitFacilityRoutingCode
...
/**
 * Check if a given object implements the DirectoryLinePayloadLegalUnitFacilityRoutingCode interface.
 */
export function instanceOfDirectoryLinePayloadLegalUnitFacilityRoutingCode(value: object): value is DirectoryLinePayloadLegalUnitFacilityRoutingCode {
    return true;
}

export function DirectoryLinePayloadLegalUnitFacilityRoutingCodeFromJSON(json: any): DirectoryLinePayloadLegalUnitFacilityRoutingCode {
    return DirectoryLinePayloadLegalUnitFacilityRoutingCodeFromJSONTyped(json, false);
}

export function DirectoryLinePayloadLegalUnitFacilityRoutingCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DirectoryLinePayloadLegalUnitFacilityRoutingCode {
    if (json == null) {
        return json;
    }
    return {
        ...
        'directoryLineStatus': json['directoryLineStatus'] == null ? undefined : UniqueDirectoryLineStatusFromJSON(json['directoryLineStatus']),
...
export function DirectoryLinePayloadLegalUnitFacilityRoutingCodeToJSON(json: any): DirectoryLinePayloadLegalUnitFacilityRoutingCode {
    return DirectoryLinePayloadLegalUnitFacilityRoutingCodeToJSONTyped(json, false);
}

export function DirectoryLinePayloadLegalUnitFacilityRoutingCodeToJSONTyped(value?: DirectoryLinePayloadLegalUnitFacilityRoutingCode | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'directoryLineStatus': UniqueDirectoryLineStatusToJSON(value['directoryLineStatus']),
        'siren': value['siren'],
        'siret': value['siret'],
