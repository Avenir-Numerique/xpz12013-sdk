...
import type { DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode } from './DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode';
import {
    DirectoryLinePayloadStatusLegalUnitFacilityRoutingCodeFromJSON,
    DirectoryLinePayloadStatusLegalUnitFacilityRoutingCodeFromJSONTyped,
    DirectoryLinePayloadStatusLegalUnitFacilityRoutingCodeToJSON,
    DirectoryLinePayloadStatusLegalUnitFacilityRoutingCodeToJSONTyped,
} from './DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode';
import type { SearchDirectoryLine } from './SearchDirectoryLine';
import {
    SearchDirectoryLineFromJSON,
    SearchDirectoryLineFromJSONTyped,
    SearchDirectoryLineToJSON,
    SearchDirectoryLineToJSONTyped,
} from './SearchDirectoryLine';

/**
 * 
 * @export
 * @interface DirectoryLineSearchPost200Response
 */
export interface DirectoryLineSearchPost200Response {
    /**
     * 
     * @type {SearchDirectoryLine}
     * @memberof DirectoryLineSearchPost200Response
     */
    ...
    /**
     * 
     * @type {Array<DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode>}
     * @memberof DirectoryLineSearchPost200Response
     */
    results?: Array<DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode>;
}

/**
 * Check if a given object implements the DirectoryLineSearchPost200Response interface.
 */
export function instanceOfDirectoryLineSearchPost200Response(value: object): value is DirectoryLineSearchPost200Response {
    return true;
}

export function DirectoryLineSearchPost200ResponseFromJSON(json: any): DirectoryLineSearchPost200Response {
    return DirectoryLineSearchPost200ResponseFromJSONTyped(json, false);
}

export function DirectoryLineSearchPost200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DirectoryLineSearchPost200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'search': json['search'] == null ? undefined : SearchDirectoryLineFromJSON(json['search']),
        'totalNumberOfResults': json['totalNumberOfResults'] == null ? undefined : json['totalNumberOfResults'],
        'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(DirectoryLinePayloadStatusLegalUnitFacilityRoutingCodeFromJSON)),
    };
}

export function DirectoryLineSearchPost200ResponseToJSON(json: any): DirectoryLineSearchPost200Response {
    return DirectoryLineSearchPost200ResponseToJSONTyped(json, false);
}

export function DirectoryLineSearchPost200ResponseToJSONTyped(value?: DirectoryLineSearchPost200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'search': SearchDirectoryLineToJSON(value['search']),
        'totalNumberOfResults': value['totalNumberOfResults'],
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(DirectoryLinePayloadStatusLegalUnitFacilityRoutingCodeToJSON)),
    };
}
