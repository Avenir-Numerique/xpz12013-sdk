...
import {
    ...
    SortingOrderFromJSONTyped,
    SortingOrderToJSON,
    SortingOrderToJSONTyped,
} from './SortingOrder';

/**
 * A sort criteria composed of a field and an order (ascending or descending).
 * @export
 * @interface SearchDirectoryLineSortingInner
 */
export interface SearchDirectoryLineSortingInner {
    /**
     * 
     * @type {DirectoryLineField}
     * @memberof SearchDirectoryLineSortingInner
     */
    field?: DirectoryLineField;
    /**
     * 
     * @type {SortingOrder}
     * @memberof SearchDirectoryLineSortingInner
...
/**
 * Check if a given object implements the SearchDirectoryLineSortingInner interface.
 */
export function instanceOfSearchDirectoryLineSortingInner(value: object): value is SearchDirectoryLineSortingInner {
    return true;
}

export function SearchDirectoryLineSortingInnerFromJSON(json: any): SearchDirectoryLineSortingInner {
    return SearchDirectoryLineSortingInnerFromJSONTyped(json, false);
}

export function SearchDirectoryLineSortingInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchDirectoryLineSortingInner {
    if (json == null) {
        return json;
    }
    return {
        
        'field': json['field'] == null ? undefined : DirectoryLineFieldFromJSON(json['field']),
        'sortingOrder': json['sortingOrder'] == null ? undefined : SortingOrderFromJSON(json['sortingOrder']),
    };
}

export function SearchDirectoryLineSortingInnerToJSON(json: any): SearchDirectoryLineSortingInner {
    return SearchDirectoryLineSortingInnerToJSONTyped(json, false);
}

export function SearchDirectoryLineSortingInnerToJSONTyped(value?: SearchDirectoryLineSortingInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'field': DirectoryLineFieldToJSON(value['field']),
        'sortingOrder': SortingOrderToJSON(value['sortingOrder']),
    };
}
