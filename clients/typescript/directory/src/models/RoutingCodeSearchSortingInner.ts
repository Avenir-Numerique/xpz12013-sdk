 ...
 * @export
 * @interface RoutingCodeSearchSortingInner
 */
export interface RoutingCodeSearchSortingInner {
    /**
     * 
     * @type {RoutingCodeField}
     * @memberof RoutingCodeSearchSortingInner
     */
    field?: RoutingCodeField;
    /**
     * 
     * @type {SortingOrder}
     * @memberof RoutingCodeSearchSortingInner
...
/**
 * Check if a given object implements the RoutingCodeSearchSortingInner interface.
 */
export function instanceOfRoutingCodeSearchSortingInner(value: object): value is RoutingCodeSearchSortingInner {
    return true;
}

export function RoutingCodeSearchSortingInnerFromJSON(json: any): RoutingCodeSearchSortingInner {
    return RoutingCodeSearchSortingInnerFromJSONTyped(json, false);
}

export function RoutingCodeSearchSortingInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutingCodeSearchSortingInner {
    if (json == null) {
        return json;
    }
    return {
        
        'field': json['field'] == null ? undefined : RoutingCodeFieldFromJSON(json['field']),
        'order': json['order'] == null ? undefined : SortingOrderFromJSON(json['order']),
    };
}

export function RoutingCodeSearchSortingInnerToJSON(json: any): RoutingCodeSearchSortingInner {
    return RoutingCodeSearchSortingInnerToJSONTyped(json, false);
}

export function RoutingCodeSearchSortingInnerToJSONTyped(value?: RoutingCodeSearchSortingInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'field': RoutingCodeFieldToJSON(value['field']),
