 ...
 * @export
 * @interface SirenInstructions
 */
export interface SirenInstructions {
    /**
     * Indicates whether the information is forbidden from being used for sales prospecting purposes.
     * @type {boolean}
     * @memberof SirenInstructions
     */
    isSalesProspectingForbidden?: boolean;
}

/**
 * Check if a given object implements the SirenInstructions interface.
 */
export function instanceOfSirenInstructions(value: object): value is SirenInstructions {
    return true;
}

export function SirenInstructionsFromJSON(json: any): SirenInstructions {
    return SirenInstructionsFromJSONTyped(json, false);
}

export function SirenInstructionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SirenInstructions {
    if (json == null) {
        return json;
    }
    return {
...
export function SirenInstructionsToJSON(json: any): SirenInstructions {
    return SirenInstructionsToJSONTyped(json, false);
}

export function SirenInstructionsToJSONTyped(value?: SirenInstructions | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
