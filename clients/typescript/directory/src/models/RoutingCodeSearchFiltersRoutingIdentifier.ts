 ...
 * 
 * @export
 * @interface RoutingCodeSearchFiltersRoutingIdentifier
 */
export interface RoutingCodeSearchFiltersRoutingIdentifier {
    /**
     * 
     * @type {ContainsOrStrictOperator}
     * @memberof RoutingCodeSearchFiltersRoutingIdentifier
     */
...
/**
 * Check if a given object implements the RoutingCodeSearchFiltersRoutingIdentifier interface.
 */
export function instanceOfRoutingCodeSearchFiltersRoutingIdentifier(value: object): value is RoutingCodeSearchFiltersRoutingIdentifier {
    return true;
}

export function RoutingCodeSearchFiltersRoutingIdentifierFromJSON(json: any): RoutingCodeSearchFiltersRoutingIdentifier {
    return RoutingCodeSearchFiltersRoutingIdentifierFromJSONTyped(json, false);
}

export function RoutingCodeSearchFiltersRoutingIdentifierFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutingCodeSearchFiltersRoutingIdentifier {
    if (json == null) {
        return json;
    }
    return {
...
export function RoutingCodeSearchFiltersRoutingIdentifierToJSON(json: any): RoutingCodeSearchFiltersRoutingIdentifier {
    return RoutingCodeSearchFiltersRoutingIdentifierToJSONTyped(json, false);
}

export function RoutingCodeSearchFiltersRoutingIdentifierToJSONTyped(value?: RoutingCodeSearchFiltersRoutingIdentifier | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
