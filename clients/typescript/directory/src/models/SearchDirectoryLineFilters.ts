...
import type { SearchDirectoryLineFiltersAddressingIdentifier } from './SearchDirectoryLineFiltersAddressingIdentifier';
import {
    SearchDirectoryLineFiltersAddressingIdentifierFromJSON,
    SearchDirectoryLineFiltersAddressingIdentifierFromJSONTyped,
    SearchDirectoryLineFiltersAddressingIdentifierToJSON,
    SearchDirectoryLineFiltersAddressingIdentifierToJSONTyped,
} from './SearchDirectoryLineFiltersAddressingIdentifier';
import type { SearchDirectoryLineFiltersAddressingSuffix } from './SearchDirectoryLineFiltersAddressingSuffix';
import {
    SearchDirectoryLineFiltersAddressingSuffixFromJSON,
    SearchDirectoryLineFiltersAddressingSuffixFromJSONTyped,
    SearchDirectoryLineFiltersAddressingSuffixToJSON,
    SearchDirectoryLineFiltersAddressingSuffixToJSONTyped,
} from './SearchDirectoryLineFiltersAddressingSuffix';
 ...
 * 
 * @export
 * @interface SearchDirectoryLineFilters
 */
export interface SearchDirectoryLineFilters {
    /**
     * 
     * @type {SearchDirectoryLineFiltersAddressingIdentifier}
     * @memberof SearchDirectoryLineFilters
     */
    ...
    /**
     * 
     * @type {SearchDirectoryLineFiltersAddressingSuffix}
     * @memberof SearchDirectoryLineFilters
     */
...
/**
 * Check if a given object implements the SearchDirectoryLineFilters interface.
 */
export function instanceOfSearchDirectoryLineFilters(value: object): value is SearchDirectoryLineFilters {
    return true;
}

export function SearchDirectoryLineFiltersFromJSON(json: any): SearchDirectoryLineFilters {
    return SearchDirectoryLineFiltersFromJSONTyped(json, false);
}

export function SearchDirectoryLineFiltersFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchDirectoryLineFilters {
    if (json == null) {
        return json;
    }
    return {
        
        'addressingIdentifier': json['addressingIdentifier'] == null ? undefined : SearchDirectoryLineFiltersAddressingIdentifierFromJSON(json['addressingIdentifier']),
        ...
        'addressingSuffix': json['addressingSuffix'] == null ? undefined : SearchDirectoryLineFiltersAddressingSuffixFromJSON(json['addressingSuffix']),
    };
}

export function SearchDirectoryLineFiltersToJSON(json: any): SearchDirectoryLineFilters {
    return SearchDirectoryLineFiltersToJSONTyped(json, false);
}

export function SearchDirectoryLineFiltersToJSONTyped(value?: SearchDirectoryLineFilters | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'addressingIdentifier': SearchDirectoryLineFiltersAddressingIdentifierToJSON(value['addressingIdentifier']),
        ...
        'addressingSuffix': SearchDirectoryLineFiltersAddressingSuffixToJSON(value['addressingSuffix']),
    };
}
