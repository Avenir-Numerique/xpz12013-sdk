 ...
 * 
 * @export
 * @interface SearchDirectoryLineFiltersAddressingSuffix
 */
export interface SearchDirectoryLineFiltersAddressingSuffix {
    /**
     * 
     * @type {ContainsOrStrictOperator}
     * @memberof SearchDirectoryLineFiltersAddressingSuffix
     */
...
/**
 * Check if a given object implements the SearchDirectoryLineFiltersAddressingSuffix interface.
 */
export function instanceOfSearchDirectoryLineFiltersAddressingSuffix(value: object): value is SearchDirectoryLineFiltersAddressingSuffix {
    return true;
}

export function SearchDirectoryLineFiltersAddressingSuffixFromJSON(json: any): SearchDirectoryLineFiltersAddressingSuffix {
    return SearchDirectoryLineFiltersAddressingSuffixFromJSONTyped(json, false);
}

export function SearchDirectoryLineFiltersAddressingSuffixFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchDirectoryLineFiltersAddressingSuffix {
    if (json == null) {
        return json;
    }
    return {
...
export function SearchDirectoryLineFiltersAddressingSuffixToJSON(json: any): SearchDirectoryLineFiltersAddressingSuffix {
    return SearchDirectoryLineFiltersAddressingSuffixToJSONTyped(json, false);
}

export function SearchDirectoryLineFiltersAddressingSuffixToJSONTyped(value?: SearchDirectoryLineFiltersAddressingSuffix | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
