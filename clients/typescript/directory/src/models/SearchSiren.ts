...
import type { SearchSirenFilters } from './SearchSirenFilters';
import {
    SearchSirenFiltersFromJSON,
    SearchSirenFiltersFromJSONTyped,
    SearchSirenFiltersToJSON,
    SearchSirenFiltersToJSONTyped,
} from './SearchSirenFilters';
import type { SearchSirenSortingInner } from './SearchSirenSortingInner';
import {
    SearchSirenSortingInnerFromJSON,
    SearchSirenSortingInnerFromJSONTyped,
    SearchSirenSortingInnerToJSON,
    SearchSirenSortingInnerToJSONTyped,
} from './SearchSirenSortingInner';
import type { SirenField } from './SirenField';
import {
    SirenFieldFromJSON,
    SirenFieldFromJSONTyped,
    SirenFieldToJSON,
    SirenFieldToJSONTyped,
} from './SirenField';

/**
 * 
 * @export
 * @interface SearchSiren
 */
export interface SearchSiren {
    /**
     * 
     * @type {SearchSirenFilters}
     * @memberof SearchSiren
     */
    filters?: SearchSirenFilters;
    /**
     * Sorting criteria on a field and an order (ascending or descending).
     * @type {Array<SearchSirenSortingInner>}
     * @memberof SearchSiren
     */
    sorting?: Array<SearchSirenSortingInner>;
    /**
     * Allows you to filter the desired fields in the response.
     * @type {Array<SirenField>}
     * @memberof SearchSiren
     */
...
/**
 * Check if a given object implements the SearchSiren interface.
 */
export function instanceOfSearchSiren(value: object): value is SearchSiren {
    return true;
}

export function SearchSirenFromJSON(json: any): SearchSiren {
    return SearchSirenFromJSONTyped(json, false);
}

export function SearchSirenFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSiren {
    if (json == null) {
        return json;
    }
    return {
        
        'filters': json['filters'] == null ? undefined : SearchSirenFiltersFromJSON(json['filters']),
        'sorting': json['sorting'] == null ? undefined : ((json['sorting'] as Array<any>).map(SearchSirenSortingInnerFromJSON)),
        'fields': json['fields'] == null ? undefined : ((json['fields'] as Array<any>).map(SirenFieldFromJSON)),
        'limit': json['limit'] == null ? undefined : json['limit'],
        'ignore': json['ignore'] == null ? undefined : json['ignore'],
    };
}

export function SearchSirenToJSON(json: any): SearchSiren {
    return SearchSirenToJSONTyped(json, false);
}

export function SearchSirenToJSONTyped(value?: SearchSiren | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'filters': SearchSirenFiltersToJSON(value['filters']),
        'sorting': value['sorting'] == null ? undefined : ((value['sorting'] as Array<any>).map(SearchSirenSortingInnerToJSON)),
        'fields': value['fields'] == null ? undefined : ((value['fields'] as Array<any>).map(SirenFieldToJSON)),
        'limit': value['limit'],
        'ignore': value['ignore'],
    };
}
