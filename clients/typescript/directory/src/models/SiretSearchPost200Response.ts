...
import type { SearchSiret } from './SearchSiret';
import {
    SearchSiretFromJSON,
    SearchSiretFromJSONTyped,
    SearchSiretToJSON,
    SearchSiretToJSONTyped,
} from './SearchSiret';
import type { FacilityPayloadHistory } from './FacilityPayloadHistory';
import {
    FacilityPayloadHistoryFromJSON,
    FacilityPayloadHistoryFromJSONTyped,
    FacilityPayloadHistoryToJSON,
    FacilityPayloadHistoryToJSONTyped,
} from './FacilityPayloadHistory';

/**
 * 
 * @export
 * @interface SiretSearchPost200Response
 */
export interface SiretSearchPost200Response {
    /**
     * 
     * @type {SearchSiret}
     * @memberof SiretSearchPost200Response
     */
    search?: SearchSiret;
    /**
    ...
    /**
     * 
     * @type {Array<FacilityPayloadHistory>}
     * @memberof SiretSearchPost200Response
     */
    results?: Array<FacilityPayloadHistory>;
}

/**
 * Check if a given object implements the SiretSearchPost200Response interface.
 */
export function instanceOfSiretSearchPost200Response(value: object): value is SiretSearchPost200Response {
    return true;
}

export function SiretSearchPost200ResponseFromJSON(json: any): SiretSearchPost200Response {
    return SiretSearchPost200ResponseFromJSONTyped(json, false);
}

export function SiretSearchPost200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiretSearchPost200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'search': json['search'] == null ? undefined : SearchSiretFromJSON(json['search']),
        'totalNumberOfResults': json['totalNumberOfResults'] == null ? undefined : json['totalNumberOfResults'],
        'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(FacilityPayloadHistoryFromJSON)),
    };
}

export function SiretSearchPost200ResponseToJSON(json: any): SiretSearchPost200Response {
    return SiretSearchPost200ResponseToJSONTyped(json, false);
}

export function SiretSearchPost200ResponseToJSONTyped(value?: SiretSearchPost200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'search': SearchSiretToJSON(value['search']),
        'totalNumberOfResults': value['totalNumberOfResults'],
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(FacilityPayloadHistoryToJSON)),
    };
}
