 ...
 * @export
 * @interface SiretInstructions
 */
export interface SiretInstructions {
    /**
     * Indicates whether the information is forbidden from being used for sales prospecting purposes.
     * @type {boolean}
     * @memberof SiretInstructions
     */
    isSalesProspectingForbidden?: boolean;
}

/**
 * Check if a given object implements the SiretInstructions interface.
 */
export function instanceOfSiretInstructions(value: object): value is SiretInstructions {
    return true;
}

export function SiretInstructionsFromJSON(json: any): SiretInstructions {
    return SiretInstructionsFromJSONTyped(json, false);
}

export function SiretInstructionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiretInstructions {
    if (json == null) {
        return json;
    }
    return {
        
        'isSalesProspectingForbidden': json['isSalesProspectingForbidden'] == null ? undefined : json['isSalesProspectingForbidden'],
    };
}

export function SiretInstructionsToJSON(json: any): SiretInstructions {
    return SiretInstructionsToJSONTyped(json, false);
}

export function SiretInstructionsToJSONTyped(value?: SiretInstructions | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'isSalesProspectingForbidden': value['isSalesProspectingForbidden'],
    };
}
