 ...
 * 
 * @export
 * @interface RoutingCodeSearchFiltersRoutingCodeName
 */
export interface RoutingCodeSearchFiltersRoutingCodeName {
    /**
     * 
     * @type {ContainsOrStrictOperator}
     * @memberof RoutingCodeSearchFiltersRoutingCodeName
     */
...
/**
 * Check if a given object implements the RoutingCodeSearchFiltersRoutingCodeName interface.
 */
export function instanceOfRoutingCodeSearchFiltersRoutingCodeName(value: object): value is RoutingCodeSearchFiltersRoutingCodeName {
    return true;
}

export function RoutingCodeSearchFiltersRoutingCodeNameFromJSON(json: any): RoutingCodeSearchFiltersRoutingCodeName {
    return RoutingCodeSearchFiltersRoutingCodeNameFromJSONTyped(json, false);
}

export function RoutingCodeSearchFiltersRoutingCodeNameFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutingCodeSearchFiltersRoutingCodeName {
    if (json == null) {
        return json;
    }
    return {
...
export function RoutingCodeSearchFiltersRoutingCodeNameToJSON(json: any): RoutingCodeSearchFiltersRoutingCodeName {
    return RoutingCodeSearchFiltersRoutingCodeNameToJSONTyped(json, false);
}

export function RoutingCodeSearchFiltersRoutingCodeNameToJSONTyped(value?: RoutingCodeSearchFiltersRoutingCodeName | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
