...
/**
 * \"contains\", \"strict\" or \"startWith\" comparison operator
 * @export
 */
export const ContainsOrStrictOrStartWithOperator = {
    Contains: 'contains',
    Strict: 'strict',
    StartWith: 'startWith'
} as const;
export type ContainsOrStrictOrStartWithOperator = typeof ContainsOrStrictOrStartWithOperator[keyof typeof ContainsOrStrictOrStartWithOperator];


export function instanceOfContainsOrStrictOrStartWithOperator(value: any): boolean {
    for (const key in ContainsOrStrictOrStartWithOperator) {
        if (Object.prototype.hasOwnProperty.call(ContainsOrStrictOrStartWithOperator, key)) {
            if (ContainsOrStrictOrStartWithOperator[key as keyof typeof ContainsOrStrictOrStartWithOperator] === value) {
                return true;
            }
        }
    }
...
export function ContainsOrStrictOrStartWithOperatorFromJSON(json: any): ContainsOrStrictOrStartWithOperator {
    return ContainsOrStrictOrStartWithOperatorFromJSONTyped(json, false);
}

export function ContainsOrStrictOrStartWithOperatorFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContainsOrStrictOrStartWithOperator {
    return json as ContainsOrStrictOrStartWithOperator;
}

export function ContainsOrStrictOrStartWithOperatorToJSON(value?: ContainsOrStrictOrStartWithOperator | null): any {
    return value as any;
}

export function ContainsOrStrictOrStartWithOperatorToJSONTyped(value: any, ignoreDiscriminator: boolean): ContainsOrStrictOrStartWithOperator {
    return value as ContainsOrStrictOrStartWithOperator;
}
