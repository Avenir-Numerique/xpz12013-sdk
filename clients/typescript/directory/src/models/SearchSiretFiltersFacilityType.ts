 ...
 * 
 * @export
 * @interface SearchSiretFiltersFacilityType
 */
export interface SearchSiretFiltersFacilityType {
    /**
     * 
     * @type {StrictOperator}
     * @memberof SearchSiretFiltersFacilityType
     */
    op?: StrictOperator;
    /**
     * 
...
/**
 * Check if a given object implements the SearchSiretFiltersFacilityType interface.
 */
export function instanceOfSearchSiretFiltersFacilityType(value: object): value is SearchSiretFiltersFacilityType {
    return true;
}

export function SearchSiretFiltersFacilityTypeFromJSON(json: any): SearchSiretFiltersFacilityType {
    return SearchSiretFiltersFacilityTypeFromJSONTyped(json, false);
}

export function SearchSiretFiltersFacilityTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchSiretFiltersFacilityType {
    if (json == null) {
        return json;
    }
    return {
        ...
        'value': json['value'] == null ? undefined : FacilityTypeFromJSON(json['value']),
    };
}

export function SearchSiretFiltersFacilityTypeToJSON(json: any): SearchSiretFiltersFacilityType {
    return SearchSiretFiltersFacilityTypeToJSONTyped(json, false);
}

export function SearchSiretFiltersFacilityTypeToJSONTyped(value?: SearchSiretFiltersFacilityType | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'value': FacilityTypeToJSON(value['value']),
    };
}
