...
/**
 * API tests for RoutingCodeApi
 */
@Disabled
public class RoutingCodeApiTest {

    private final RoutingCodeApi api = new RoutingCodeApi();
     ...
     */
    @Test
    public void getRoutingCodeBySiretAndIdTest() throws ApiException {
        String siret = null;
        String routingIdentifier = null;
        List<String> include = null;
        List<RoutingCodeField> fields = null;
        RoutingCodePayloadHistoryLegalUnitFacility response = 
        api.getRoutingCodeBySiretAndId(siret, routingIdentifier, include, fields);
     ...
     */
    @Test
    public void searchRoutingCodeTest() throws ApiException {
        RoutingCodeSearch routingCodeSearch = null;
        RoutingCodeSearchPost200Response response = 
        api.searchRoutingCode(routingCodeSearch);
