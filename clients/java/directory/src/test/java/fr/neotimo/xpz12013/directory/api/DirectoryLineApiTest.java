...
/**
 * API tests for DirectoryLineApi
 */
@Disabled
public class DirectoryLineApiTest {

    private final DirectoryLineApi api = new DirectoryLineApi();
     ...
     */
    @Test
    public void getDirectoryLineByIdTest() throws ApiException {
        String addressingIdentifier = null;
        List<String> include = null;
        List<DirectoryLineField> fields = null;
        DirectoryLinePayloadLegalUnitFacilityRoutingCode response = 
        api.getDirectoryLineById(addressingIdentifier, include, fields);
     ...
     */
    @Test
    public void searchDirectoryLineTest() throws ApiException {
        SearchDirectoryLine searchDirectoryLine = null;
        DirectoryLineSearchPost200Response response = 
        api.searchDirectoryLine(searchDirectoryLine);
