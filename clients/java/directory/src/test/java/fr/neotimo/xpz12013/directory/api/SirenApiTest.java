...
/**
 * API tests for SirenApi
 */
@Disabled
public class SirenApiTest {

    private final SirenApi api = new SirenApi();
     ...
     */
    @Test
    public void getCompanyBySirenTest() throws ApiException {
        String siren = null;
        List<SirenField> fields = null;
        LegalUnitPayloadHistory response = 
        api.getCompanyBySiren(siren, fields);
     ...
     */
    @Test
    public void searchCompanyBySirenTest() throws ApiException {
        SearchSiren searchSiren = null;
        SirenSearchPost200Response response = 
        api.searchCompanyBySiren(searchSiren);
