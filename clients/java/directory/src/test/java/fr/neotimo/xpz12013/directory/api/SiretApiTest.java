...
/**
 * API tests for SiretApi
 */
@Disabled
public class SiretApiTest {

    private final SiretApi api = new SiretApi();
     ...
     */
    @Test
    public void getFacilityBySiretTest() throws ApiException {
        String siret = null;
        List<SiretField> fields = null;
        List<String> include = null;
        FacilityPayloadHistory response = 
        api.getFacilityBySiret(siret, fields, include);
     ...
     */
    @Test
    public void searchFacilityBySiretTest() throws ApiException {
        SearchSiret searchSiret = null;
        SiretSearchPost200Response response = 
        api.searchFacilityBySiret(searchSiret);
