...
import fr.neotimo.xpz12013.directory.model.SearchDirectoryLineFilters;
import fr.neotimo.xpz12013.directory.model.SearchDirectoryLineSortingInner;
 ...
 */
@JsonPropertyOrder({
  SearchDirectoryLine.JSON_PROPERTY_FILTERS,
  SearchDirectoryLine.JSON_PROPERTY_SORTING,
  SearchDirectoryLine.JSON_PROPERTY_FIELDS,
  SearchDirectoryLine.JSON_PROPERTY_INCLUDE,
  SearchDirectoryLine.JSON_PROPERTY_LIMIT,
  SearchDirectoryLine.JSON_PROPERTY_IGNORE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SearchDirectoryLine {
  public static final String JSON_PROPERTY_FILTERS = "filters";
  @javax.annotation.Nullable
  private SearchDirectoryLineFilters filters;

  public static final String JSON_PROPERTY_SORTING = "sorting";
  @javax.annotation.Nullable
  private List<SearchDirectoryLineSortingInner> sorting = new ArrayList<>();

  public static final String JSON_PROPERTY_FIELDS = "fields";
  @javax.annotation.Nullable
  private List<DirectoryLineField> fields = new ArrayList<>();
  ...
  public enum IncludeEnum {
    ...
    ROUTING_CODE(String.valueOf("routingCode"));
  ...
  public SearchDirectoryLine() { 
  }

  public SearchDirectoryLine filters(@javax.annotation.Nullable SearchDirectoryLineFilters filters) {
  ...
  public SearchDirectoryLineFilters getFilters() {
    return filters;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FILTERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFilters(@javax.annotation.Nullable SearchDirectoryLineFilters filters) {
    this.filters = filters;
  }


  public SearchDirectoryLine sorting(@javax.annotation.Nullable List<SearchDirectoryLineSortingInner> sorting) {
    this.sorting = sorting;
    return this;
  }

  public SearchDirectoryLine addSortingItem(SearchDirectoryLineSortingInner sortingItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<SearchDirectoryLineSortingInner> getSorting() {
    return sorting;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SORTING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSorting(@javax.annotation.Nullable List<SearchDirectoryLineSortingInner> sorting) {
    this.sorting = sorting;
  }


  public SearchDirectoryLine fields(@javax.annotation.Nullable List<DirectoryLineField> fields) {
    this.fields = fields;
    return this;
  }

  public SearchDirectoryLine addFieldsItem(DirectoryLineField fieldsItem) {
    if (this.fields == null) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<DirectoryLineField> getFields() {
    return fields;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FIELDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFields(@javax.annotation.Nullable List<DirectoryLineField> fields) {
    this.fields = fields;
  }


  public SearchDirectoryLine include(@javax.annotation.Nullable List<IncludeEnum> include) {
    this.include = include;
    return this;
  }

  public SearchDirectoryLine addIncludeItem(IncludeEnum includeItem) {
  ...
  public SearchDirectoryLine limit(@javax.annotation.Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public SearchDirectoryLine ignore(@javax.annotation.Nullable Integer ignore) {
    this.ignore = ignore;
    return this;
  }
  ...
  /**
   * Return true if this searchDirectoryLine object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchDirectoryLine searchDirectoryLine = (SearchDirectoryLine) o;
    return Objects.equals(this.filters, searchDirectoryLine.filters) &&
        Objects.equals(this.sorting, searchDirectoryLine.sorting) &&
        Objects.equals(this.fields, searchDirectoryLine.fields) &&
        Objects.equals(this.include, searchDirectoryLine.include) &&
        Objects.equals(this.limit, searchDirectoryLine.limit) &&
        Objects.equals(this.ignore, searchDirectoryLine.ignore);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchDirectoryLine {\n");
