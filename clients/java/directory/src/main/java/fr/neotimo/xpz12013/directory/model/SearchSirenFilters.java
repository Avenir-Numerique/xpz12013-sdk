...
import fr.neotimo.xpz12013.directory.model.SearchSirenFiltersAdministrativeStatus;
import fr.neotimo.xpz12013.directory.model.SearchSirenFiltersBusinessName;
import fr.neotimo.xpz12013.directory.model.SearchSirenFiltersEntityType;
 ...
 */
@JsonPropertyOrder({
  SearchSirenFilters.JSON_PROPERTY_SIREN,
  SearchSirenFilters.JSON_PROPERTY_BUSINESS_NAME,
  SearchSirenFilters.JSON_PROPERTY_ENTITY_TYPE,
  SearchSirenFilters.JSON_PROPERTY_ADMINISTRATIVE_STATUS
})
...
public class SearchSirenFilters {
  ...
  @javax.annotation.Nullable
  private SearchSirenFiltersBusinessName businessName;

  public static final String JSON_PROPERTY_ENTITY_TYPE = "entityType";
  @javax.annotation.Nullable
  private SearchSirenFiltersEntityType entityType;

  public static final String JSON_PROPERTY_ADMINISTRATIVE_STATUS = "administrativeStatus";
  @javax.annotation.Nullable
  private SearchSirenFiltersAdministrativeStatus administrativeStatus;

  public SearchSirenFilters() { 
  }

  public SearchSirenFilters siren(@javax.annotation.Nullable SearchSirenFiltersSiren siren) {
    this.siren = siren;
    return this;
  }
  ...
  public SearchSirenFilters businessName(@javax.annotation.Nullable SearchSirenFiltersBusinessName businessName) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public SearchSirenFiltersBusinessName getBusinessName() {
    return businessName;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BUSINESS_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBusinessName(@javax.annotation.Nullable SearchSirenFiltersBusinessName businessName) {
    this.businessName = businessName;
  }


  public SearchSirenFilters entityType(@javax.annotation.Nullable SearchSirenFiltersEntityType entityType) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public SearchSirenFiltersEntityType getEntityType() {
    return entityType;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENTITY_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityType(@javax.annotation.Nullable SearchSirenFiltersEntityType entityType) {
    this.entityType = entityType;
  }


  public SearchSirenFilters administrativeStatus(@javax.annotation.Nullable SearchSirenFiltersAdministrativeStatus administrativeStatus) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public SearchSirenFiltersAdministrativeStatus getAdministrativeStatus() {
    return administrativeStatus;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ADMINISTRATIVE_STATUS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAdministrativeStatus(@javax.annotation.Nullable SearchSirenFiltersAdministrativeStatus administrativeStatus) {
    this.administrativeStatus = administrativeStatus;
  }


  /**
   * Return true if this searchSirenFilters object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchSirenFilters searchSirenFilters = (SearchSirenFilters) o;
    return Objects.equals(this.siren, searchSirenFilters.siren) &&
        Objects.equals(this.businessName, searchSirenFilters.businessName) &&
        Objects.equals(this.entityType, searchSirenFilters.entityType) &&
        Objects.equals(this.administrativeStatus, searchSirenFilters.administrativeStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchSirenFilters {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getBusinessName() != null) {
      joiner.add(getBusinessName().toUrlQueryString(prefix + "businessName" + suffix));
    }

    // add `entityType` to the URL query string
    if (getEntityType() != null) {
      joiner.add(getEntityType().toUrlQueryString(prefix + "entityType" + suffix));
    }
