 ...
 */
public enum ContainsOrStartWithOperator {
  ...
  ContainsOrStartWithOperator(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ContainsOrStartWithOperator fromValue(String value) {
    for (ContainsOrStartWithOperator b : ContainsOrStartWithOperator.values()) {
