 ...
 */
@JsonPropertyOrder({
  LegalUnitPayloadHistory.JSON_PROPERTY_SIREN,
  LegalUnitPayloadHistory.JSON_PROPERTY_BUSINESS_NAME,
  LegalUnitPayloadHistory.JSON_PROPERTY_ENTITY_TYPE,
  LegalUnitPayloadHistory.JSON_PROPERTY_ADMINISTRATIVE_STATUS,
  LegalUnitPayloadHistory.JSON_PROPERTY_INSTRUCTIONS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class LegalUnitPayloadHistory {
  ...
  public LegalUnitPayloadHistory() { 
  }

  public LegalUnitPayloadHistory siren(@javax.annotation.Nullable String siren) {
    this.siren = siren;
    return this;
  }
  ...
  public LegalUnitPayloadHistory businessName(@javax.annotation.Nullable String businessName) {
  ...
  public LegalUnitPayloadHistory entityType(@javax.annotation.Nullable EntityType entityType) {
  ...
  public LegalUnitPayloadHistory administrativeStatus(@javax.annotation.Nullable LegalUnitAdministrativeStatus administrativeStatus) {
  ...
  public LegalUnitPayloadHistory instructions(@javax.annotation.Nullable SirenInstructions instructions) {
  ...
  /**
   * Return true if this legalUnitPayloadHistory object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    LegalUnitPayloadHistory legalUnitPayloadHistory = (LegalUnitPayloadHistory) o;
    return Objects.equals(this.siren, legalUnitPayloadHistory.siren) &&
        Objects.equals(this.businessName, legalUnitPayloadHistory.businessName) &&
        Objects.equals(this.entityType, legalUnitPayloadHistory.entityType) &&
        Objects.equals(this.administrativeStatus, legalUnitPayloadHistory.administrativeStatus) &&
        Objects.equals(this.instructions, legalUnitPayloadHistory.instructions);
  }
  ...
  public String toString() {
    ...
    sb.append("class LegalUnitPayloadHistory {\n");
