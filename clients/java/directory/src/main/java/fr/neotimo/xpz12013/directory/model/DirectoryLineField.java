 ...
 */
public enum DirectoryLineField {
  ...
  DirectoryLineField(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DirectoryLineField fromValue(String value) {
    for (DirectoryLineField b : DirectoryLineField.values()) {
