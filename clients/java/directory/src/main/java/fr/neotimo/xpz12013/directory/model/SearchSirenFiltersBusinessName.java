...
import fr.neotimo.xpz12013.directory.model.ContainsOrStrictOrStartWithOperator;
 ...
 */
@JsonPropertyOrder({
  SearchSirenFiltersBusinessName.JSON_PROPERTY_OP,
  SearchSirenFiltersBusinessName.JSON_PROPERTY_VALUE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SearchSirenFiltersBusinessName {
  public static final String JSON_PROPERTY_OP = "op";
  @javax.annotation.Nullable
  private ContainsOrStrictOrStartWithOperator op;

  public static final String JSON_PROPERTY_VALUE = "value";
  @javax.annotation.Nullable
  private String value;

  public SearchSirenFiltersBusinessName() { 
  }

  public SearchSirenFiltersBusinessName op(@javax.annotation.Nullable ContainsOrStrictOrStartWithOperator op) {
    this.op = op;
    return this;
  }
  ...
  public ContainsOrStrictOrStartWithOperator getOp() {
    return op;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOp(@javax.annotation.Nullable ContainsOrStrictOrStartWithOperator op) {
    this.op = op;
  }


  public SearchSirenFiltersBusinessName value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  /**
   * Return true if this searchSirenFiltersBusinessName object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchSirenFiltersBusinessName searchSirenFiltersBusinessName = (SearchSirenFiltersBusinessName) o;
    return Objects.equals(this.op, searchSirenFiltersBusinessName.op) &&
        Objects.equals(this.value, searchSirenFiltersBusinessName.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchSirenFiltersBusinessName {\n");
