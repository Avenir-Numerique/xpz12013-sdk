 ...
 */
public enum RoutingCodeAdministrativeStatus {
  ...
  RoutingCodeAdministrativeStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static RoutingCodeAdministrativeStatus fromValue(String value) {
    for (RoutingCodeAdministrativeStatus b : RoutingCodeAdministrativeStatus.values()) {
