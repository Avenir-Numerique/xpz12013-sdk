...
import fr.neotimo.xpz12013.directory.model.ContainsOperator;
...
public class SearchSiretFiltersAddressLines {
  ...
  public SearchSiretFiltersAddressLines op(@javax.annotation.Nullable ContainsOperator op) {
    this.op = op;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOp(@javax.annotation.Nullable ContainsOperator op) {
    this.op = op;
  }
