...
import fr.neotimo.xpz12013.directory.model.ContainsOrStartWithOperator;
 ...
 */
@JsonPropertyOrder({
  SearchSiretFiltersAddressLines.JSON_PROPERTY_OP,
  SearchSiretFiltersAddressLines.JSON_PROPERTY_VALUE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SearchSiretFiltersAddressLines {
  public static final String JSON_PROPERTY_OP = "op";
  @javax.annotation.Nullable
  private ContainsOrStartWithOperator op;

  public static final String JSON_PROPERTY_VALUE = "value";
  @javax.annotation.Nullable
  private String value;

  public SearchSiretFiltersAddressLines() { 
  }

  public SearchSiretFiltersAddressLines op(@javax.annotation.Nullable ContainsOrStartWithOperator op) {
    this.op = op;
    return this;
  }
  ...
  public ContainsOrStartWithOperator getOp() {
    return op;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOp(@javax.annotation.Nullable ContainsOrStartWithOperator op) {
    this.op = op;
  }


  public SearchSiretFiltersAddressLines value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  /**
   * Return true if this searchSiretFiltersAddressLines object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchSiretFiltersAddressLines searchSiretFiltersAddressLines = (SearchSiretFiltersAddressLines) o;
    return Objects.equals(this.op, searchSiretFiltersAddressLines.op) &&
        Objects.equals(this.value, searchSiretFiltersAddressLines.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchSiretFiltersAddressLines {\n");
