 ...
 */
@JsonPropertyOrder({
  RoutingCodeSearchFiltersRoutingCodeName.JSON_PROPERTY_OP,
  RoutingCodeSearchFiltersRoutingCodeName.JSON_PROPERTY_VALUE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class RoutingCodeSearchFiltersRoutingCodeName {
  ...
  public RoutingCodeSearchFiltersRoutingCodeName() { 
  }

  public RoutingCodeSearchFiltersRoutingCodeName op(@javax.annotation.Nullable ContainsOrStrictOperator op) {
    this.op = op;
    return this;
  }
  ...
  public RoutingCodeSearchFiltersRoutingCodeName value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  /**
   * Return true if this routingCodeSearchFiltersRoutingCodeName object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RoutingCodeSearchFiltersRoutingCodeName routingCodeSearchFiltersRoutingCodeName = (RoutingCodeSearchFiltersRoutingCodeName) o;
    return Objects.equals(this.op, routingCodeSearchFiltersRoutingCodeName.op) &&
        Objects.equals(this.value, routingCodeSearchFiltersRoutingCodeName.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoutingCodeSearchFiltersRoutingCodeName {\n");
