...
import fr.neotimo.xpz12013.directory.model.SearchSiretFilters;
import fr.neotimo.xpz12013.directory.model.SearchSiretSortingInner;
 ...
 */
@JsonPropertyOrder({
  SearchSiret.JSON_PROPERTY_FILTERS,
  SearchSiret.JSON_PROPERTY_SORTING,
  SearchSiret.JSON_PROPERTY_FIELDS,
  SearchSiret.JSON_PROPERTY_INCLUDE,
  SearchSiret.JSON_PROPERTY_LIMIT,
  SearchSiret.JSON_PROPERTY_IGNORE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SearchSiret {
  public static final String JSON_PROPERTY_FILTERS = "filters";
  @javax.annotation.Nullable
  private SearchSiretFilters filters;

  public static final String JSON_PROPERTY_SORTING = "sorting";
  @javax.annotation.Nullable
  private List<SearchSiretSortingInner> sorting = new ArrayList<>();

  public static final String JSON_PROPERTY_FIELDS = "fields";
  @javax.annotation.Nullable
  private List<SiretField> fields = new ArrayList<>();
  ...
  public SearchSiret filters(@javax.annotation.Nullable SearchSiretFilters filters) {
  ...
  public SearchSiretFilters getFilters() {
    return filters;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FILTERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFilters(@javax.annotation.Nullable SearchSiretFilters filters) {
    this.filters = filters;
  }


  public SearchSiret sorting(@javax.annotation.Nullable List<SearchSiretSortingInner> sorting) {
    this.sorting = sorting;
    return this;
  }

  public SearchSiret addSortingItem(SearchSiretSortingInner sortingItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<SearchSiretSortingInner> getSorting() {
    return sorting;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SORTING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSorting(@javax.annotation.Nullable List<SearchSiretSortingInner> sorting) {
    this.sorting = sorting;
  }


  public SearchSiret fields(@javax.annotation.Nullable List<SiretField> fields) {
    this.fields = fields;
    return this;
  }

  public SearchSiret addFieldsItem(SiretField fieldsItem) {
    if (this.fields == null) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<SiretField> getFields() {
    return fields;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FIELDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFields(@javax.annotation.Nullable List<SiretField> fields) {
    this.fields = fields;
  }


  public SearchSiret include(@javax.annotation.Nullable List<IncludeEnum> include) {
    this.include = include;
    return this;
  }

  public SearchSiret addIncludeItem(IncludeEnum includeItem) {
  ...
  public SearchSiret limit(@javax.annotation.Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public SearchSiret ignore(@javax.annotation.Nullable Integer ignore) {
    this.ignore = ignore;
    return this;
  }
  ...
  /**
   * Return true if this searchSiret object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchSiret searchSiret = (SearchSiret) o;
    return Objects.equals(this.filters, searchSiret.filters) &&
        Objects.equals(this.sorting, searchSiret.sorting) &&
        Objects.equals(this.fields, searchSiret.fields) &&
        Objects.equals(this.include, searchSiret.include) &&
        Objects.equals(this.limit, searchSiret.limit) &&
        Objects.equals(this.ignore, searchSiret.ignore);
  }
