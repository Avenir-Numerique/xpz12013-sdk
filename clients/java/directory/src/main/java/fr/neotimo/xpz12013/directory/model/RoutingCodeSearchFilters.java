...
import fr.neotimo.xpz12013.directory.model.RoutingCodeSearchFiltersAdministrativeStatus;
import fr.neotimo.xpz12013.directory.model.RoutingCodeSearchFiltersRoutingCodeName;
import fr.neotimo.xpz12013.directory.model.RoutingCodeSearchFiltersRoutingIdentifier;
 ...
 */
@JsonPropertyOrder({
  RoutingCodeSearchFilters.JSON_PROPERTY_ROUTING_IDENTIFIER,
  RoutingCodeSearchFilters.JSON_PROPERTY_SIRET,
  RoutingCodeSearchFilters.JSON_PROPERTY_ROUTING_CODE_NAME,
  RoutingCodeSearchFilters.JSON_PROPERTY_ADMINISTRATIVE_STATUS,
  RoutingCodeSearchFilters.JSON_PROPERTY_ADDRESS_LINES,
  RoutingCodeSearchFilters.JSON_PROPERTY_POSTAL_CODE,
  RoutingCodeSearchFilters.JSON_PROPERTY_LOCALITY
})
...
public class RoutingCodeSearchFilters {
  ...
  private RoutingCodeSearchFiltersRoutingIdentifier routingIdentifier;
  ...
  @javax.annotation.Nullable
  private RoutingCodeSearchFiltersRoutingCodeName routingCodeName;

  public static final String JSON_PROPERTY_ADMINISTRATIVE_STATUS = "administrativeStatus";
  @javax.annotation.Nullable
  private RoutingCodeSearchFiltersAdministrativeStatus administrativeStatus;
  ...
  public RoutingCodeSearchFilters() { 
  }

  public RoutingCodeSearchFilters routingIdentifier(@javax.annotation.Nullable RoutingCodeSearchFiltersRoutingIdentifier routingIdentifier) {
  ...
  public RoutingCodeSearchFiltersRoutingIdentifier getRoutingIdentifier() {
    return routingIdentifier;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROUTING_IDENTIFIER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRoutingIdentifier(@javax.annotation.Nullable RoutingCodeSearchFiltersRoutingIdentifier routingIdentifier) {
    this.routingIdentifier = routingIdentifier;
  }


  public RoutingCodeSearchFilters siret(@javax.annotation.Nullable SearchSiretFiltersSiret siret) {
    this.siret = siret;
    return this;
  }
  ...
  public RoutingCodeSearchFilters routingCodeName(@javax.annotation.Nullable RoutingCodeSearchFiltersRoutingCodeName routingCodeName) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public RoutingCodeSearchFiltersRoutingCodeName getRoutingCodeName() {
    return routingCodeName;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROUTING_CODE_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRoutingCodeName(@javax.annotation.Nullable RoutingCodeSearchFiltersRoutingCodeName routingCodeName) {
    this.routingCodeName = routingCodeName;
  }


  public RoutingCodeSearchFilters administrativeStatus(@javax.annotation.Nullable RoutingCodeSearchFiltersAdministrativeStatus administrativeStatus) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public RoutingCodeSearchFiltersAdministrativeStatus getAdministrativeStatus() {
    return administrativeStatus;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ADMINISTRATIVE_STATUS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAdministrativeStatus(@javax.annotation.Nullable RoutingCodeSearchFiltersAdministrativeStatus administrativeStatus) {
    this.administrativeStatus = administrativeStatus;
  }


  public RoutingCodeSearchFilters addressLines(@javax.annotation.Nullable SearchSiretFiltersAddressLines addressLines) {
  ...
  public RoutingCodeSearchFilters postalCode(@javax.annotation.Nullable SearchSiretFiltersPostalCode postalCode) {
  ...
  public RoutingCodeSearchFilters locality(@javax.annotation.Nullable SearchSiretFiltersLocality locality) {
  ...
  /**
   * Return true if this routingCodeSearchFilters object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RoutingCodeSearchFilters routingCodeSearchFilters = (RoutingCodeSearchFilters) o;
    return Objects.equals(this.routingIdentifier, routingCodeSearchFilters.routingIdentifier) &&
        Objects.equals(this.siret, routingCodeSearchFilters.siret) &&
        Objects.equals(this.routingCodeName, routingCodeSearchFilters.routingCodeName) &&
        Objects.equals(this.administrativeStatus, routingCodeSearchFilters.administrativeStatus) &&
        Objects.equals(this.addressLines, routingCodeSearchFilters.addressLines) &&
        Objects.equals(this.postalCode, routingCodeSearchFilters.postalCode) &&
        Objects.equals(this.locality, routingCodeSearchFilters.locality);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoutingCodeSearchFilters {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getRoutingIdentifier() != null) {
      joiner.add(getRoutingIdentifier().toUrlQueryString(prefix + "routingIdentifier" + suffix));
    }
    ...
    if (getRoutingCodeName() != null) {
      joiner.add(getRoutingCodeName().toUrlQueryString(prefix + "routingCodeName" + suffix));
    }
