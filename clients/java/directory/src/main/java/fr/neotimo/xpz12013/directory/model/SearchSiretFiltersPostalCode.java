...
import fr.neotimo.xpz12013.directory.model.StrictOrStartWithOperator;
 ...
 */
@JsonPropertyOrder({
  SearchSiretFiltersPostalCode.JSON_PROPERTY_OP,
  SearchSiretFiltersPostalCode.JSON_PROPERTY_VALUE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SearchSiretFiltersPostalCode {
  public static final String JSON_PROPERTY_OP = "op";
  @javax.annotation.Nullable
  private StrictOrStartWithOperator op;

  public static final String JSON_PROPERTY_VALUE = "value";
  @javax.annotation.Nullable
  private String value;

  public SearchSiretFiltersPostalCode() { 
  }

  public SearchSiretFiltersPostalCode op(@javax.annotation.Nullable StrictOrStartWithOperator op) {
    this.op = op;
    return this;
  }
  ...
  public StrictOrStartWithOperator getOp() {
    return op;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOp(@javax.annotation.Nullable StrictOrStartWithOperator op) {
    this.op = op;
  }


  public SearchSiretFiltersPostalCode value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  /**
   * Return true if this searchSiretFiltersPostalCode object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchSiretFiltersPostalCode searchSiretFiltersPostalCode = (SearchSiretFiltersPostalCode) o;
    return Objects.equals(this.op, searchSiretFiltersPostalCode.op) &&
        Objects.equals(this.value, searchSiretFiltersPostalCode.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchSiretFiltersPostalCode {\n");
