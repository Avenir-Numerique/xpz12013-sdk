 ...
 */
@JsonPropertyOrder({
  SearchDirectoryLineFiltersAddressingSuffix.JSON_PROPERTY_OP,
  SearchDirectoryLineFiltersAddressingSuffix.JSON_PROPERTY_VALUE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SearchDirectoryLineFiltersAddressingSuffix {
  ...
  public SearchDirectoryLineFiltersAddressingSuffix() { 
  }

  public SearchDirectoryLineFiltersAddressingSuffix op(@javax.annotation.Nullable ContainsOrStrictOperator op) {
    this.op = op;
    return this;
  }
  ...
  public SearchDirectoryLineFiltersAddressingSuffix value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  /**
   * Return true if this searchDirectoryLineFiltersAddressingSuffix object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchDirectoryLineFiltersAddressingSuffix searchDirectoryLineFiltersAddressingSuffix = (SearchDirectoryLineFiltersAddressingSuffix) o;
    return Objects.equals(this.op, searchDirectoryLineFiltersAddressingSuffix.op) &&
        Objects.equals(this.value, searchDirectoryLineFiltersAddressingSuffix.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchDirectoryLineFiltersAddressingSuffix {\n");
