 ...
 */
@JsonPropertyOrder({
  SiretSearchPost200Response.JSON_PROPERTY_SEARCH,
  SiretSearchPost200Response.JSON_PROPERTY_TOTAL_NUMBER_OF_RESULTS,
  SiretSearchPost200Response.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SiretSearchPost200Response {
  public static final String JSON_PROPERTY_SEARCH = "search";
  @javax.annotation.Nullable
  private SearchSiret search;
  ...
  @javax.annotation.Nullable
  private List<FacilityPayloadHistory> results = new ArrayList<>();

  public SiretSearchPost200Response() { 
  }

  public SiretSearchPost200Response search(@javax.annotation.Nullable SearchSiret search) {
    this.search = search;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SEARCH)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSearch(@javax.annotation.Nullable SearchSiret search) {
    this.search = search;
  }


  public SiretSearchPost200Response totalNumberOfResults(@javax.annotation.Nullable Integer totalNumberOfResults) {
  ...
  public SiretSearchPost200Response results(@javax.annotation.Nullable List<FacilityPayloadHistory> results) {
    this.results = results;
    return this;
  }

  public SiretSearchPost200Response addResultsItem(FacilityPayloadHistory resultsItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<FacilityPayloadHistory> getResults() {
    return results;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESULTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResults(@javax.annotation.Nullable List<FacilityPayloadHistory> results) {
    this.results = results;
  }


  /**
   * Return true if this siretSearchPost200Response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SiretSearchPost200Response siretSearchPost200Response = (SiretSearchPost200Response) o;
    return Objects.equals(this.search, siretSearchPost200Response.search) &&
        Objects.equals(this.totalNumberOfResults, siretSearchPost200Response.totalNumberOfResults) &&
        Objects.equals(this.results, siretSearchPost200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class SiretSearchPost200Response {\n");
