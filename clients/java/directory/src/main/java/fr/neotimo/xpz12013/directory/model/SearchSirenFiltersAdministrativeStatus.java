 ...
 */
@JsonPropertyOrder({
  SearchSirenFiltersAdministrativeStatus.JSON_PROPERTY_OP,
  SearchSirenFiltersAdministrativeStatus.JSON_PROPERTY_VALUE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SearchSirenFiltersAdministrativeStatus {
  ...
  @javax.annotation.Nullable
  private LegalUnitAdministrativeStatus value;

  public SearchSirenFiltersAdministrativeStatus() { 
  }

  public SearchSirenFiltersAdministrativeStatus op(@javax.annotation.Nullable StrictOperator op) {
    this.op = op;
    return this;
  }
  ...
  public SearchSirenFiltersAdministrativeStatus value(@javax.annotation.Nullable LegalUnitAdministrativeStatus value) {
    this.value = value;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public LegalUnitAdministrativeStatus getValue() {
    return value;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VALUE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValue(@javax.annotation.Nullable LegalUnitAdministrativeStatus value) {
    this.value = value;
  }


  /**
   * Return true if this searchSirenFiltersAdministrativeStatus object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchSirenFiltersAdministrativeStatus searchSirenFiltersAdministrativeStatus = (SearchSirenFiltersAdministrativeStatus) o;
    return Objects.equals(this.op, searchSirenFiltersAdministrativeStatus.op) &&
        Objects.equals(this.value, searchSirenFiltersAdministrativeStatus.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchSirenFiltersAdministrativeStatus {\n");
