...
import fr.neotimo.xpz12013.directory.model.SearchSirenFilters;
import fr.neotimo.xpz12013.directory.model.SearchSirenSortingInner;
 ...
 */
@JsonPropertyOrder({
  SearchSiren.JSON_PROPERTY_FILTERS,
  SearchSiren.JSON_PROPERTY_SORTING,
  SearchSiren.JSON_PROPERTY_FIELDS,
  SearchSiren.JSON_PROPERTY_LIMIT,
  SearchSiren.JSON_PROPERTY_IGNORE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SearchSiren {
  public static final String JSON_PROPERTY_FILTERS = "filters";
  @javax.annotation.Nullable
  private SearchSirenFilters filters;

  public static final String JSON_PROPERTY_SORTING = "sorting";
  @javax.annotation.Nullable
  private List<SearchSirenSortingInner> sorting = new ArrayList<>();

  public static final String JSON_PROPERTY_FIELDS = "fields";
  @javax.annotation.Nullable
  private List<SirenField> fields = new ArrayList<>();
  ...
  public SearchSiren filters(@javax.annotation.Nullable SearchSirenFilters filters) {
  ...
  public SearchSirenFilters getFilters() {
    return filters;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FILTERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFilters(@javax.annotation.Nullable SearchSirenFilters filters) {
    this.filters = filters;
  }


  public SearchSiren sorting(@javax.annotation.Nullable List<SearchSirenSortingInner> sorting) {
    this.sorting = sorting;
    return this;
  }

  public SearchSiren addSortingItem(SearchSirenSortingInner sortingItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<SearchSirenSortingInner> getSorting() {
    return sorting;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SORTING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSorting(@javax.annotation.Nullable List<SearchSirenSortingInner> sorting) {
    this.sorting = sorting;
  }


  public SearchSiren fields(@javax.annotation.Nullable List<SirenField> fields) {
    this.fields = fields;
    return this;
  }

  public SearchSiren addFieldsItem(SirenField fieldsItem) {
    if (this.fields == null) {
  ...
  @JsonProperty(JSON_PROPERTY_FIELDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFields(@javax.annotation.Nullable List<SirenField> fields) {
    this.fields = fields;
  }


  public SearchSiren limit(@javax.annotation.Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public SearchSiren ignore(@javax.annotation.Nullable Integer ignore) {
    this.ignore = ignore;
    return this;
  }
  ...
  /**
   * Return true if this searchSiren object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchSiren searchSiren = (SearchSiren) o;
    return Objects.equals(this.filters, searchSiren.filters) &&
        Objects.equals(this.sorting, searchSiren.sorting) &&
        Objects.equals(this.fields, searchSiren.fields) &&
        Objects.equals(this.limit, searchSiren.limit) &&
        Objects.equals(this.ignore, searchSiren.ignore);
  }
