...
import fr.neotimo.xpz12013.directory.model.StrictOperator;
 ...
 */
@JsonPropertyOrder({
  RoutingCodeSearchFiltersAdministrativeStatus.JSON_PROPERTY_OP,
  RoutingCodeSearchFiltersAdministrativeStatus.JSON_PROPERTY_VALUE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class RoutingCodeSearchFiltersAdministrativeStatus {
  public static final String JSON_PROPERTY_OP = "op";
  @javax.annotation.Nullable
  private StrictOperator op;

  public static final String JSON_PROPERTY_VALUE = "value";
  @javax.annotation.Nullable
  private RoutingCodeAdministrativeStatus value;

  public RoutingCodeSearchFiltersAdministrativeStatus() { 
  }

  public RoutingCodeSearchFiltersAdministrativeStatus op(@javax.annotation.Nullable StrictOperator op) {
    this.op = op;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOp(@javax.annotation.Nullable StrictOperator op) {
    this.op = op;
  }


  public RoutingCodeSearchFiltersAdministrativeStatus value(@javax.annotation.Nullable RoutingCodeAdministrativeStatus value) {
    this.value = value;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public RoutingCodeAdministrativeStatus getValue() {
    return value;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VALUE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValue(@javax.annotation.Nullable RoutingCodeAdministrativeStatus value) {
    this.value = value;
  }


  /**
   * Return true if this routingCodeSearchFiltersAdministrativeStatus object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RoutingCodeSearchFiltersAdministrativeStatus routingCodeSearchFiltersAdministrativeStatus = (RoutingCodeSearchFiltersAdministrativeStatus) o;
    return Objects.equals(this.op, routingCodeSearchFiltersAdministrativeStatus.op) &&
        Objects.equals(this.value, routingCodeSearchFiltersAdministrativeStatus.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoutingCodeSearchFiltersAdministrativeStatus {\n");
