 ...
 */
public enum StrictOrStartWithOperator {
  ...
  StrictOrStartWithOperator(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static StrictOrStartWithOperator fromValue(String value) {
    for (StrictOrStartWithOperator b : StrictOrStartWithOperator.values()) {
