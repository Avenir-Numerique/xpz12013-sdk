...
public enum RoutingCodeField {
  ...
  @JsonCreator
  public static RoutingCodeField fromValue(String value) {
    for (RoutingCodeField b : RoutingCodeField.values()) {
