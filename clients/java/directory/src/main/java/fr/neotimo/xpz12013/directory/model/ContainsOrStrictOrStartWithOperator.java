 ...
 */
public enum ContainsOrStrictOrStartWithOperator {
  ...
  ContainsOrStrictOrStartWithOperator(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ContainsOrStrictOrStartWithOperator fromValue(String value) {
    for (ContainsOrStrictOrStartWithOperator b : ContainsOrStrictOrStartWithOperator.values()) {
