 ...
 */
@JsonPropertyOrder({
  SearchSiretFiltersAdministrativeStatus.JSON_PROPERTY_OP,
  SearchSiretFiltersAdministrativeStatus.JSON_PROPERTY_VALUE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SearchSiretFiltersAdministrativeStatus {
  ...
  @javax.annotation.Nullable
  private FacilityAdministrativeStatus value;

  public SearchSiretFiltersAdministrativeStatus() { 
  }

  public SearchSiretFiltersAdministrativeStatus op(@javax.annotation.Nullable StrictOperator op) {
    this.op = op;
    return this;
  }
  ...
  public SearchSiretFiltersAdministrativeStatus value(@javax.annotation.Nullable FacilityAdministrativeStatus value) {
    this.value = value;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public FacilityAdministrativeStatus getValue() {
    return value;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VALUE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValue(@javax.annotation.Nullable FacilityAdministrativeStatus value) {
    this.value = value;
  }


  /**
   * Return true if this searchSiretFiltersAdministrativeStatus object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchSiretFiltersAdministrativeStatus searchSiretFiltersAdministrativeStatus = (SearchSiretFiltersAdministrativeStatus) o;
    return Objects.equals(this.op, searchSiretFiltersAdministrativeStatus.op) &&
        Objects.equals(this.value, searchSiretFiltersAdministrativeStatus.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchSiretFiltersAdministrativeStatus {\n");
