...
import fr.neotimo.xpz12013.directory.model.ContainsOrStrictOperator;
 ...
 */
@JsonPropertyOrder({
  SearchDirectoryLineFiltersAddressingIdentifier.JSON_PROPERTY_OP,
  SearchDirectoryLineFiltersAddressingIdentifier.JSON_PROPERTY_VALUE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SearchDirectoryLineFiltersAddressingIdentifier {
  public static final String JSON_PROPERTY_OP = "op";
  @javax.annotation.Nullable
  private ContainsOrStrictOperator op;

  public static final String JSON_PROPERTY_VALUE = "value";
  @javax.annotation.Nullable
  private String value;

  public SearchDirectoryLineFiltersAddressingIdentifier() { 
  }

  public SearchDirectoryLineFiltersAddressingIdentifier op(@javax.annotation.Nullable ContainsOrStrictOperator op) {
    this.op = op;
    return this;
  }
  ...
  public ContainsOrStrictOperator getOp() {
    return op;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOp(@javax.annotation.Nullable ContainsOrStrictOperator op) {
    this.op = op;
  }


  public SearchDirectoryLineFiltersAddressingIdentifier value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  /**
   * Return true if this searchDirectoryLineFiltersAddressingIdentifier object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchDirectoryLineFiltersAddressingIdentifier searchDirectoryLineFiltersAddressingIdentifier = (SearchDirectoryLineFiltersAddressingIdentifier) o;
    return Objects.equals(this.op, searchDirectoryLineFiltersAddressingIdentifier.op) &&
        Objects.equals(this.value, searchDirectoryLineFiltersAddressingIdentifier.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchDirectoryLineFiltersAddressingIdentifier {\n");
