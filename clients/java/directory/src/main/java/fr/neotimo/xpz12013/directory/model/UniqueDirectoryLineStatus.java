...
/**
 * Current line status of the platform.   - Enabled : Active line linked to a platform   - Disabled : No platform linked to the line 
 */
public enum UniqueDirectoryLineStatus {
  ...
  UniqueDirectoryLineStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static UniqueDirectoryLineStatus fromValue(String value) {
    for (UniqueDirectoryLineStatus b : UniqueDirectoryLineStatus.values()) {
