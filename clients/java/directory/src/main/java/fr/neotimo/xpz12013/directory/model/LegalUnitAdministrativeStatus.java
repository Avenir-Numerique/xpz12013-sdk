 ...
 */
public enum LegalUnitAdministrativeStatus {
  ...
  LegalUnitAdministrativeStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static LegalUnitAdministrativeStatus fromValue(String value) {
    for (LegalUnitAdministrativeStatus b : LegalUnitAdministrativeStatus.values()) {
