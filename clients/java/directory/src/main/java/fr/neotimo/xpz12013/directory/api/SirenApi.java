...
import fr.neotimo.xpz12013.directory.model.SirenField;
import fr.neotimo.xpz12013.directory.model.SirenSearchPost200Response;
...
public class SirenApi {
  ...
  public SirenApi(ApiClient apiClient) {
   ...
   * @param siren Corresponds to the SIREN number of a legal unit. (required)
   * @param fields Fields of the SIREN resource. (optional)
   * @return LegalUnitPayloadHistory
   * @throws ApiException if fails to make API call
   */
  public LegalUnitPayloadHistory getCompanyBySiren(String siren, List<SirenField> fields) throws ApiException {
    ApiResponse<LegalUnitPayloadHistory> localVarResponse = getCompanyBySirenWithHttpInfo(siren, fields);
   ...
   * @param siren Corresponds to the SIREN number of a legal unit. (required)
   * @param fields Fields of the SIREN resource. (optional)
   * @return ApiResponse&lt;LegalUnitPayloadHistory&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<LegalUnitPayloadHistory> getCompanyBySirenWithHttpInfo(String siren, List<SirenField> fields) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getCompanyBySirenRequestBuilder(siren, fields);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getCompanyBySiren", localVarResponse);
        }
        if (localVarResponse.body() == null) {
          return new ApiResponse<LegalUnitPayloadHistory>(
        ...
        return new ApiResponse<LegalUnitPayloadHistory>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<LegalUnitPayloadHistory>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder getCompanyBySirenRequestBuilder(String siren, List<SirenField> fields) throws ApiException {
    // verify the required parameter 'siren' is set
    if (siren == null) {
      throw new ApiException(400, "Missing the required parameter 'siren' when calling getCompanyBySiren");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v1/siren/code-insee:{siren}"
        .replace("{siren}", ApiClient.urlEncode(siren.toString()));
   ...
   * @param searchSiren  (optional)
   * @return SirenSearchPost200Response
   * @throws ApiException if fails to make API call
   */
  public SirenSearchPost200Response searchCompanyBySiren(SearchSiren searchSiren) throws ApiException {
    ApiResponse<SirenSearchPost200Response> localVarResponse = searchCompanyBySirenWithHttpInfo(searchSiren);
    return localVarResponse.getData();
  }
   ...
   * Multi-criteria company search.
   * @param searchSiren  (optional)
   * @return ApiResponse&lt;SirenSearchPost200Response&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<SirenSearchPost200Response> searchCompanyBySirenWithHttpInfo(SearchSiren searchSiren) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = searchCompanyBySirenRequestBuilder(searchSiren);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("searchCompanyBySiren", localVarResponse);
        }
        if (localVarResponse.body() == null) {
          return new ApiResponse<SirenSearchPost200Response>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        return new ApiResponse<SirenSearchPost200Response>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<SirenSearchPost200Response>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder searchCompanyBySirenRequestBuilder(SearchSiren searchSiren) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v1/siren/search";
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(searchSiren);
