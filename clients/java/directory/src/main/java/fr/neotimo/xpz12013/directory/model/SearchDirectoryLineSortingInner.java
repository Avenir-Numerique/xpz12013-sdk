 ...
 */
@JsonPropertyOrder({
  SearchDirectoryLineSortingInner.JSON_PROPERTY_FIELD,
  SearchDirectoryLineSortingInner.JSON_PROPERTY_ORDER
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SearchDirectoryLineSortingInner {
  public static final String JSON_PROPERTY_FIELD = "field";
  @javax.annotation.Nullable
  private DirectoryLineField field;

  public static final String JSON_PROPERTY_ORDER = "order";
  @javax.annotation.Nullable
  private SortingOrder order;

  public SearchDirectoryLineSortingInner() { 
  }

  public SearchDirectoryLineSortingInner field(@javax.annotation.Nullable DirectoryLineField field) {
    this.field = field;
    return this;
  }
  ...
  public DirectoryLineField getField() {
    return field;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FIELD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setField(@javax.annotation.Nullable DirectoryLineField field) {
    this.field = field;
  }


  public SearchDirectoryLineSortingInner order(@javax.annotation.Nullable SortingOrder order) {
    this.order = order;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ORDER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOrder(@javax.annotation.Nullable SortingOrder order) {
    this.order = order;
  }


  /**
   * Return true if this searchDirectoryLineSortingInner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchDirectoryLineSortingInner searchDirectoryLineSortingInner = (SearchDirectoryLineSortingInner) o;
    return Objects.equals(this.field, searchDirectoryLineSortingInner.field) &&
        Objects.equals(this.order, searchDirectoryLineSortingInner.order);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchDirectoryLineSortingInner {\n");
