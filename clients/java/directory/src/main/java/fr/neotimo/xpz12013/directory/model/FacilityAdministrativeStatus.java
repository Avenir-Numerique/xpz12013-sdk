 ...
 */
public enum FacilityAdministrativeStatus {
  ...
  FacilityAdministrativeStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static FacilityAdministrativeStatus fromValue(String value) {
    for (FacilityAdministrativeStatus b : FacilityAdministrativeStatus.values()) {
