...
import fr.neotimo.xpz12013.directory.model.DirectoryLineStatus;
 ...
 */
@JsonPropertyOrder({
  DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode.JSON_PROPERTY_ADDRESSING_IDENTIFIER,
  DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode.JSON_PROPERTY_PLATFORM_TYPE,
  DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode.JSON_PROPERTY_DIRECTORY_LINE_STATUS,
  DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode.JSON_PROPERTY_SIREN,
  DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode.JSON_PROPERTY_SIRET,
  DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode.JSON_PROPERTY_ROUTING_IDENTIFIER,
  DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode.JSON_PROPERTY_ADDRESSING_SUFFIX,
  DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode.JSON_PROPERTY_ROUTING_CODE,
  DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode.JSON_PROPERTY_LEGAL_UNIT,
  DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode.JSON_PROPERTY_FACILITY
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode {
  ...
  @javax.annotation.Nullable
  private DirectoryLineStatus directoryLineStatus;
  ...
  public DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode() { 
  }

  public DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode addressingIdentifier(@javax.annotation.Nullable String addressingIdentifier) {
  ...
  public DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode platformType(@javax.annotation.Nullable RecipientPlatformType platformType) {
  ...
  public DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode directoryLineStatus(@javax.annotation.Nullable DirectoryLineStatus directoryLineStatus) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public DirectoryLineStatus getDirectoryLineStatus() {
    return directoryLineStatus;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DIRECTORY_LINE_STATUS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDirectoryLineStatus(@javax.annotation.Nullable DirectoryLineStatus directoryLineStatus) {
    this.directoryLineStatus = directoryLineStatus;
  }


  public DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode siren(@javax.annotation.Nullable String siren) {
    this.siren = siren;
    return this;
  }
  ...
  public DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode siret(@javax.annotation.Nullable String siret) {
    this.siret = siret;
    return this;
  }
  ...
  public DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode routingIdentifier(@javax.annotation.Nullable String routingIdentifier) {
  ...
  public DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode addressingSuffix(@javax.annotation.Nullable String addressingSuffix) {
  ...
  public DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode routingCode(@javax.annotation.Nullable DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode routingCode) {
  ...
  public DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode legalUnit(@javax.annotation.Nullable LegalUnitPayloadIncluded legalUnit) {
  ...
  public DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode facility(@javax.annotation.Nullable FacilityPayloadIncluded facility) {
  ...
  /**
   * Return true if this directoryLinePayloadStatusLegalUnitFacilityRoutingCode object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode directoryLinePayloadStatusLegalUnitFacilityRoutingCode = (DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode) o;
    return Objects.equals(this.addressingIdentifier, directoryLinePayloadStatusLegalUnitFacilityRoutingCode.addressingIdentifier) &&
        Objects.equals(this.platformType, directoryLinePayloadStatusLegalUnitFacilityRoutingCode.platformType) &&
        Objects.equals(this.directoryLineStatus, directoryLinePayloadStatusLegalUnitFacilityRoutingCode.directoryLineStatus) &&
        Objects.equals(this.siren, directoryLinePayloadStatusLegalUnitFacilityRoutingCode.siren) &&
        Objects.equals(this.siret, directoryLinePayloadStatusLegalUnitFacilityRoutingCode.siret) &&
        Objects.equals(this.routingIdentifier, directoryLinePayloadStatusLegalUnitFacilityRoutingCode.routingIdentifier) &&
        Objects.equals(this.addressingSuffix, directoryLinePayloadStatusLegalUnitFacilityRoutingCode.addressingSuffix) &&
        Objects.equals(this.routingCode, directoryLinePayloadStatusLegalUnitFacilityRoutingCode.routingCode) &&
        Objects.equals(this.legalUnit, directoryLinePayloadStatusLegalUnitFacilityRoutingCode.legalUnit) &&
        Objects.equals(this.facility, directoryLinePayloadStatusLegalUnitFacilityRoutingCode.facility);
  }
  ...
  public String toString() {
    ...
    sb.append("class DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode {\n");
