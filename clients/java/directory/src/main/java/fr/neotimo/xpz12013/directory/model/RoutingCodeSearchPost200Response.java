 ...
 */
@JsonPropertyOrder({
  RoutingCodeSearchPost200Response.JSON_PROPERTY_SEARCH,
  RoutingCodeSearchPost200Response.JSON_PROPERTY_TOTAL_NUMBER_OF_RESULTS,
  RoutingCodeSearchPost200Response.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class RoutingCodeSearchPost200Response {
  public static final String JSON_PROPERTY_SEARCH = "search";
  @javax.annotation.Nullable
  private RoutingCodeSearch search;
  ...
  @javax.annotation.Nullable
  private List<RoutingCodePayloadHistoryLegalUnitFacility> results = new ArrayList<>();

  public RoutingCodeSearchPost200Response() { 
  }

  public RoutingCodeSearchPost200Response search(@javax.annotation.Nullable RoutingCodeSearch search) {
    this.search = search;
    return this;
  }
  ...
  public RoutingCodeSearch getSearch() {
    return search;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SEARCH)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSearch(@javax.annotation.Nullable RoutingCodeSearch search) {
    this.search = search;
  }


  public RoutingCodeSearchPost200Response totalNumberOfResults(@javax.annotation.Nullable Integer totalNumberOfResults) {
  ...
  public RoutingCodeSearchPost200Response results(@javax.annotation.Nullable List<RoutingCodePayloadHistoryLegalUnitFacility> results) {
    this.results = results;
    return this;
  }

  public RoutingCodeSearchPost200Response addResultsItem(RoutingCodePayloadHistoryLegalUnitFacility resultsItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<RoutingCodePayloadHistoryLegalUnitFacility> getResults() {
    return results;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESULTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResults(@javax.annotation.Nullable List<RoutingCodePayloadHistoryLegalUnitFacility> results) {
    this.results = results;
  }


  /**
   * Return true if this routingCodeSearchPost200Response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RoutingCodeSearchPost200Response routingCodeSearchPost200Response = (RoutingCodeSearchPost200Response) o;
    return Objects.equals(this.search, routingCodeSearchPost200Response.search) &&
        Objects.equals(this.totalNumberOfResults, routingCodeSearchPost200Response.totalNumberOfResults) &&
        Objects.equals(this.results, routingCodeSearchPost200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoutingCodeSearchPost200Response {\n");
