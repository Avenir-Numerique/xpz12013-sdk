...
import fr.neotimo.xpz12013.directory.model.SearchDirectoryLineFiltersAddressingIdentifier;
import fr.neotimo.xpz12013.directory.model.SearchDirectoryLineFiltersAddressingSuffix;
 ...
 */
@JsonPropertyOrder({
  SearchDirectoryLineFilters.JSON_PROPERTY_ADDRESSING_IDENTIFIER,
  SearchDirectoryLineFilters.JSON_PROPERTY_SIREN,
  SearchDirectoryLineFilters.JSON_PROPERTY_SIRET,
  SearchDirectoryLineFilters.JSON_PROPERTY_ROUTING_IDENTIFIER,
  SearchDirectoryLineFilters.JSON_PROPERTY_ADDRESSING_SUFFIX
})
...
public class SearchDirectoryLineFilters {
  ...
  private SearchDirectoryLineFiltersAddressingIdentifier addressingIdentifier;
  ...
  @javax.annotation.Nullable
  private SearchDirectoryLineFiltersAddressingSuffix addressingSuffix;

  public SearchDirectoryLineFilters() { 
  }

  public SearchDirectoryLineFilters addressingIdentifier(@javax.annotation.Nullable SearchDirectoryLineFiltersAddressingIdentifier addressingIdentifier) {
  ...
  public SearchDirectoryLineFiltersAddressingIdentifier getAddressingIdentifier() {
    return addressingIdentifier;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ADDRESSING_IDENTIFIER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAddressingIdentifier(@javax.annotation.Nullable SearchDirectoryLineFiltersAddressingIdentifier addressingIdentifier) {
    this.addressingIdentifier = addressingIdentifier;
  }


  public SearchDirectoryLineFilters siren(@javax.annotation.Nullable SearchSirenFiltersSiren siren) {
    this.siren = siren;
    return this;
  }
  ...
  public SearchDirectoryLineFilters siret(@javax.annotation.Nullable SearchSiretFiltersSiret siret) {
    this.siret = siret;
    return this;
  }
  ...
  public SearchDirectoryLineFilters routingIdentifier(@javax.annotation.Nullable RoutingCodeSearchFiltersRoutingIdentifier routingIdentifier) {
  ...
  public SearchDirectoryLineFilters addressingSuffix(@javax.annotation.Nullable SearchDirectoryLineFiltersAddressingSuffix addressingSuffix) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public SearchDirectoryLineFiltersAddressingSuffix getAddressingSuffix() {
    return addressingSuffix;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ADDRESSING_SUFFIX)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAddressingSuffix(@javax.annotation.Nullable SearchDirectoryLineFiltersAddressingSuffix addressingSuffix) {
    this.addressingSuffix = addressingSuffix;
  }


  /**
   * Return true if this searchDirectoryLineFilters object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchDirectoryLineFilters searchDirectoryLineFilters = (SearchDirectoryLineFilters) o;
    return Objects.equals(this.addressingIdentifier, searchDirectoryLineFilters.addressingIdentifier) &&
        Objects.equals(this.siren, searchDirectoryLineFilters.siren) &&
        Objects.equals(this.siret, searchDirectoryLineFilters.siret) &&
        Objects.equals(this.routingIdentifier, searchDirectoryLineFilters.routingIdentifier) &&
        Objects.equals(this.addressingSuffix, searchDirectoryLineFilters.addressingSuffix);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchDirectoryLineFilters {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAddressingIdentifier() != null) {
      joiner.add(getAddressingIdentifier().toUrlQueryString(prefix + "addressingIdentifier" + suffix));
    }
    ...
    if (getAddressingSuffix() != null) {
      joiner.add(getAddressingSuffix().toUrlQueryString(prefix + "addressingSuffix" + suffix));
    }
