 ...
 */
@JsonPropertyOrder({
  SirenInstructions.JSON_PROPERTY_IS_SALES_PROSPECTING_FORBIDDEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SirenInstructions {
  public static final String JSON_PROPERTY_IS_SALES_PROSPECTING_FORBIDDEN = "isSalesProspectingForbidden";
  @javax.annotation.Nullable
  private Boolean isSalesProspectingForbidden;

  public SirenInstructions() { 
  }

  public SirenInstructions isSalesProspectingForbidden(@javax.annotation.Nullable Boolean isSalesProspectingForbidden) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_IS_SALES_PROSPECTING_FORBIDDEN)
  ...
  /**
   * Return true if this sirenInstructions object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SirenInstructions sirenInstructions = (SirenInstructions) o;
    return Objects.equals(this.isSalesProspectingForbidden, sirenInstructions.isSalesProspectingForbidden);
  }
  ...
  public String toString() {
    ...
    sb.append("class SirenInstructions {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `isSalesProspectingForbidden` to the URL query string
    if (getIsSalesProspectingForbidden() != null) {
      joiner.add(String.format("%sisSalesProspectingForbidden%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getIsSalesProspectingForbidden()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
