 ...
 */
@JsonPropertyOrder({
  RoutingCodeSearchSortingInner.JSON_PROPERTY_FIELD,
  RoutingCodeSearchSortingInner.JSON_PROPERTY_ORDER
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class RoutingCodeSearchSortingInner {
  public static final String JSON_PROPERTY_FIELD = "field";
  @javax.annotation.Nullable
  private RoutingCodeField field;

  public static final String JSON_PROPERTY_ORDER = "order";
  @javax.annotation.Nullable
  private SortingOrder order;

  public RoutingCodeSearchSortingInner() { 
  }

  public RoutingCodeSearchSortingInner field(@javax.annotation.Nullable RoutingCodeField field) {
    this.field = field;
    return this;
  }
  ...
  public RoutingCodeField getField() {
    return field;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FIELD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setField(@javax.annotation.Nullable RoutingCodeField field) {
    this.field = field;
  }


  public RoutingCodeSearchSortingInner order(@javax.annotation.Nullable SortingOrder order) {
    this.order = order;
    return this;
  }
  ...
  /**
   * Return true if this routingCodeSearchSortingInner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RoutingCodeSearchSortingInner routingCodeSearchSortingInner = (RoutingCodeSearchSortingInner) o;
    return Objects.equals(this.field, routingCodeSearchSortingInner.field) &&
        Objects.equals(this.order, routingCodeSearchSortingInner.order);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoutingCodeSearchSortingInner {\n");
