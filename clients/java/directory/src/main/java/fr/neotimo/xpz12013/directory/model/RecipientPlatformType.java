 ...
 */
public enum RecipientPlatformType {
  ...
  RecipientPlatformType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static RecipientPlatformType fromValue(String value) {
    for (RecipientPlatformType b : RecipientPlatformType.values()) {
