 ...
 */
public enum ContainsOrStrictOperator {
  ...
  ContainsOrStrictOperator(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ContainsOrStrictOperator fromValue(String value) {
    for (ContainsOrStrictOperator b : ContainsOrStrictOperator.values()) {
