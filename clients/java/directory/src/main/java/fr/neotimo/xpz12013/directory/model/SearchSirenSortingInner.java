 ...
 */
@JsonPropertyOrder({
  SearchSirenSortingInner.JSON_PROPERTY_FIELD,
  SearchSirenSortingInner.JSON_PROPERTY_ORDER
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SearchSirenSortingInner {
  public static final String JSON_PROPERTY_FIELD = "field";
  @javax.annotation.Nullable
  private SirenField field;

  public static final String JSON_PROPERTY_ORDER = "order";
  @javax.annotation.Nullable
  private SortingOrder order;

  public SearchSirenSortingInner() { 
  }

  public SearchSirenSortingInner field(@javax.annotation.Nullable SirenField field) {
    this.field = field;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FIELD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setField(@javax.annotation.Nullable SirenField field) {
    this.field = field;
  }


  public SearchSirenSortingInner order(@javax.annotation.Nullable SortingOrder order) {
    this.order = order;
    return this;
  }
  ...
  /**
   * Return true if this searchSirenSortingInner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchSirenSortingInner searchSirenSortingInner = (SearchSirenSortingInner) o;
    return Objects.equals(this.field, searchSirenSortingInner.field) &&
        Objects.equals(this.order, searchSirenSortingInner.order);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchSirenSortingInner {\n");
