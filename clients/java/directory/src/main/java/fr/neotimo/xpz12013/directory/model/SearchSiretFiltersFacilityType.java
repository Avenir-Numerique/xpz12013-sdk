 ...
 */
@JsonPropertyOrder({
  SearchSiretFiltersFacilityType.JSON_PROPERTY_OP,
  SearchSiretFiltersFacilityType.JSON_PROPERTY_VALUE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SearchSiretFiltersFacilityType {
  ...
  @javax.annotation.Nullable
  private FacilityType value;

  public SearchSiretFiltersFacilityType() { 
  }

  public SearchSiretFiltersFacilityType op(@javax.annotation.Nullable StrictOperator op) {
    this.op = op;
    return this;
  }
  ...
  public SearchSiretFiltersFacilityType value(@javax.annotation.Nullable FacilityType value) {
    this.value = value;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VALUE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValue(@javax.annotation.Nullable FacilityType value) {
    this.value = value;
  }


  /**
   * Return true if this searchSiretFiltersFacilityType object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchSiretFiltersFacilityType searchSiretFiltersFacilityType = (SearchSiretFiltersFacilityType) o;
    return Objects.equals(this.op, searchSiretFiltersFacilityType.op) &&
        Objects.equals(this.value, searchSiretFiltersFacilityType.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchSiretFiltersFacilityType {\n");
