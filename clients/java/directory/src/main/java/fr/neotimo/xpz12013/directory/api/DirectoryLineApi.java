...
import fr.neotimo.xpz12013.directory.model.DirectoryLineField;
import fr.neotimo.xpz12013.directory.model.DirectoryLinePayloadLegalUnitFacilityRoutingCode;
import fr.neotimo.xpz12013.directory.model.DirectoryLineSearchPost200Response;
import fr.neotimo.xpz12013.directory.model.Error;
import fr.neotimo.xpz12013.directory.model.SearchDirectoryLine;
...
public class DirectoryLineApi {
  ...
  public DirectoryLineApi() {
    this(new ApiClient());
  }

  public DirectoryLineApi(ApiClient apiClient) {
   ...
   * @param addressingIdentifier Addressing identifier of the directory line (required)
   * @param include Relations to include in the response.. (optional)
   * @param fields Fields of the Directory Line resource (optional)
   * @return DirectoryLinePayloadLegalUnitFacilityRoutingCode
   * @throws ApiException if fails to make API call
   */
  public DirectoryLinePayloadLegalUnitFacilityRoutingCode getDirectoryLineById(String addressingIdentifier, List<String> include, List<DirectoryLineField> fields) throws ApiException {
    ApiResponse<DirectoryLinePayloadLegalUnitFacilityRoutingCode> localVarResponse = getDirectoryLineByIdWithHttpInfo(addressingIdentifier, include, fields);
   ...
   * @param include Relations to include in the response.. (optional)
   * @param fields Fields of the Directory Line resource (optional)
   * @return ApiResponse&lt;DirectoryLinePayloadLegalUnitFacilityRoutingCode&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DirectoryLinePayloadLegalUnitFacilityRoutingCode> getDirectoryLineByIdWithHttpInfo(String addressingIdentifier, List<String> include, List<DirectoryLineField> fields) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getDirectoryLineByIdRequestBuilder(addressingIdentifier, include, fields);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getDirectoryLineById", localVarResponse);
        }
        if (localVarResponse.body() == null) {
          return new ApiResponse<DirectoryLinePayloadLegalUnitFacilityRoutingCode>(
        ...
        return new ApiResponse<DirectoryLinePayloadLegalUnitFacilityRoutingCode>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<DirectoryLinePayloadLegalUnitFacilityRoutingCode>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder getDirectoryLineByIdRequestBuilder(String addressingIdentifier, List<String> include, List<DirectoryLineField> fields) throws ApiException {
    // verify the required parameter 'addressingIdentifier' is set
    if (addressingIdentifier == null) {
      throw new ApiException(400, "Missing the required parameter 'addressingIdentifier' when calling getDirectoryLineById");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v1/directory-line/code:{addressing-identifier}"
        .replace("{addressing-identifier}", ApiClient.urlEncode(addressingIdentifier.toString()));
   ...
   * @param searchDirectoryLine  (optional)
   * @return DirectoryLineSearchPost200Response
   * @throws ApiException if fails to make API call
   */
  public DirectoryLineSearchPost200Response searchDirectoryLine(SearchDirectoryLine searchDirectoryLine) throws ApiException {
    ApiResponse<DirectoryLineSearchPost200Response> localVarResponse = searchDirectoryLineWithHttpInfo(searchDirectoryLine);
    return localVarResponse.getData();
  }
   ...
   * Search for directory lines that meet all the criteria passed as parameters and return the results in the desired format.
   * @param searchDirectoryLine  (optional)
   * @return ApiResponse&lt;DirectoryLineSearchPost200Response&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DirectoryLineSearchPost200Response> searchDirectoryLineWithHttpInfo(SearchDirectoryLine searchDirectoryLine) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = searchDirectoryLineRequestBuilder(searchDirectoryLine);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("searchDirectoryLine", localVarResponse);
        }
        if (localVarResponse.body() == null) {
          return new ApiResponse<DirectoryLineSearchPost200Response>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        return new ApiResponse<DirectoryLineSearchPost200Response>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<DirectoryLineSearchPost200Response>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder searchDirectoryLineRequestBuilder(SearchDirectoryLine searchDirectoryLine) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v1/directory-line/search";
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(searchDirectoryLine);
