 ...
 */
@JsonPropertyOrder({
  SearchSirenFiltersEntityType.JSON_PROPERTY_OP,
  SearchSirenFiltersEntityType.JSON_PROPERTY_VALUE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class SearchSirenFiltersEntityType {
  ...
  public SearchSirenFiltersEntityType() { 
  }

  public SearchSirenFiltersEntityType op(@javax.annotation.Nullable StrictOperator op) {
    this.op = op;
    return this;
  }
  ...
  public SearchSirenFiltersEntityType value(@javax.annotation.Nullable EntityType value) {
    this.value = value;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VALUE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValue(@javax.annotation.Nullable EntityType value) {
    this.value = value;
  }


  /**
   * Return true if this searchSirenFiltersEntityType object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchSirenFiltersEntityType searchSirenFiltersEntityType = (SearchSirenFiltersEntityType) o;
    return Objects.equals(this.op, searchSirenFiltersEntityType.op) &&
        Objects.equals(this.value, searchSirenFiltersEntityType.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchSirenFiltersEntityType {\n");
