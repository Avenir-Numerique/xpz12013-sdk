 ...
 */
@JsonPropertyOrder({
  FacilityPayloadIncluded.JSON_PROPERTY_SIRET,
  FacilityPayloadIncluded.JSON_PROPERTY_SIREN,
  FacilityPayloadIncluded.JSON_PROPERTY_NAME,
  FacilityPayloadIncluded.JSON_PROPERTY_FACILITY_TYPE,
  FacilityPayloadIncluded.JSON_PROPERTY_ADMINISTRATIVE_STATUS,
  FacilityPayloadIncluded.JSON_PROPERTY_INSTRUCTIONS,
  FacilityPayloadIncluded.JSON_PROPERTY_ADDRESS,
  FacilityPayloadIncluded.JSON_PROPERTY_B2G_ADDITIONAL_DATA
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class FacilityPayloadIncluded {
  ...
  @javax.annotation.Nullable
  private SiretInstructions instructions;
  ...
  public FacilityPayloadIncluded() { 
  }

  public FacilityPayloadIncluded siret(@javax.annotation.Nullable String siret) {
    this.siret = siret;
    return this;
  }
  ...
  public FacilityPayloadIncluded siren(@javax.annotation.Nullable String siren) {
    this.siren = siren;
    return this;
  }
  ...
  public FacilityPayloadIncluded name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public FacilityPayloadIncluded facilityType(@javax.annotation.Nullable FacilityType facilityType) {
  ...
  public FacilityPayloadIncluded administrativeStatus(@javax.annotation.Nullable FacilityAdministrativeStatus administrativeStatus) {
  ...
  public FacilityPayloadIncluded instructions(@javax.annotation.Nullable SiretInstructions instructions) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public SiretInstructions getInstructions() {
    return instructions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_INSTRUCTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInstructions(@javax.annotation.Nullable SiretInstructions instructions) {
    this.instructions = instructions;
  }


  public FacilityPayloadIncluded address(@javax.annotation.Nullable AddressRead address) {
  ...
  public FacilityPayloadIncluded b2gAdditionalData(@javax.annotation.Nullable FacilityPayloadHistoryUleB2gAdditionalData b2gAdditionalData) {
  ...
  /**
   * Return true if this facilityPayloadIncluded object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FacilityPayloadIncluded facilityPayloadIncluded = (FacilityPayloadIncluded) o;
    return Objects.equals(this.siret, facilityPayloadIncluded.siret) &&
        Objects.equals(this.siren, facilityPayloadIncluded.siren) &&
        Objects.equals(this.name, facilityPayloadIncluded.name) &&
        Objects.equals(this.facilityType, facilityPayloadIncluded.facilityType) &&
        Objects.equals(this.administrativeStatus, facilityPayloadIncluded.administrativeStatus) &&
        Objects.equals(this.instructions, facilityPayloadIncluded.instructions) &&
        Objects.equals(this.address, facilityPayloadIncluded.address) &&
        Objects.equals(this.b2gAdditionalData, facilityPayloadIncluded.b2gAdditionalData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(siret, siren, name, facilityType, administrativeStatus, instructions, address, b2gAdditionalData);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FacilityPayloadIncluded {\n");
