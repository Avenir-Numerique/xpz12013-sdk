...
import fr.neotimo.xpz12013.directory.model.DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode;
 ...
 */
@JsonPropertyOrder({
  DirectoryLineSearchPost200Response.JSON_PROPERTY_SEARCH,
  DirectoryLineSearchPost200Response.JSON_PROPERTY_TOTAL_NUMBER_OF_RESULTS,
  DirectoryLineSearchPost200Response.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class DirectoryLineSearchPost200Response {
  public static final String JSON_PROPERTY_SEARCH = "search";
  @javax.annotation.Nullable
  private SearchDirectoryLine search;
  ...
  @javax.annotation.Nullable
  private List<DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode> results = new ArrayList<>();

  public DirectoryLineSearchPost200Response() { 
  }

  public DirectoryLineSearchPost200Response search(@javax.annotation.Nullable SearchDirectoryLine search) {
    this.search = search;
    return this;
  }
  ...
  public SearchDirectoryLine getSearch() {
    return search;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SEARCH)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSearch(@javax.annotation.Nullable SearchDirectoryLine search) {
    this.search = search;
  }


  public DirectoryLineSearchPost200Response totalNumberOfResults(@javax.annotation.Nullable Integer totalNumberOfResults) {
  ...
  public DirectoryLineSearchPost200Response results(@javax.annotation.Nullable List<DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode> results) {
    this.results = results;
    return this;
  }

  public DirectoryLineSearchPost200Response addResultsItem(DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode resultsItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode> getResults() {
    return results;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESULTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResults(@javax.annotation.Nullable List<DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode> results) {
    this.results = results;
  }


  /**
   * Return true if this directoryLineSearchPost200Response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DirectoryLineSearchPost200Response directoryLineSearchPost200Response = (DirectoryLineSearchPost200Response) o;
    return Objects.equals(this.search, directoryLineSearchPost200Response.search) &&
        Objects.equals(this.totalNumberOfResults, directoryLineSearchPost200Response.totalNumberOfResults) &&
        Objects.equals(this.results, directoryLineSearchPost200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class DirectoryLineSearchPost200Response {\n");
