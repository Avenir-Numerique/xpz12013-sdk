 ...
 */
@JsonPropertyOrder({
  FlowInfo.JSON_PROPERTY_TRACKING_ID,
  FlowInfo.JSON_PROPERTY_NAME,
  FlowInfo.JSON_PROPERTY_PROCESSING_RULE,
  FlowInfo.JSON_PROPERTY_FLOW_SYNTAX,
  FlowInfo.JSON_PROPERTY_FLOW_PROFILE,
  FlowInfo.JSON_PROPERTY_SHA256
})
...
public class FlowInfo {
  ...
  public FlowInfo trackingId(@javax.annotation.Nullable String trackingId) {
  ...
  public FlowInfo name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public FlowInfo processingRule(@javax.annotation.Nullable ProcessingRule processingRule) {
  ...
  public FlowInfo flowSyntax(@javax.annotation.Nonnull FlowSyntax flowSyntax) {
  ...
  public FlowInfo flowProfile(@javax.annotation.Nullable FlowProfile flowProfile) {
  ...
  public FlowInfo sha256(@javax.annotation.Nullable byte[] sha256) {
    this.sha256 = sha256;
    return this;
  }
  ...
  /**
   * Return true if this FlowInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.trackingId, flowInfo.trackingId) &&
        Objects.equals(this.name, flowInfo.name) &&
        Objects.equals(this.processingRule, flowInfo.processingRule) &&
        Objects.equals(this.flowSyntax, flowInfo.flowSyntax) &&
        Objects.equals(this.flowProfile, flowInfo.flowProfile) &&
        Arrays.equals(this.sha256, flowInfo.sha256);
  }
