...
public class Flow {
  ...
  public Flow processingRule(@javax.annotation.Nonnull ProcessingRule processingRule) {
  ...
  @JsonProperty(JSON_PROPERTY_PROCESSING_RULE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setProcessingRule(@javax.annotation.Nonnull ProcessingRule processingRule) {
    this.processingRule = processingRule;
  }
  ...
  public Flow flowProfile(@javax.annotation.Nonnull FlowProfile flowProfile) {
  ...
  @JsonProperty(JSON_PROPERTY_FLOW_PROFILE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFlowProfile(@javax.annotation.Nonnull FlowProfile flowProfile) {
    this.flowProfile = flowProfile;
  }
