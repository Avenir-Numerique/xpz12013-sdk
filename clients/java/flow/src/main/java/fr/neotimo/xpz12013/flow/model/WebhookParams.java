 ...
 */
@JsonPropertyOrder({
  WebhookParams.JSON_PROPERTY_CALLBACK_URL,
  WebhookParams.JSON_PROPERTY_FLOW_TYPES,
  WebhookParams.JSON_PROPERTY_FLOW_DIRECTION,
  WebhookParams.JSON_PROPERTY_ACK_STATUS
})
...
public class WebhookParams {
  ...
  public WebhookParams callbackUrl(@javax.annotation.Nonnull URI callbackUrl) {
  ...
  public WebhookParams flowTypes(@javax.annotation.Nullable List<FlowType> flowTypes) {
    this.flowTypes = flowTypes;
    return this;
  }

  public WebhookParams addFlowTypesItem(FlowType flowTypesItem) {
  ...
  public WebhookParams flowDirection(@javax.annotation.Nullable FlowDirection flowDirection) {
  ...
  public WebhookParams ackStatus(@javax.annotation.Nullable FlowAckStatus ackStatus) {
  ...
  /**
   * Return true if this WebhookParams object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.callbackUrl, webhookParams.callbackUrl) &&
        Objects.equals(this.flowTypes, webhookParams.flowTypes) &&
        Objects.equals(this.flowDirection, webhookParams.flowDirection) &&
        Objects.equals(this.ackStatus, webhookParams.ackStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(callbackUrl, flowTypes, flowDirection, ackStatus);
  }
