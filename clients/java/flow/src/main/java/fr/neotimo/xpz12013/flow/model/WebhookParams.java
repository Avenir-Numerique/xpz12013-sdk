 ...
 */
@JsonPropertyOrder({
  WebhookParams.JSON_PROPERTY_CALLBACK,
  WebhookParams.JSON_PROPERTY_METADATA
})
...
public class WebhookParams {
  ...
  public WebhookParams callback(@javax.annotation.Nonnull CallbackParameters callback) {
  ...
  public WebhookParams metadata(@javax.annotation.Nonnull WebhookMetadata metadata) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.callback, webhookParams.callback) &&
        Objects.equals(this.metadata, webhookParams.metadata);
  }
