 ...
 */
@JsonPropertyOrder({
  SearchFlowParams.JSON_PROPERTY_LIMIT,
  SearchFlowParams.JSON_PROPERTY_CURSOR,
  SearchFlowParams.JSON_PROPERTY_WHERE
})
...
public class SearchFlowParams {
  ...
  private SearchFlowFilters where;

  public SearchFlowParams() { 
  }

  public SearchFlowParams limit(@javax.annotation.Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public SearchFlowParams cursor(@javax.annotation.Nullable String cursor) {
    this.cursor = cursor;
    return this;
  }
  ...
  public SearchFlowParams where(@javax.annotation.Nonnull SearchFlowFilters where) {
    this.where = where;
    return this;
  }
  ...
  public SearchFlowFilters getWhere() {
    return where;
  }
  ...
  @JsonProperty(JSON_PROPERTY_WHERE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setWhere(@javax.annotation.Nonnull SearchFlowFilters where) {
    this.where = where;
  }


  /**
   * Return true if this SearchFlowParams object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SearchFlowParams searchFlowParams = (SearchFlowParams) o;
    return Objects.equals(this.limit, searchFlowParams.limit) &&
        Objects.equals(this.cursor, searchFlowParams.cursor) &&
        Objects.equals(this.where, searchFlowParams.where);
  }

  @Override
  public int hashCode() {
    return Objects.hash(limit, cursor, where);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SearchFlowParams {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCursor() != null) {
      joiner.add(String.format("%scursor%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCursor()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
