...
@JsonPropertyOrder({
  ...
  SearchFlowContent.JSON_PROPERTY_NEXT_CURSOR,
...
public class SearchFlowContent {
  ...
  /**
   * Pagination, Maximum number of results that may be returned
   * maximum: 100
   * @return limit
   */
  @javax.annotation.Nullable
  ...
  public SearchFlowContent nextCursor(@javax.annotation.Nullable String nextCursor) {
    this.nextCursor = nextCursor;
    return this;
  }

  /**
   * Pagination management: - If present, says where to start for next page, set nextCursor as the cursor in the next request - If omitted, says that pagination is finished 
   * @return nextCursor
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.limit, searchFlowContent.limit) &&
        Objects.equals(this.nextCursor, searchFlowContent.nextCursor) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(limit, nextCursor, filters, results);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getNextCursor() != null) {
      joiner.add(String.format("%snextCursor%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getNextCursor()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
