...
import fr.neotimo.xpz12013.flow.model.Algorithm;
 ...
 */
@JsonPropertyOrder({
  CallbackSignature.JSON_PROPERTY_ALGO,
  CallbackSignature.JSON_PROPERTY_KEY
})
...
public class CallbackSignature {
  ...
  public CallbackSignature() { 
  }

  public CallbackSignature algo(@javax.annotation.Nonnull Algorithm algo) {
    this.algo = algo;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ALGO)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAlgo(@javax.annotation.Nonnull Algorithm algo) {
    this.algo = algo;
  }


  public CallbackSignature key(@javax.annotation.Nonnull byte[] key) {
    this.key = key;
    return this;
  }
  ...
  /**
   * Return true if this CallbackSignature object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CallbackSignature callbackSignature = (CallbackSignature) o;
    return Objects.equals(this.algo, callbackSignature.algo) &&
        Arrays.equals(this.key, callbackSignature.key);
  }
  ...
  public String toString() {
    ...
    sb.append("class CallbackSignature {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `algo` to the URL query string
    if (getAlgo() != null) {
      joiner.add(String.format("%salgo%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAlgo()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
