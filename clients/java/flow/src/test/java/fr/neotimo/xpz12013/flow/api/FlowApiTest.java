...
public class FlowApiTest {
    ...
    public void createFlowTest() throws ApiException {
        ...
        FullFlowInfo response = 
        api.createFlow(flowInfo, _file, requestId, organizationId);
    ...
    public void getFlowTest() throws ApiException {
        ...
        api.getFlow(flowId, requestId, organizationId, docType);
    ...
    public void searchFlowsTest() throws ApiException {
        UUID requestId = null;
        String organizationId = null;
        SearchFlowParams searchFlowParams = null;
        SearchFlowContent response = 
        api.searchFlows(requestId, organizationId, searchFlowParams);
