...
class TestRoutingCodeSearchPost200Response(unittest.TestCase):
    """RoutingCodeSearchPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutingCodeSearchPost200Response:
        """Test RoutingCodeSearchPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoutingCodeSearchPost200Response`
        """
        model = RoutingCodeSearchPost200Response()
        if include_optional:
            return RoutingCodeSearchPost200Response(
                search = neotimo_xpz12013_directory.models.routing_code_search.routingCodeSearch(
                    filters = neotimo_xpz12013_directory.models.routing_code_search_filters.routingCodeSearchFilters(
                        ...
                        routing_code_name = neotimo_xpz12013_directory.models.routing_code_search_filters_routing_code_name.routingCodeSearchFiltersRoutingCodeName(), 
                        administrative_status = neotimo_xpz12013_directory.models.routing_code_search_filters_administrative_status.routingCodeSearchFiltersAdministrativeStatus(), 
                        address_lines = neotimo_xpz12013_directory.models.search_siret_filters_address_lines.searchSiretFiltersAddressLines(), 
                        postal_code = neotimo_xpz12013_directory.models.search_siret_filters_postal_code.searchSiretFiltersPostalCode(), 
                        locality = neotimo_xpz12013_directory.models.search_siret_filters_locality.searchSiretFiltersLocality(), ), 
                    sorting = [{"field":"siret","order":"ascending"},{"field":"routingIdentifier","order":"ascending"}], 
                ...
                results = [
                    neotimo_xpz12013_directory.models.routing_code_payload_history_legal_unit_facility.routingCodePayloadHistoryLegalUnitFacility(
    ...
    def testRoutingCodeSearchPost200Response(self):
        """Test RoutingCodeSearchPost200Response"""
