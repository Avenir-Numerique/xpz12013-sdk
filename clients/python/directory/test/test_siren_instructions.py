...
class TestSirenInstructions(unittest.TestCase):
    """SirenInstructions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SirenInstructions:
        """Test SirenInstructions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SirenInstructions`
        """
        model = SirenInstructions()
        if include_optional:
            return SirenInstructions(
    ...
    def testSirenInstructions(self):
        """Test SirenInstructions"""
