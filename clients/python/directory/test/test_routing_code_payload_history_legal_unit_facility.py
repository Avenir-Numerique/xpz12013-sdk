...
class TestRoutingCodePayloadHistoryLegalUnitFacility(unittest.TestCase):
    """RoutingCodePayloadHistoryLegalUnitFacility unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutingCodePayloadHistoryLegalUnitFacility:
        """Test RoutingCodePayloadHistoryLegalUnitFacility
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoutingCodePayloadHistoryLegalUnitFacility`
        """
        model = RoutingCodePayloadHistoryLegalUnitFacility()
        if include_optional:
    ...
    def testRoutingCodePayloadHistoryLegalUnitFacility(self):
        """Test RoutingCodePayloadHistoryLegalUnitFacility"""
