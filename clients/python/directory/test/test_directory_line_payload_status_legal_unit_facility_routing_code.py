...
class TestDirectoryLinePayloadStatusLegalUnitFacilityRoutingCode(unittest.TestCase):
    """DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode:
        """Test DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode`
        """
        model = DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode()
        if include_optional:
            return DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode(
                ...
                facility = neotimo_xpz12013_directory.models.facility_payload_included.facilityPayloadIncluded(
                    ...
                    facility_type = 'P', 
                    administrative_status = 'A', 
                    instructions = neotimo_xpz12013_directory.models.siret_instructions.siretInstructions(
                        is_sales_prospecting_forbidden = False, ), 
                    address = neotimo_xpz12013_directory.models.address_read.addressRead(
                        address_line1 = '16 BIS RUE HENRI BARBUSSE', 
                        address_line2 = 'CEDEX 1', 
    ...
    def testDirectoryLinePayloadStatusLegalUnitFacilityRoutingCode(self):
        """Test DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode"""
