...
class TestRoutingCodeSearchFiltersRoutingIdentifier(unittest.TestCase):
    """RoutingCodeSearchFiltersRoutingIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutingCodeSearchFiltersRoutingIdentifier:
        """Test RoutingCodeSearchFiltersRoutingIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoutingCodeSearchFiltersRoutingIdentifier`
        """
        model = RoutingCodeSearchFiltersRoutingIdentifier()
        if include_optional:
    ...
    def testRoutingCodeSearchFiltersRoutingIdentifier(self):
        """Test RoutingCodeSearchFiltersRoutingIdentifier"""
