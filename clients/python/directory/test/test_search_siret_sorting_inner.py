...
class TestSearchSiretSortingInner(unittest.TestCase):
    """SearchSiretSortingInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSiretSortingInner:
        """Test SearchSiretSortingInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSiretSortingInner`
        """
        model = SearchSiretSortingInner()
        if include_optional:
            return SearchSiretSortingInner(
                var_field = 'siret',
                order = 'ascending'
            )
        else:
    ...
    def testSearchSiretSortingInner(self):
        """Test SearchSiretSortingInner"""
