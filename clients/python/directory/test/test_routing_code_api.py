...
class TestRoutingCodeApi(unittest.TestCase):
    """RoutingCodeApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RoutingCodeApi()

    def tearDown(self) -> None:
        pass

    def test_get_routing_code_by_siret_and_id(self) -> None:
        """Test case for get_routing_code_by_siret_and_id

        Get a routing code by SIRET and routing identifier
        """
        pass

    def test_search_routing_code(self) -> None:
        """Test case for search_routing_code
