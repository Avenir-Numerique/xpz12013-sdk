...
class TestSearchSiret(unittest.TestCase):
    """SearchSiret unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSiret:
        """Test SearchSiret
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSiret`
        """
        model = SearchSiret()
        if include_optional:
            return SearchSiret(
