...
class TestSearchSiretFiltersPostalCode(unittest.TestCase):
    """SearchSiretFiltersPostalCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSiretFiltersPostalCode:
        """Test SearchSiretFiltersPostalCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSiretFiltersPostalCode`
        """
        model = SearchSiretFiltersPostalCode()
        if include_optional:
    ...
    def testSearchSiretFiltersPostalCode(self):
        """Test SearchSiretFiltersPostalCode"""
