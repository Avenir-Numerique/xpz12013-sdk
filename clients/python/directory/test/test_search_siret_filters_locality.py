...
class TestSearchSiretFiltersLocality(unittest.TestCase):
    """SearchSiretFiltersLocality unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSiretFiltersLocality:
        """Test SearchSiretFiltersLocality
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSiretFiltersLocality`
        """
        model = SearchSiretFiltersLocality()
        if include_optional:
    ...
    def testSearchSiretFiltersLocality(self):
        """Test SearchSiretFiltersLocality"""
