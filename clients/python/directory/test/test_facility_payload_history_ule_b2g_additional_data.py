...
class TestFacilityPayloadHistoryUleB2gAdditionalData(unittest.TestCase):
    """FacilityPayloadHistoryUleB2gAdditionalData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FacilityPayloadHistoryUleB2gAdditionalData:
        """Test FacilityPayloadHistoryUleB2gAdditionalData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FacilityPayloadHistoryUleB2gAdditionalData`
        """
        model = FacilityPayloadHistoryUleB2gAdditionalData()
        if include_optional:
    ...
    def testFacilityPayloadHistoryUleB2gAdditionalData(self):
        """Test FacilityPayloadHistoryUleB2gAdditionalData"""
