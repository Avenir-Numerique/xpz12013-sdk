...
class TestSiretInstructions(unittest.TestCase):
    """SiretInstructions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SiretInstructions:
        """Test SiretInstructions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SiretInstructions`
        """
        model = SiretInstructions()
        if include_optional:
    ...
    def testSiretInstructions(self):
        """Test SiretInstructions"""
