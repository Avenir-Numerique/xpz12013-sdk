...
class TestSiretSearchPost200Response(unittest.TestCase):
    """SiretSearchPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SiretSearchPost200Response:
        """Test SiretSearchPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SiretSearchPost200Response`
        """
        model = SiretSearchPost200Response()
        if include_optional:
            return SiretSearchPost200Response(
                search = neotimo_xpz12013_directory.models.search_siret.searchSiret(
                    filters = neotimo_xpz12013_directory.models.search_siret_filters.searchSiretFilters(
                        ...
                        facility_type = neotimo_xpz12013_directory.models.search_siret_filters_facility_type.searchSiretFiltersFacilityType(), 
                        name = neotimo_xpz12013_directory.models.search_siret_filters_name.searchSiretFiltersName(), 
                        ...
                        country_subdivision = neotimo_xpz12013_directory.models.search_siret_filters_country_subdivision.searchSiretFiltersCountrySubdivision(), 
                        locality = neotimo_xpz12013_directory.models.search_siret_filters_locality.searchSiretFiltersLocality(), 
                        administrative_status = neotimo_xpz12013_directory.models.search_siret_filters_administrative_status.searchSiretFiltersAdministrativeStatus(), ), 
                ...
                results = [
                    neotimo_xpz12013_directory.models.facility_payload_history.facilityPayloadHistory(
                        siret = '70204275500240', 
                        siren = '702042755', 
                        name = 'Boulangerie Pascale', 
                        facility_type = 'P', 
                        administrative_status = 'A', 
                        siret_instructions = neotimo_xpz12013_directory.models.siret_instructions.siretInstructions(
    ...
    def testSiretSearchPost200Response(self):
        """Test SiretSearchPost200Response"""
