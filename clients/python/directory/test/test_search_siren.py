...
class TestSearchSiren(unittest.TestCase):
    """SearchSiren unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSiren:
        """Test SearchSiren
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSiren`
        """
        model = SearchSiren()
        if include_optional:
            return SearchSiren(
