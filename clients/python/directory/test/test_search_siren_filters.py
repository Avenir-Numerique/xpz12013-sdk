...
class TestSearchSirenFilters(unittest.TestCase):
    """SearchSirenFilters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSirenFilters:
        """Test SearchSirenFilters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSirenFilters`
        """
        model = SearchSirenFilters()
        if include_optional:
    ...
    def testSearchSirenFilters(self):
        """Test SearchSirenFilters"""
