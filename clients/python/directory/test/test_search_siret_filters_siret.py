...
class TestSearchSiretFiltersSiret(unittest.TestCase):
    """SearchSiretFiltersSiret unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSiretFiltersSiret:
        """Test SearchSiretFiltersSiret
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSiretFiltersSiret`
        """
        model = SearchSiretFiltersSiret()
        if include_optional:
    ...
    def testSearchSiretFiltersSiret(self):
        """Test SearchSiretFiltersSiret"""
