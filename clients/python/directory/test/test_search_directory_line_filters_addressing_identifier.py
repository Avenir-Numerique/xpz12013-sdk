...
class TestSearchDirectoryLineFiltersAddressingIdentifier(unittest.TestCase):
    """SearchDirectoryLineFiltersAddressingIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchDirectoryLineFiltersAddressingIdentifier:
        """Test SearchDirectoryLineFiltersAddressingIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchDirectoryLineFiltersAddressingIdentifier`
        """
        model = SearchDirectoryLineFiltersAddressingIdentifier()
        if include_optional:
    ...
    def testSearchDirectoryLineFiltersAddressingIdentifier(self):
        """Test SearchDirectoryLineFiltersAddressingIdentifier"""
