...
class TestSearchDirectoryLineSortingInner(unittest.TestCase):
    """SearchDirectoryLineSortingInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchDirectoryLineSortingInner:
        """Test SearchDirectoryLineSortingInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchDirectoryLineSortingInner`
        """
        model = SearchDirectoryLineSortingInner()
        if include_optional:
            return SearchDirectoryLineSortingInner(
                var_field = 'siren',
                order = 'ascending'
            )
        else:
    ...
    def testSearchDirectoryLineSortingInner(self):
        """Test SearchDirectoryLineSortingInner"""
