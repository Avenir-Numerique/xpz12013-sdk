...
class TestDirectoryLineApi(unittest.TestCase):
    """DirectoryLineApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DirectoryLineApi()

    def tearDown(self) -> None:
        pass

    def test_get_directory_line_by_id(self) -> None:
        """Test case for get_directory_line_by_id

        Get a directory line.
        """
        pass

    def test_search_directory_line(self) -> None:
        """Test case for search_directory_line
