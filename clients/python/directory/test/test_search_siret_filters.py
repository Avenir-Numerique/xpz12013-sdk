...
class TestSearchSiretFilters(unittest.TestCase):
    """SearchSiretFilters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSiretFilters:
        """Test SearchSiretFilters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSiretFilters`
        """
        model = SearchSiretFilters()
        if include_optional:
    ...
    def testSearchSiretFilters(self):
        """Test SearchSiretFilters"""
