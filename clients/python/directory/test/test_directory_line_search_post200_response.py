...
class TestDirectoryLineSearchPost200Response(unittest.TestCase):
    """DirectoryLineSearchPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DirectoryLineSearchPost200Response:
        """Test DirectoryLineSearchPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DirectoryLineSearchPost200Response`
        """
        model = DirectoryLineSearchPost200Response()
        if include_optional:
            return DirectoryLineSearchPost200Response(
                search = neotimo_xpz12013_directory.models.search_directory_line.searchDirectoryLine(
                    filters = neotimo_xpz12013_directory.models.search_directory_line_filters.searchDirectoryLineFilters(
                        addressing_identifier = neotimo_xpz12013_directory.models.search_directory_line_filters_addressing_identifier.searchDirectoryLineFiltersAddressingIdentifier(
                            op = 'contains', 
                            value = 'dcsc456sdcsdcs556', ), 
                        siren = neotimo_xpz12013_directory.models.search_siren_filters_siren.searchSirenFiltersSiren(), 
                        siret = neotimo_xpz12013_directory.models.search_siret_filters_siret.searchSiretFiltersSiret(), 
                        routing_identifier = neotimo_xpz12013_directory.models.routing_code_search_filters_routing_identifier.routingCodeSearchFiltersRoutingIdentifier(), 
                        addressing_suffix = neotimo_xpz12013_directory.models.search_directory_line_filters_addressing_suffix.searchDirectoryLineFiltersAddressingSuffix(), ), 
                    sorting = [{"field":"addressingIdentifier","order":"ascending"}], 
                    fields = ["addressingIdentifier","siren","siret","addressingSuffix","routingIdentifier"], 
                    include = ["siren","siret","routingCode"], 
                    limit = 50, 
                    ignore = 0, ),
                total_number_of_results = 1500,
                results = [
                    neotimo_xpz12013_directory.models.directory_line_payload_history_legal_unit_facility_routing_code.directoryLinePayloadHistoryLegalUnitFacilityRoutingCode(
                        ...
                        routing_code = neotimo_xpz12013_directory.models.directory_line_payload_history_legal_unit_facility_routing_code_routing_code.directoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode(
                            routing_identifier = 'dcsc456sdcsdcs556', 
                            routing_identifier_type = '0224', 
                            routing_code_name = 'Libellé Code routage', 
                            manages_legal_commitment = True, 
                            administrative_status = 'A', 
                            address = neotimo_xpz12013_directory.models.address_read.addressRead(
                                ...
                                country_code = 'FR', 
                                country_name = 'France', ), ), 
                        legal_unit = neotimo_xpz12013_directory.models.legal_unit_payload_included.legalUnitPayloadIncluded(
                            siren = '702042755', 
                            business_name = 'Boulangerie Pascale', 
                            entity_type = 'Public', 
                            instructions = neotimo_xpz12013_directory.models.siren_instructions.sirenInstructions(
                                is_sales_prospecting_forbidden = False, ), ), 
                        facility = neotimo_xpz12013_directory.models.facility_payload_included.facilityPayloadIncluded(
                            siret = '70204275500240', 
                            siren = '702042755', 
                            name = 'Boulangerie Pascale', 
                            facility_type = 'P', 
                            b2g_additional_data = neotimo_xpz12013_directory.models.facility_payload_history_ule_b2g_additional_data.facilityPayloadHistoryUleB2gAdditionalData(
                                pm = True, 
                                pm_only = True, 
    ...
    def testDirectoryLineSearchPost200Response(self):
        """Test DirectoryLineSearchPost200Response"""
