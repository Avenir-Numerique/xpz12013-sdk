...
class TestSiretApi(unittest.TestCase):
    """SiretApi unit test stubs"""
    ...
    def test_get_facility_by_siret(self) -> None:
        """Test case for get_facility_by_siret

        Gets a siret (facility) by SIRET number
        """
        pass

    def test_search_facility_by_siret(self) -> None:
        """Test case for search_facility_by_siret
