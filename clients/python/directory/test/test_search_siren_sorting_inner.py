...
class TestSearchSirenSortingInner(unittest.TestCase):
    """SearchSirenSortingInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSirenSortingInner:
        """Test SearchSirenSortingInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSirenSortingInner`
        """
        model = SearchSirenSortingInner()
        if include_optional:
            return SearchSirenSortingInner(
                var_field = 'siren',
    ...
    def testSearchSirenSortingInner(self):
        """Test SearchSirenSortingInner"""
