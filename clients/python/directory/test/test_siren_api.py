...
class TestSirenApi(unittest.TestCase):
    """SirenApi unit test stubs"""
    ...
    def test_get_company_by_siren(self) -> None:
        """Test case for get_company_by_siren

        Consult a siren (legal unit) by SIREN number
        """
        pass

    def test_search_company_by_siren(self) -> None:
        """Test case for search_company_by_siren
