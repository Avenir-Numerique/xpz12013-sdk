...
class TestSearchSiretFiltersAddressLines(unittest.TestCase):
    """SearchSiretFiltersAddressLines unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSiretFiltersAddressLines:
        """Test SearchSiretFiltersAddressLines
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSiretFiltersAddressLines`
        """
        model = SearchSiretFiltersAddressLines()
        if include_optional:
    ...
    def testSearchSiretFiltersAddressLines(self):
        """Test SearchSiretFiltersAddressLines"""
