...
class TestRoutingCodeSearch(unittest.TestCase):
    """RoutingCodeSearch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutingCodeSearch:
        """Test RoutingCodeSearch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoutingCodeSearch`
        """
        model = RoutingCodeSearch()
        if include_optional:
    ...
    def testRoutingCodeSearch(self):
        """Test RoutingCodeSearch"""
