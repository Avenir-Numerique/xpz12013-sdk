...
class TestRoutingCodeSearchSortingInner(unittest.TestCase):
    """RoutingCodeSearchSortingInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutingCodeSearchSortingInner:
        """Test RoutingCodeSearchSortingInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoutingCodeSearchSortingInner`
        """
        model = RoutingCodeSearchSortingInner()
        if include_optional:
            return RoutingCodeSearchSortingInner(
                var_field = 'siret',
                order = 'ascending'
            )
        else:
    ...
    def testRoutingCodeSearchSortingInner(self):
        """Test RoutingCodeSearchSortingInner"""
