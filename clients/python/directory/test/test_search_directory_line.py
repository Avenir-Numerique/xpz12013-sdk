...
class TestSearchDirectoryLine(unittest.TestCase):
    """SearchDirectoryLine unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchDirectoryLine:
        """Test SearchDirectoryLine
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchDirectoryLine`
        """
        model = SearchDirectoryLine()
        if include_optional:
    ...
    def testSearchDirectoryLine(self):
        """Test SearchDirectoryLine"""
