...
class TestSearchSirenFiltersAdministrativeStatus(unittest.TestCase):
    """SearchSirenFiltersAdministrativeStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSirenFiltersAdministrativeStatus:
        """Test SearchSirenFiltersAdministrativeStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSirenFiltersAdministrativeStatus`
        """
        model = SearchSirenFiltersAdministrativeStatus()
        if include_optional:
    ...
    def testSearchSirenFiltersAdministrativeStatus(self):
        """Test SearchSirenFiltersAdministrativeStatus"""
