...
class TestRoutingCodeSearchFiltersRoutingCodeName(unittest.TestCase):
    """RoutingCodeSearchFiltersRoutingCodeName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutingCodeSearchFiltersRoutingCodeName:
        """Test RoutingCodeSearchFiltersRoutingCodeName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoutingCodeSearchFiltersRoutingCodeName`
        """
        model = RoutingCodeSearchFiltersRoutingCodeName()
        if include_optional:
    ...
    def testRoutingCodeSearchFiltersRoutingCodeName(self):
        """Test RoutingCodeSearchFiltersRoutingCodeName"""
