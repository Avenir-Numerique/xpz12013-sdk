...
class TestSearchDirectoryLineFilters(unittest.TestCase):
    """SearchDirectoryLineFilters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchDirectoryLineFilters:
        """Test SearchDirectoryLineFilters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchDirectoryLineFilters`
        """
        model = SearchDirectoryLineFilters()
        if include_optional:
    ...
    def testSearchDirectoryLineFilters(self):
        """Test SearchDirectoryLineFilters"""
