...
class TestSearchSiretFiltersName(unittest.TestCase):
    """SearchSiretFiltersName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSiretFiltersName:
        """Test SearchSiretFiltersName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSiretFiltersName`
        """
        model = SearchSiretFiltersName()
        if include_optional:
    ...
    def testSearchSiretFiltersName(self):
        """Test SearchSiretFiltersName"""
