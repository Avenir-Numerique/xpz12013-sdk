...
class TestLegalUnitPayloadIncluded(unittest.TestCase):
    """LegalUnitPayloadIncluded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegalUnitPayloadIncluded:
        """Test LegalUnitPayloadIncluded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LegalUnitPayloadIncluded`
        """
        model = LegalUnitPayloadIncluded()
        if include_optional:
    ...
    def testLegalUnitPayloadIncluded(self):
        """Test LegalUnitPayloadIncluded"""
