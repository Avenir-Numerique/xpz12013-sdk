...
class TestFacilityPayloadHistory(unittest.TestCase):
    """FacilityPayloadHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FacilityPayloadHistory:
        """Test FacilityPayloadHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FacilityPayloadHistory`
        """
        model = FacilityPayloadHistory()
        if include_optional:
    ...
    def testFacilityPayloadHistory(self):
        """Test FacilityPayloadHistory"""
