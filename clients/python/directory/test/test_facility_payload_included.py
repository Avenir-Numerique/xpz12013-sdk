...
class TestFacilityPayloadIncluded(unittest.TestCase):
    """FacilityPayloadIncluded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FacilityPayloadIncluded:
        """Test FacilityPayloadIncluded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FacilityPayloadIncluded`
        """
        model = FacilityPayloadIncluded()
        if include_optional:
    ...
    def testFacilityPayloadIncluded(self):
        """Test FacilityPayloadIncluded"""
