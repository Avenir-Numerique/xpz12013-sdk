...
class TestSearchDirectoryLineFiltersAddressingSuffix(unittest.TestCase):
    """SearchDirectoryLineFiltersAddressingSuffix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchDirectoryLineFiltersAddressingSuffix:
        """Test SearchDirectoryLineFiltersAddressingSuffix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchDirectoryLineFiltersAddressingSuffix`
        """
        model = SearchDirectoryLineFiltersAddressingSuffix()
        if include_optional:
    ...
    def testSearchDirectoryLineFiltersAddressingSuffix(self):
        """Test SearchDirectoryLineFiltersAddressingSuffix"""
