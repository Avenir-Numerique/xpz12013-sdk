...
class TestSearchSiretFiltersFacilityType(unittest.TestCase):
    """SearchSiretFiltersFacilityType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSiretFiltersFacilityType:
        """Test SearchSiretFiltersFacilityType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSiretFiltersFacilityType`
        """
        model = SearchSiretFiltersFacilityType()
        if include_optional:
    ...
    def testSearchSiretFiltersFacilityType(self):
        """Test SearchSiretFiltersFacilityType"""
