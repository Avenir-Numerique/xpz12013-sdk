...
class TestSearchSirenFiltersBusinessName(unittest.TestCase):
    """SearchSirenFiltersBusinessName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSirenFiltersBusinessName:
        """Test SearchSirenFiltersBusinessName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSirenFiltersBusinessName`
        """
        model = SearchSirenFiltersBusinessName()
        if include_optional:
    ...
    def testSearchSirenFiltersBusinessName(self):
        """Test SearchSirenFiltersBusinessName"""
