...
class TestRoutingCodeSearchFilters(unittest.TestCase):
    """RoutingCodeSearchFilters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutingCodeSearchFilters:
        """Test RoutingCodeSearchFilters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoutingCodeSearchFilters`
        """
        model = RoutingCodeSearchFilters()
        if include_optional:
    ...
    def testRoutingCodeSearchFilters(self):
        """Test RoutingCodeSearchFilters"""
