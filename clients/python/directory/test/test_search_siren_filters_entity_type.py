...
class TestSearchSirenFiltersEntityType(unittest.TestCase):
    """SearchSirenFiltersEntityType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSirenFiltersEntityType:
        """Test SearchSirenFiltersEntityType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSirenFiltersEntityType`
        """
        model = SearchSirenFiltersEntityType()
        if include_optional:
    ...
    def testSearchSirenFiltersEntityType(self):
        """Test SearchSirenFiltersEntityType"""
