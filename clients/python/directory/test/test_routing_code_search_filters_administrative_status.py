...
class TestRoutingCodeSearchFiltersAdministrativeStatus(unittest.TestCase):
    """RoutingCodeSearchFiltersAdministrativeStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutingCodeSearchFiltersAdministrativeStatus:
        """Test RoutingCodeSearchFiltersAdministrativeStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoutingCodeSearchFiltersAdministrativeStatus`
        """
        model = RoutingCodeSearchFiltersAdministrativeStatus()
        if include_optional:
    ...
    def testRoutingCodeSearchFiltersAdministrativeStatus(self):
        """Test RoutingCodeSearchFiltersAdministrativeStatus"""
