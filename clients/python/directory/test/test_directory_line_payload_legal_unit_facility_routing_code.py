...
class TestDirectoryLinePayloadLegalUnitFacilityRoutingCode(unittest.TestCase):
    """DirectoryLinePayloadLegalUnitFacilityRoutingCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DirectoryLinePayloadLegalUnitFacilityRoutingCode:
        """Test DirectoryLinePayloadLegalUnitFacilityRoutingCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DirectoryLinePayloadLegalUnitFacilityRoutingCode`
        """
        model = DirectoryLinePayloadLegalUnitFacilityRoutingCode()
        if include_optional:
    ...
    def testDirectoryLinePayloadLegalUnitFacilityRoutingCode(self):
        """Test DirectoryLinePayloadLegalUnitFacilityRoutingCode"""
