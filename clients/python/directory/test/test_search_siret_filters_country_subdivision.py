...
class TestSearchSiretFiltersCountrySubdivision(unittest.TestCase):
    """SearchSiretFiltersCountrySubdivision unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSiretFiltersCountrySubdivision:
        """Test SearchSiretFiltersCountrySubdivision
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSiretFiltersCountrySubdivision`
        """
        model = SearchSiretFiltersCountrySubdivision()
        if include_optional:
    ...
    def testSearchSiretFiltersCountrySubdivision(self):
        """Test SearchSiretFiltersCountrySubdivision"""
