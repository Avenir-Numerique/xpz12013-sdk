...
class TestSearchSiretFiltersAdministrativeStatus(unittest.TestCase):
    """SearchSiretFiltersAdministrativeStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSiretFiltersAdministrativeStatus:
        """Test SearchSiretFiltersAdministrativeStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSiretFiltersAdministrativeStatus`
        """
        model = SearchSiretFiltersAdministrativeStatus()
        if include_optional:
    ...
    def testSearchSiretFiltersAdministrativeStatus(self):
        """Test SearchSiretFiltersAdministrativeStatus"""
