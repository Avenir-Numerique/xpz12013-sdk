...
class TestLegalUnitPayloadHistory(unittest.TestCase):
    """LegalUnitPayloadHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegalUnitPayloadHistory:
        """Test LegalUnitPayloadHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LegalUnitPayloadHistory`
        """
        model = LegalUnitPayloadHistory()
        if include_optional:
    ...
    def testLegalUnitPayloadHistory(self):
        """Test LegalUnitPayloadHistory"""
