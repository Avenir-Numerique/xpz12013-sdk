...
class TestSirenSearchPost200Response(unittest.TestCase):
    """SirenSearchPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SirenSearchPost200Response:
        """Test SirenSearchPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SirenSearchPost200Response`
        """
        model = SirenSearchPost200Response()
        if include_optional:
            return SirenSearchPost200Response(
                search = neotimo_xpz12013_directory.models.search_siren.searchSiren(
                    filters = neotimo_xpz12013_directory.models.search_siren_filters.searchSirenFilters(
                        siren = neotimo_xpz12013_directory.models.search_siren_filters_siren.searchSirenFiltersSiren(
                            op = 'strict', 
                            value = '702042755', ), 
                        business_name = neotimo_xpz12013_directory.models.search_siren_filters_business_name.searchSirenFiltersBusinessName(), 
                        entity_type = neotimo_xpz12013_directory.models.search_siren_filters_entity_type.searchSirenFiltersEntityType(), 
                        administrative_status = neotimo_xpz12013_directory.models.search_siren_filters_administrative_status.searchSirenFiltersAdministrativeStatus(), ), 
                ...
                results = [
                    neotimo_xpz12013_directory.models.legal_unit_payload_history.legalUnitPayloadHistory(
                        siren = '702042755', 
    ...
    def testSirenSearchPost200Response(self):
        """Test SirenSearchPost200Response"""
