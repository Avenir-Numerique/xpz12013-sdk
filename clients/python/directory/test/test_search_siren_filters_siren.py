...
class TestSearchSirenFiltersSiren(unittest.TestCase):
    """SearchSirenFiltersSiren unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchSirenFiltersSiren:
        """Test SearchSirenFiltersSiren
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchSirenFiltersSiren`
        """
        model = SearchSirenFiltersSiren()
        if include_optional:
    ...
    def testSearchSirenFiltersSiren(self):
        """Test SearchSirenFiltersSiren"""
