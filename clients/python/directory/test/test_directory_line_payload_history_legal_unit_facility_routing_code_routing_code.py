...
class TestDirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode(unittest.TestCase):
    """DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode:
        """Test DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode`
        """
        model = DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode()
        if include_optional:
    ...
    def testDirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode(self):
        """Test DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode"""
