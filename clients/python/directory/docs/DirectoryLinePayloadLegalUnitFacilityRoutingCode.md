...
directory_line_payload_legal_unit_facility_routing_code_instance = DirectoryLinePayloadLegalUnitFacilityRoutingCode.from_json(json)
# print the JSON string representation of the object
print(DirectoryLinePayloadLegalUnitFacilityRoutingCode.to_json())

# convert the object into a dict
directory_line_payload_legal_unit_facility_routing_code_dict = directory_line_payload_legal_unit_facility_routing_code_instance.to_dict()
# create an instance of DirectoryLinePayloadLegalUnitFacilityRoutingCode from a dict
directory_line_payload_legal_unit_facility_routing_code_from_dict = DirectoryLinePayloadLegalUnitFacilityRoutingCode.from_dict(directory_line_payload_legal_unit_facility_routing_code_dict)
```
