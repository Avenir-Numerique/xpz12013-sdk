...
from neotimo_xpz12013_directory.api_response import ApiResponse, T as ApiResponseT
import neotimo_xpz12013_directory.models
from neotimo_xpz12013_directory import rest
from neotimo_xpz12013_directory.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(neotimo_xpz12013_directory.models, klass)
