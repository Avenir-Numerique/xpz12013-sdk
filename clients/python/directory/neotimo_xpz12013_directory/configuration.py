...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.directory.company.com/directory-service" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("neotimo_xpz12013_directory")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "https://{sub-domain}.{domain}{base-path}/directory-service",
                'description': "Prod public URLs",
                'variables': {
                    'sub-domain': {
                        'description': "Sub domain related to the directory API if any",
                        'default_value': "api.directory",
                        },
                    'domain': {
                        'description': "Domain name",
                        'default_value': "company.com",
                        },
                    'base-path': {
                        'description': "Custom path that may be used for routing, customer, PA, API",
                        'default_value': "",
                        }
                    }
            }
