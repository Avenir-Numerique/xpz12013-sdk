...
class RoutingCodeApi:
    ...
    @validate_call
    def get_routing_code_by_siret_and_id(
        self,
        siret: Annotated[str, Field(strict=True, max_length=14, description="SIRET number of a facility.")],
        routing_identifier: Annotated[str, Field(strict=True, max_length=100, description="Routing Identifier of a routing code")],
        include: Annotated[Optional[List[StrictStr]], Field(description="Relations to include in the response.")] = None,
        fields: Annotated[Optional[List[RoutingCodeField]], Field(description="Fields of the Routing Code resource")] = None,
        ...
        :type siret: str
        :param routing_identifier: Routing Identifier of a routing code (required)
        ...
        :type fields: List[RoutingCodeField]
        ...
        _param = self._get_routing_code_by_siret_and_id_serialize(
            siret=siret,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RoutingCodePayloadHistoryLegalUnitFacility",
            '400': "Error",
            '401': "Error",
            '403': "Error",
            '404': "Error",
    ...
    @validate_call
    def get_routing_code_by_siret_and_id_with_http_info(
        self,
        siret: Annotated[str, Field(strict=True, max_length=14, description="SIRET number of a facility.")],
        routing_identifier: Annotated[str, Field(strict=True, max_length=100, description="Routing Identifier of a routing code")],
        include: Annotated[Optional[List[StrictStr]], Field(description="Relations to include in the response.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RoutingCodePayloadHistoryLegalUnitFacility]:
        """Get a routing code by SIRET and routing identifier
    ...
    @validate_call
    def get_routing_code_by_siret_and_id_without_preload_content(
        self,
        siret: Annotated[str, Field(strict=True, max_length=14, description="SIRET number of a facility.")],
        routing_identifier: Annotated[str, Field(strict=True, max_length=100, description="Routing Identifier of a routing code")],
        include: Annotated[Optional[List[StrictStr]], Field(description="Relations to include in the response.")] = None,
    ...
    def _get_routing_code_by_siret_and_id_serialize(
        self,
        siret,
        routing_identifier,
        include,
        ...
        if routing_identifier is not None:
            _path_params['routing-identifier'] = routing_identifier
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/routing-code/siret:{siret}/code:{routing-identifier}',
    ...
    def search_routing_code(
        self,
        routing_code_search: RoutingCodeSearch,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param routing_code_search: (required)
        :type routing_code_search: RoutingCodeSearch
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._search_routing_code_serialize(
            routing_code_search=routing_code_search,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RoutingCodeSearchPost200Response",
            '204': None,
            '206': "RoutingCodeSearchPost200Response",
            '400': "Error",
            '401': "Error",
            '403': "Error",
            '404': "Error",
    ...
    @validate_call
    def search_routing_code_with_http_info(
        self,
        routing_code_search: RoutingCodeSearch,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RoutingCodeSearchPost200Response]:
        """Search for a routing code
    ...
    @validate_call
    def search_routing_code_without_preload_content(
        self,
        routing_code_search: RoutingCodeSearch,
        _request_timeout: Union[
            None,
    ...
    def _search_routing_code_serialize(
        self,
        routing_code_search,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if routing_code_search is not None:
            _body_params = routing_code_search
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/routing-code/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
