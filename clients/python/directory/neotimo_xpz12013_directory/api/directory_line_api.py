...
class DirectoryLineApi:
    ...
    @validate_call
    def get_directory_line_by_id(
        self,
        addressing_identifier: Annotated[str, Field(strict=True, max_length=125, description="Addressing identifier of the directory line")],
        include: Annotated[Optional[List[StrictStr]], Field(description="Relations to include in the response..")] = None,
        fields: Annotated[Optional[List[DirectoryLineField]], Field(description="Fields of the Directory Line resource")] = None,
        ...
        :param addressing_identifier: Addressing identifier of the directory line (required)
        ...
        :type fields: List[DirectoryLineField]
        ...
        _param = self._get_directory_line_by_id_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DirectoryLinePayloadLegalUnitFacilityRoutingCode",
            '400': "Error",
            '401': "Error",
            '403': "Error",
            '404': "Error",
    ...
    @validate_call
    def get_directory_line_by_id_with_http_info(
        self,
        addressing_identifier: Annotated[str, Field(strict=True, max_length=125, description="Addressing identifier of the directory line")],
        include: Annotated[Optional[List[StrictStr]], Field(description="Relations to include in the response..")] = None,
        fields: Annotated[Optional[List[DirectoryLineField]], Field(description="Fields of the Directory Line resource")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DirectoryLinePayloadLegalUnitFacilityRoutingCode]:
        """Get a directory line.
    ...
    @validate_call
    def get_directory_line_by_id_without_preload_content(
        self,
        addressing_identifier: Annotated[str, Field(strict=True, max_length=125, description="Addressing identifier of the directory line")],
        include: Annotated[Optional[List[StrictStr]], Field(description="Relations to include in the response..")] = None,
        fields: Annotated[Optional[List[DirectoryLineField]], Field(description="Fields of the Directory Line resource")] = None,
    ...
    def _get_directory_line_by_id_serialize(
        self,
        ...
        if addressing_identifier is not None:
            _path_params['addressing-identifier'] = addressing_identifier
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/directory-line/code:{addressing-identifier}',
    ...
    def search_directory_line(
        self,
        search_directory_line: Optional[SearchDirectoryLine] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param search_directory_line:
        :type search_directory_line: SearchDirectoryLine
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._search_directory_line_serialize(
            search_directory_line=search_directory_line,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DirectoryLineSearchPost200Response",
            '204': None,
            '206': "DirectoryLineSearchPost200Response",
            '400': "Error",
            '401': "Error",
            '403': "Error",
            '404': "Error",
    ...
    @validate_call
    def search_directory_line_with_http_info(
        self,
        search_directory_line: Optional[SearchDirectoryLine] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DirectoryLineSearchPost200Response]:
        """Search for a directory line
    ...
    @validate_call
    def search_directory_line_without_preload_content(
        self,
        search_directory_line: Optional[SearchDirectoryLine] = None,
        _request_timeout: Union[
            None,
    ...
    def _search_directory_line_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if search_directory_line is not None:
            _body_params = search_directory_line
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/directory-line/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
