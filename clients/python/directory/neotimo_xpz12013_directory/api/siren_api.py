...
class SirenApi:
    ...
    def get_company_by_siren(
        self,
        siren: Annotated[str, Field(strict=True, max_length=9, description="Corresponds to the SIREN number of a legal unit.")],
        fields: Annotated[Optional[List[SirenField]], Field(description="Fields of the SIREN resource.")] = None,
        ...
        _param = self._get_company_by_siren_serialize(
            siren=siren,
            fields=fields,
    ...
    @validate_call
    def get_company_by_siren_with_http_info(
        self,
        siren: Annotated[str, Field(strict=True, max_length=9, description="Corresponds to the SIREN number of a legal unit.")],
        fields: Annotated[Optional[List[SirenField]], Field(description="Fields of the SIREN resource.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LegalUnitPayloadHistory]:
        """Consult a siren (legal unit) by SIREN number
    ...
    @validate_call
    def get_company_by_siren_without_preload_content(
        self,
        siren: Annotated[str, Field(strict=True, max_length=9, description="Corresponds to the SIREN number of a legal unit.")],
        fields: Annotated[Optional[List[SirenField]], Field(description="Fields of the SIREN resource.")] = None,
        _request_timeout: Union[
    ...
    def _get_company_by_siren_serialize(
        self,
        siren,
        fields,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/siren/code-insee:{siren}',
    ...
    @validate_call
    def search_company_by_siren(
        self,
        search_siren: Optional[SearchSiren] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._search_company_by_siren_serialize(
            search_siren=search_siren,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SirenSearchPost200Response",
            '204': None,
            '206': "SirenSearchPost200Response",
            '400': "Error",
            '401': "Error",
            '403': "Error",
            '404': "Error",
    ...
    @validate_call
    def search_company_by_siren_with_http_info(
        self,
        search_siren: Optional[SearchSiren] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SirenSearchPost200Response]:
        """SIREN search (or legal unit)
    ...
    @validate_call
    def search_company_by_siren_without_preload_content(
        self,
        search_siren: Optional[SearchSiren] = None,
        _request_timeout: Union[
            None,
    ...
    def _search_company_by_siren_serialize(
        self,
        search_siren,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if search_siren is not None:
            _body_params = search_siren
