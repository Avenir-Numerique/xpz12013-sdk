...
class SearchDirectoryLineFilters(BaseModel):
    """
    SearchDirectoryLineFilters
    """ # noqa: E501
    addressing_identifier: Optional[SearchDirectoryLineFiltersAddressingIdentifier] = Field(default=None, alias="addressingIdentifier")
    ...
    addressing_suffix: Optional[SearchDirectoryLineFiltersAddressingSuffix] = Field(default=None, alias="addressingSuffix")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addressingIdentifier": SearchDirectoryLineFiltersAddressingIdentifier.from_dict(obj["addressingIdentifier"]) if obj.get("addressingIdentifier") is not None else None,
            ...
            "addressingSuffix": SearchDirectoryLineFiltersAddressingSuffix.from_dict(obj["addressingSuffix"]) if obj.get("addressingSuffix") is not None else None
        })
        return _obj
