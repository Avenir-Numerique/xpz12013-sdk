...
class SirenSearchPost200Response(BaseModel):
    """
    SirenSearchPost200Response
    """ # noqa: E501
    search: Optional[SearchSiren] = None
    ...
    results: Optional[List[LegalUnitPayloadHistory]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "search": SearchSiren.from_dict(obj["search"]) if obj.get("search") is not None else None,
            "totalNumberOfResults": obj.get("totalNumberOfResults") if obj.get("totalNumberOfResults") is not None else -1,
            "results": [LegalUnitPayloadHistory.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
