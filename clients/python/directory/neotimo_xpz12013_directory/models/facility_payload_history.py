...
class FacilityPayloadHistory(BaseModel):
    """
    ...
    facility_type: Optional[FacilityType] = Field(default=None, alias="facilityType")
    administrative_status: Optional[FacilityAdministrativeStatus] = Field(default=None, alias="administrativeStatus")
    siret_instructions: Optional[SiretInstructions] = Field(default=None, alias="siretInstructions")
    address: Optional[AddressRead] = None
    b2g_additional_data: Optional[FacilityPayloadHistoryUleB2gAdditionalData] = Field(default=None, alias="b2gAdditionalData")
    legal_unit: Optional[LegalUnitPayloadIncluded] = Field(default=None, alias="legalUnit")
    __properties: ClassVar[List[str]] = ["siret", "siren", "name", "facilityType", "administrativeStatus", "siretInstructions", "address", "b2gAdditionalData", "legalUnit"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of siret_instructions
        if self.siret_instructions:
            _dict['siretInstructions'] = self.siret_instructions.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "siretInstructions": SiretInstructions.from_dict(obj["siretInstructions"]) if obj.get("siretInstructions") is not None else None,
            "address": AddressRead.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "b2gAdditionalData": FacilityPayloadHistoryUleB2gAdditionalData.from_dict(obj["b2gAdditionalData"]) if obj.get("b2gAdditionalData") is not None else None,
