...
class LegalUnitPayloadIncluded(BaseModel):
    """
    ...
    administrative_status: Optional[LegalUnitAdministrativeStatus] = Field(default=None, alias="administrativeStatus")
    instructions: Optional[SirenInstructions] = None
    __properties: ClassVar[List[str]] = ["siren", "businessName", "entityType", "administrativeStatus", "instructions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "instructions": SirenInstructions.from_dict(obj["instructions"]) if obj.get("instructions") is not None else None
        })
        return _obj
