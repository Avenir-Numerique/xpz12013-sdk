...
class SearchDirectoryLineSortingInner(BaseModel):
    """
    A sort criteria composed of a field and an order (ascending or descending).
    """ # noqa: E501
    var_field: Optional[DirectoryLineField] = Field(default=None, alias="field")
    sorting_order: Optional[SortingOrder] = Field(default=None, alias="sortingOrder")
