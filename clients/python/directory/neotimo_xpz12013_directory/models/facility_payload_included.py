...
class FacilityPayloadIncluded(BaseModel):
    """
    ...
    instructions: Optional[SiretInstructions] = None
    ...
    __properties: ClassVar[List[str]] = ["siret", "siren", "name", "facilityType", "administrativeStatus", "instructions", "address", "b2gAdditionalData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "instructions": SiretInstructions.from_dict(obj["instructions"]) if obj.get("instructions") is not None else None,
