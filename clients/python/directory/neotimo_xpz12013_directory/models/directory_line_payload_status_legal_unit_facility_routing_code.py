...
class DirectoryLinePayloadStatusLegalUnitFacilityRoutingCode(BaseModel):
    """
    ...
    directory_line_status: Optional[DirectoryLineStatus] = Field(default=None, alias="directoryLineStatus")
