...
from neotimo_xpz12013_directory.models.unique_directory_line_status import UniqueDirectoryLineStatus
from typing import Optional, Set
from typing_extensions import Self

class DirectoryLinePayloadLegalUnitFacilityRoutingCode(BaseModel):
    """
    ...
    platform_type: Optional[RecipientPlatformType] = Field(default=None, alias="platformType")
    directory_line_status: Optional[UniqueDirectoryLineStatus] = Field(default=None, alias="directoryLineStatus")
    ...
    routing_code: Optional[DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode] = Field(default=None, alias="routingCode")
    ...
    __properties: ClassVar[List[str]] = ["addressingIdentifier", "platformType", "directoryLineStatus", "siren", "siret", "routingIdentifier", "addressingSuffix", "routingCode", "legalUnit", "facility"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DirectoryLinePayloadLegalUnitFacilityRoutingCode from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DirectoryLinePayloadLegalUnitFacilityRoutingCode from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "directoryLineStatus": obj.get("directoryLineStatus"),
            "siren": obj.get("siren"),
            "siret": obj.get("siret"),
            "routingIdentifier": obj.get("routingIdentifier"),
            "addressingSuffix": obj.get("addressingSuffix"),
            "routingCode": DirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode.from_dict(obj["routingCode"]) if obj.get("routingCode") is not None else None,
