...
class SirenInstructions(BaseModel):
    """
    Instructions regarding the SIREN
    """ # noqa: E501
    is_sales_prospecting_forbidden: Optional[StrictBool] = Field(default=None, description="Indicates whether the information is forbidden from being used for sales prospecting purposes.", alias="isSalesProspectingForbidden")
    __properties: ClassVar[List[str]] = ["isSalesProspectingForbidden"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "isSalesProspectingForbidden": obj.get("isSalesProspectingForbidden")
        })
        return _obj
