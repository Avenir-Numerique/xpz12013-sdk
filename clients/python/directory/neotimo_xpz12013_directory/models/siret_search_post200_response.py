...
class SiretSearchPost200Response(BaseModel):
    """
    SiretSearchPost200Response
    """ # noqa: E501
    search: Optional[SearchSiret] = None
    ...
    results: Optional[List[FacilityPayloadHistory]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "search": SearchSiret.from_dict(obj["search"]) if obj.get("search") is not None else None,
            "totalNumberOfResults": obj.get("totalNumberOfResults") if obj.get("totalNumberOfResults") is not None else -1,
            "results": [FacilityPayloadHistory.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
