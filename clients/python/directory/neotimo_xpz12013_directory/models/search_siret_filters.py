...
class SearchSiretFilters(BaseModel):
    """
    SearchSiretFilters
    """ # noqa: E501
    siret: Optional[SearchSiretFiltersSiret] = None
    siren: Optional[SearchSirenFiltersSiren] = None
    facility_type: Optional[SearchSiretFiltersFacilityType] = Field(default=None, alias="facilityType")
    name: Optional[SearchSiretFiltersName] = None
    ...
    country_subdivision: Optional[SearchSiretFiltersCountrySubdivision] = Field(default=None, alias="countrySubdivision")
    locality: Optional[SearchSiretFiltersLocality] = None
    administrative_status: Optional[SearchSiretFiltersAdministrativeStatus] = Field(default=None, alias="administrativeStatus")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "siren": SearchSirenFiltersSiren.from_dict(obj["siren"]) if obj.get("siren") is not None else None,
            "facilityType": SearchSiretFiltersFacilityType.from_dict(obj["facilityType"]) if obj.get("facilityType") is not None else None,
            "name": SearchSiretFiltersName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            ...
            "countrySubdivision": SearchSiretFiltersCountrySubdivision.from_dict(obj["countrySubdivision"]) if obj.get("countrySubdivision") is not None else None,
            "locality": SearchSiretFiltersLocality.from_dict(obj["locality"]) if obj.get("locality") is not None else None,
            "administrativeStatus": SearchSiretFiltersAdministrativeStatus.from_dict(obj["administrativeStatus"]) if obj.get("administrativeStatus") is not None else None
        })
        return _obj
