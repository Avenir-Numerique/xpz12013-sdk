...
class SearchSirenFilters(BaseModel):
    """
    SearchSirenFilters
    """ # noqa: E501
    siren: Optional[SearchSirenFiltersSiren] = None
    business_name: Optional[SearchSirenFiltersBusinessName] = Field(default=None, alias="businessName")
    entity_type: Optional[SearchSirenFiltersEntityType] = Field(default=None, alias="entityType")
    administrative_status: Optional[SearchSirenFiltersAdministrativeStatus] = Field(default=None, alias="administrativeStatus")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "businessName": SearchSirenFiltersBusinessName.from_dict(obj["businessName"]) if obj.get("businessName") is not None else None,
            "entityType": SearchSirenFiltersEntityType.from_dict(obj["entityType"]) if obj.get("entityType") is not None else None,
            "administrativeStatus": SearchSirenFiltersAdministrativeStatus.from_dict(obj["administrativeStatus"]) if obj.get("administrativeStatus") is not None else None
        })
        return _obj
