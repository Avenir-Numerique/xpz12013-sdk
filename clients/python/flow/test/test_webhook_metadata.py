...
class TestWebhookMetadata(unittest.TestCase):
    """WebhookMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookMetadata:
        """Test WebhookMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookMetadata`
        """
        model = WebhookMetadata()
        if include_optional:
