...
class TestCallbackAuthentication(unittest.TestCase):
    """CallbackAuthentication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallbackAuthentication:
        """Test CallbackAuthentication
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallbackAuthentication`
        """
        model = CallbackAuthentication()
        if include_optional:
    ...
    def testCallbackAuthentication(self):
        """Test CallbackAuthentication"""
