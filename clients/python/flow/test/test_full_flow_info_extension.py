...
class TestFullFlowInfoExtension(unittest.TestCase):
    """FullFlowInfoExtension unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FullFlowInfoExtension:
        """Test FullFlowInfoExtension
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FullFlowInfoExtension`
        """
        model = FullFlowInfoExtension()
        if include_optional:
            return FullFlowInfoExtension(
                flow_id = '',
    ...
    def testFullFlowInfoExtension(self):
        """Test FullFlowInfoExtension"""
