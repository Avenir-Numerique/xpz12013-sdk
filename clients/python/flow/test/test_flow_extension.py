...
class TestFlowExtension(unittest.TestCase):
    """FlowExtension unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlowExtension:
        """Test FlowExtension
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlowExtension`
        """
        model = FlowExtension()
        if include_optional:
            return FlowExtension(
                ...
                flow_direction = 'Out',
                acknowledgement = neotimo_xpz12013_flow.models.acknowledgement.Acknowledgement(
                    status = 'Pending', 
                    details = [
