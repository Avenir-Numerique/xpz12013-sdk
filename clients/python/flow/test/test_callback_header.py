...
class TestCallbackHeader(unittest.TestCase):
    """CallbackHeader unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallbackHeader:
        """Test CallbackHeader
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallbackHeader`
        """
        model = CallbackHeader()
        if include_optional:
