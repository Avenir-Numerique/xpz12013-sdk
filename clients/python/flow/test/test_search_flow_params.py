...
class TestSearchFlowParams(unittest.TestCase):
    """SearchFlowParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchFlowParams:
        """Test SearchFlowParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchFlowParams`
        """
        model = SearchFlowParams()
        if include_optional:
            return SearchFlowParams(
                limit = 56,
                cursor = 'eyJjcmVhdGVkX2F0IjoiMjAyNS0wNi0wOVQxMDowMDowMFoiLCJpZCI6MTIzNH0=',
                where = neotimo_xpz12013_flow.models.search_flow_filters.SearchFlowFilters(
