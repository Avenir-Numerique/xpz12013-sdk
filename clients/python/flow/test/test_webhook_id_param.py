...
class TestWebhookIdParam(unittest.TestCase):
    """WebhookIdParam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookIdParam:
        """Test WebhookIdParam
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookIdParam`
        """
        model = WebhookIdParam()
        if include_optional:
