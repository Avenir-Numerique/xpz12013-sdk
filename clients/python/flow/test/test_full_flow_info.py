...
class TestFullFlowInfo(unittest.TestCase):
    """FullFlowInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FullFlowInfo:
        """Test FullFlowInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FullFlowInfo`
        """
        model = FullFlowInfo()
        if include_optional:
            return FullFlowInfo(
