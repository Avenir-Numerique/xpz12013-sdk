...
class TestAcknowledgementDetail(unittest.TestCase):
    """AcknowledgementDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AcknowledgementDetail:
        """Test AcknowledgementDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AcknowledgementDetail`
        """
        model = AcknowledgementDetail()
        if include_optional:
    ...
    def testAcknowledgementDetail(self):
        """Test AcknowledgementDetail"""
