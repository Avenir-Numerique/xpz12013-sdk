...
class TestCallbackSignature(unittest.TestCase):
    """CallbackSignature unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallbackSignature:
        """Test CallbackSignature
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallbackSignature`
        """
        model = CallbackSignature()
        if include_optional:
    ...
    def testCallbackSignature(self):
        """Test CallbackSignature"""
