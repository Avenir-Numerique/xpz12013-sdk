...
class TestSearchFlowFilters(unittest.TestCase):
    """SearchFlowFilters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchFlowFilters:
        """Test SearchFlowFilters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchFlowFilters`
        """
        model = SearchFlowFilters()
        if include_optional:
            return SearchFlowFilters(
    ...
    def testSearchFlowFilters(self):
        """Test SearchFlowFilters"""
