...
class TestWebhookPatchPayload(unittest.TestCase):
    """WebhookPatchPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookPatchPayload:
        """Test WebhookPatchPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookPatchPayload`
        """
        model = WebhookPatchPayload()
        if include_optional:
            return WebhookPatchPayload(
                headers = [
                    neotimo_xpz12013_flow.models.callback_header.CallbackHeader(
                        header_name = '', 
                        header_value = '', )
                    ],
                authentication = neotimo_xpz12013_flow.models.callback_authentication.CallbackAuthentication(
                    auth_type = 'BASIC', ),
                signature = neotimo_xpz12013_flow.models.callback_signature.CallbackSignature(
                    algo = 'RS256', 
                    key = 'YQ==', )
            )
        else:
    ...
    def testWebhookPatchPayload(self):
        """Test WebhookPatchPayload"""
