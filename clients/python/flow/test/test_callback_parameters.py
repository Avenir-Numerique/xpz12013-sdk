...
class TestCallbackParameters(unittest.TestCase):
    """CallbackParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallbackParameters:
        """Test CallbackParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallbackParameters`
        """
        model = CallbackParameters()
        if include_optional:
    ...
    def testCallbackParameters(self):
        """Test CallbackParameters"""
