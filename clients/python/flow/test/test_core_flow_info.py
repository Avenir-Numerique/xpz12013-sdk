...
class TestCoreFlowInfo(unittest.TestCase):
    """CoreFlowInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreFlowInfo:
        """Test CoreFlowInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreFlowInfo`
        """
        model = CoreFlowInfo()
        if include_optional:
            return CoreFlowInfo(
