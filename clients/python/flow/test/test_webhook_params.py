...
class TestWebhookParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WebhookParams:
        """Test WebhookParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookParams`
        """
        model = WebhookParams()
        if include_optional:
            return WebhookParams(
                callback = neotimo_xpz12013_flow.models.callback_parameters.CallbackParameters(
                    url = '', 
                    headers = [
                    ...
                    signature = neotimo_xpz12013_flow.models.callback_signature.CallbackSignature(
                        algo = 'RS256', 
                        key = 'YQ==', ), ),
                metadata = neotimo_xpz12013_flow.models.webhook_metadata.WebhookMetadata(
                    processing_rule = 'B2B', 
