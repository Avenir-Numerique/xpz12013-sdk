...
class TestFlowInfoExtension(unittest.TestCase):
    """FlowInfoExtension unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlowInfoExtension:
        """Test FlowInfoExtension
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlowInfoExtension`
        """
        model = FlowInfoExtension()
        if include_optional:
            return FlowInfoExtension(
                sha256 = 'YQ=='
            )
        else:
            return FlowInfoExtension(
    ...
    def testFlowInfoExtension(self):
        """Test FlowInfoExtension"""
