...
class TestSearchFlowContent(unittest.TestCase):
    """SearchFlowContent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchFlowContent:
        """Test SearchFlowContent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchFlowContent`
        """
        model = SearchFlowContent()
        if include_optional:
            return SearchFlowContent(
                limit = 56,
                next_cursor = 'eyJjcmVhdGVkX2F0IjoiMjAyNS0wNi0wOVQxMDowMDowMFoiLCJpZCI6MTIzNH0=',
                filters = neotimo_xpz12013_flow.models.search_flow_filters.SearchFlowFilters(
    ...
    def testSearchFlowContent(self):
        """Test SearchFlowContent"""
