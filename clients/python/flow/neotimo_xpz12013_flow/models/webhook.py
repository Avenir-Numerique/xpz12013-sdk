...
class Webhook(BaseModel):
    ...
    signing_key: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, alias="signingKey")
    ...
    __properties: ClassVar[List[str]] = ["webhookId", "signingKey", "createdAt", "callbackUrl", "flowTypes", "flowDirection", "ackStatus"]
