...
class Webhook(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["webhookId", "callback", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "callback": CallbackParameters.from_dict(obj["callback"]) if obj.get("callback") is not None else None,
            "metadata": WebhookMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
