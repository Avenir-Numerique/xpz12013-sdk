...
class Acknowledgement(BaseModel):
    ...
    details: Optional[Annotated[List[AcknowledgementDetail], Field(min_length=1)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": [AcknowledgementDetail.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
