...
class SearchFlowParams(BaseModel):
    """
    SearchFlowParams
    """ # noqa: E501
    ...
    cursor: Optional[StrictStr] = Field(default=None, description="If cursor is provided, then start search starting from that cursor")
    where: SearchFlowFilters
    __properties: ClassVar[List[str]] = ["limit", "cursor", "where"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "where": SearchFlowFilters.from_dict(obj["where"]) if obj.get("where") is not None else None
        })
        return _obj
