...
class WebhookPatchPayload(BaseModel):
    """
    WebhookPatchPayload
    """ # noqa: E501
    headers: Optional[List[CallbackHeader]] = None
    authentication: Optional[CallbackAuthentication] = None
    signature: Optional[CallbackSignature] = None
    __properties: ClassVar[List[str]] = ["headers", "authentication", "signature"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "headers": [CallbackHeader.from_dict(_item) for _item in obj["headers"]] if obj.get("headers") is not None else None,
            "authentication": CallbackAuthentication.from_dict(obj["authentication"]) if obj.get("authentication") is not None else None,
            "signature": CallbackSignature.from_dict(obj["signature"]) if obj.get("signature") is not None else None
        })
        return _obj
