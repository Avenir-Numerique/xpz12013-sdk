...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.flow.company.com/flow-service" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("neotimo_xpz12013_flow")
        ...
        return [
            {
                ...
                'variables': {
                    ...
                    'service-name': {
                        'description': "If service name is not the default one",
                        'default_value': "flow-service",
                        }
                    }
            }
        ]
